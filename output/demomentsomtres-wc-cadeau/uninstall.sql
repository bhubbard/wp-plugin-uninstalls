...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('dms3-wccadeau_dms3-is-cadeau', 'wpml_language');
DELETE FROM wp_usermeta WHERE meta_key IN ('dms3-wccadeau_dms3-is-cadeau', 'wpml_language');
DELETE FROM wp_termmeta WHERE meta_key IN ('dms3-wccadeau_dms3-is-cadeau', 'wpml_language');
DELETE FROM wp_commentmeta WHERE meta_key IN ('dms3-wccadeau_dms3-is-cadeau', 'wpml_language');
