...
delete_site_option('redux-framework-statistics');
delete_option('redux_statistics_cache');
delete_site_option('redux_statistics_cache');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('redux_statistics');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'redux_tour' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'redux_tour' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'redux_tour' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'redux_tour' ) );
