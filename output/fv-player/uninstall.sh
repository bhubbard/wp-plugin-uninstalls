...
wp option delete 'fv_player_stats_last_guest_user_id'
...
wp transient delete 'fv-player_license'
...
wp transient delete 'fv_player_license'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'fv_player_audio_name'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'fv_player_audio_name'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'fv_player_audio_name'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'fv_player_audio_name'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'fv_player_audio_lang'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'fv_player_audio_lang'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'fv_player_audio_lang'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'fv_player_audio_lang'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fv_player_youtube_channel_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fv_player_youtube_channel_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fv_player_youtube_channel_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fv_player_youtube_channel_id'"
