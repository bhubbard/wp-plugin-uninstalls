...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_%_wpse10500_post_pending_notice', '_site_transient_%_wpse10500_post_pending_notice' ) );
