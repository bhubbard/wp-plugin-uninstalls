...
# Delete Options
wp option delete 'solr_last_post_date_indexed'
...
# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%search_admin_notice' OR option_name LIKE '_site_transient_%search_admin_notice'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%wpsolr_error_during_search' OR option_name LIKE '_site_transient_%wpsolr_error_during_search'"
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%error_solr_post_save_admin_notice' OR option_name LIKE '_site_transient_%error_solr_post_save_admin_notice'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%updated_solr_post_save_admin_notice' OR option_name LIKE '_site_transient_%updated_solr_post_save_admin_notice'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%wpsolr_some_languages_have_no_solr_index_admin_notice' OR option_name LIKE '_site_transient_%wpsolr_some_languages_have_no_solr_index_admin_notice'"
