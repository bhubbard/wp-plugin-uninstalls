...
// Delete Options
delete_option('everest_toolkit_consent_optin');
delete_site_option('everest_toolkit_consent_optin');
delete_option('everest_themes');
delete_site_option('everest_themes');
global $wpdb;
...
delete_option('widget_everest-news-lite-fullwidth-widget-cat-three');
delete_site_option('widget_everest-news-lite-fullwidth-widget-cat-three');
delete_option('widget_everest-news-halfwidth-widget-five');
delete_site_option('widget_everest-news-halfwidth-widget-five');
delete_option('nav_menu');
delete_site_option('nav_menu');
delete_option('everest_toolkit_activate_time');
delete_site_option('everest_toolkit_activate_time');

// Delete Transients
delete_transient('everest_toolkit_consent_skip');
delete_site_transient('everest_toolkit_consent_skip');
