...
# Delete Options
wp option delete 'everest_toolkit_consent_optin'
wp option delete 'everest_themes'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'sidebars_widgets'
wp option delete 'widget_everest-news-lite-fullwidth-widget-cat-three'
wp option delete 'widget_everest-news-halfwidth-widget-five'
wp option delete 'nav_menu'
wp option delete 'everest_toolkit_activate_time'

# Delete Transients
wp transient delete 'everest_toolkit_consent_skip'
wp transient delete 'MG_importer_data'
