...
// Delete Options
delete_option('learndash_salesforce_settings');
delete_site_option('learndash_salesforce_settings');
delete_option('learndash_salesforce_access_token');
delete_site_option('learndash_salesforce_access_token');
delete_option('learndash_salesforce_instance_url');
delete_site_option('learndash_salesforce_instance_url');
global $wpdb;
...
delete_site_transient('learndash_salesforce_connection_status');
global $wpdb;
