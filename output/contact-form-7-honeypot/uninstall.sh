...
wp option delete 'cf7apps_settings'
wp option delete 'cf7_entries_version'
wp option delete 'honeypot4cf7_config'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'cf7apps_settings'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'cf7apps_settings'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'cf7apps_settings'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'cf7apps_settings'"
