...
delete_option('cf7apps_settings');
delete_site_option('cf7apps_settings');
delete_option('cf7_entries_version');
delete_site_option('cf7_entries_version');
delete_option('honeypot4cf7_config');
delete_site_option('honeypot4cf7_config');
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'cf7apps_settings' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'cf7apps_settings' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'cf7apps_settings' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'cf7apps_settings' ) );
