...
wp option delete 'table_builder_settings_list'
wp option delete '__table_builder_oppai__'
wp option delete '__table_builder_license_key__'
wp option delete 'table_builder_fse_fonts'
...
# Delete Transients
wp transient delete 'table_builder_block_migrate'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'table_builder_posts_fonts'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'table_builder_posts_fonts'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'table_builder_posts_fonts'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'table_builder_posts_fonts'"
