...
# Delete Options
wp option delete 'bsearch_db_version'
wp option delete 'bsearch_settings'
wp option delete 'bsearch_show_wizard'
wp option delete 'bsearch_wizard_notice_dismissed'
wp option delete 'wz_posts_custom_tables_ready'
wp option delete 'ald_bsearch_settings'
wp option delete 'better_search_selected_sites'
wp option delete 'bsearch_wizard_completed'
wp option delete 'bsearch_wizard_completed_date'
wp option delete 'bsearch_wizard_current_step'
...
# Delete Transients
wp transient delete 'bsearch_deactivated_notice'
wp transient delete 'bsearch_show_wizard_activation_redirect'
wp transient delete 'bsearch_reindex_state'
wp transient delete 'bsearch_deactivated_notice_id'
wp transient delete 'bsearch_reindex_scheduled'
