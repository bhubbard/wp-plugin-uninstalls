...
# Delete Options
wp option delete 'woocommerce_easyauthnet_authorizenet_settings'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_settings'"
wp option delete 'easyauthnet_activation_time'
wp option delete 'easyauthnet_review_notice_hide_v1'
wp option delete 'easyauthnet_next_show_time'
wp option delete 'woocommerce_easyauthnet_authorizenet_echeck_settings'
wp option delete 'woocommerce_default_country'

# Delete Transients
wp transient delete 'easyauthnet_authorizenet_invalid_credentials_message'
wp transient delete 'easyauthnet_authorized_for_woocommerce_redirect'
