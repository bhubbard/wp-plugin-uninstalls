...
wp option delete 'mltlngg_options'
wp option delete 'sidebars_widgets'
wp option delete 'widget_multi_language_widget'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_mltlngg_menu_item'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_mltlngg_menu_item'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_mltlngg_menu_item'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_mltlngg_menu_item'"
