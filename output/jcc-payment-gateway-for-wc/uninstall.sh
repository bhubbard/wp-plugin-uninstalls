...
wp option delete 'woocommerce_jccgateway_settings'
wp option delete 'woocommerce_calc_taxes'
wp option delete 'woocommerce_jccgateway_title'
wp option delete 'woocommerce_jccgateway_description'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'orderId'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'orderId'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'orderId'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'orderId'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fes_truCode'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fes_truCode'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fes_truCode'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fes_truCode'"
