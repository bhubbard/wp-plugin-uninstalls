...
delete_option('wcb_note');
delete_site_option('wcb_note');
delete_option('wcb_note_time');
delete_site_option('wcb_note_time');
delete_option('wcb_active');
delete_site_option('wcb_active');
delete_option('woo_coupon_box_params');
delete_site_option('woo_coupon_box_params');
global $wpdb;
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'woo_coupon_box_meta' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'woo_coupon_box_meta' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'woo_coupon_box_meta' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'woo_coupon_box_meta' ) );
