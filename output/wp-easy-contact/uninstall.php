...
delete_option('wp_easy_contact_access_views');
delete_site_option('wp_easy_contact_access_views');
delete_option('wp_easy_contact_ent_map_list');
delete_site_option('wp_easy_contact_ent_map_list');
delete_option('wp_easy_contact_tax_settings');
delete_site_option('wp_easy_contact_tax_settings');
delete_option('wp_easy_contact_tools');
delete_site_option('wp_easy_contact_tools');
global $wpdb;
...
delete_option('wp_easy_contact_tracking_optin');
delete_site_option('wp_easy_contact_tracking_optin');
delete_option('wp_easy_contact_show_rateme_plugin_min');
delete_site_option('wp_easy_contact_show_rateme_plugin_min');
delete_option('wp_easy_contact_ent_list');
delete_site_option('wp_easy_contact_ent_list');
delete_option('wp_easy_contact_activation_date');
delete_site_option('wp_easy_contact_activation_date');
delete_option('wp_easy_contact_tax_list');
delete_site_option('wp_easy_contact_tax_list');
delete_option('wp_easy_contact_rel_list');
delete_site_option('wp_easy_contact_rel_list');
delete_option('wp_easy_contact_shc_list');
delete_site_option('wp_easy_contact_shc_list');
global $wpdb;
...
delete_option('wp_easy_contact_attr_list');
delete_site_option('wp_easy_contact_attr_list');
delete_option('wp_easy_contact_setup_pages_list');
delete_site_option('wp_easy_contact_setup_pages_list');
