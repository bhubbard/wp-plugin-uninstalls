...
DELETE FROM wp_options WHERE option_name IN ('emd_session_db_version', 'dashboard_widget_options', 'emd_inline_ent_list', 'emd_activated_plugins', 'secure_cookies', 'cookie_http_only', 'session_delete_batch_size', 'emd_inc_email_apps', 'wp_easy_contact_access_views', 'wp_easy_contact_ent_map_list', 'wp_easy_contact_tax_settings', 'wp_easy_contact_tools', 'wp_easy_contact_tracking_optin', 'wp_easy_contact_show_rateme_plugin_min', 'wp_easy_contact_ent_list', 'wp_easy_contact_activation_date', 'wp_easy_contact_tax_list', 'wp_easy_contact_rel_list', 'wp_easy_contact_shc_list', 'wp_easy_contact_attr_list', 'wp_easy_contact_setup_pages_list', 'emd_license_settings');
