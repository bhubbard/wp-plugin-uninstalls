...
wp option delete 'mm-Role-option'
wp option delete 'BeRocket_MM_Quantity_version'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_minmax_limitation'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_minmax_limitation'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_minmax_limitation'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_minmax_limitation'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'quantity_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'quantity_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'quantity_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'quantity_text'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'min_quantity'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'min_quantity'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'min_quantity'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'min_quantity'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'min_quantity_var'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'min_quantity_var'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'min_quantity_var'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'min_quantity_var'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'max_quantity_var'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'max_quantity_var'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'max_quantity_var'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'max_quantity_var'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'quantity_var_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'quantity_var_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'quantity_var_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'quantity_var_text'"
