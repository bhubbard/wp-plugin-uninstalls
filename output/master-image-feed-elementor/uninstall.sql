...
DELETE FROM wp_options WHERE option_name IN ('jltelimf_sheet_promo_data', 'jltelimf_sheet_promo_data_hash', 'jltelimf_activation_time');
DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking';
DELETE FROM wp_options WHERE option_name LIKE 'jltelimf-plugin-info-%';
