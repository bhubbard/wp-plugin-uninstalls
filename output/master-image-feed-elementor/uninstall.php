...
// Delete Options
delete_option('jltelimf_sheet_promo_data');
delete_site_option('jltelimf_sheet_promo_data');
delete_option('jltelimf_sheet_promo_data_hash');
delete_site_option('jltelimf_sheet_promo_data_hash');
delete_option('jltelimf_activation_time');
delete_site_option('jltelimf_activation_time');
global $wpdb;
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_jltelimf-plugin-info-%', '_site_transient_jltelimf-plugin-info-%' ) );
