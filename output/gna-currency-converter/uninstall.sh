...
# Delete Options
wp option delete 'g_cc_configs'
wp option delete 'g_currency_converter_configs'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'meta_image_from'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'meta_image_from'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'meta_image_from'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'meta_image_from'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'meta_image_to'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'meta_image_to'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'meta_image_to'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'meta_image_to'"
