...
DELETE FROM wp_options WHERE option_name IN ('woocommerce_shop_page_id', 'woocommerce_cart_page_id', 'woocommerce_checkout_page_id', 'woocommerce_myaccount_page_id', 'sidebars_widgets', '_wxr_imported_users', '_wxr_imported_terms', '_wxr_orphaned_terms', 'wc_attribute_taxonomies', '_wxr_imported_posts', '_wxr_orphaned_posts', '_wxr_orphaned_comments', '_wxr_imported_comments');
