...
DELETE FROM wp_options WHERE option_name IN ('ppr_version', 'ppr_meta_clean', 'quickppr_redirects', 'quickppr_redirects_meta', 'ppr_override-nofollow', 'ppr_override-newwindow', 'ppr_use-jquery', 'ppr_qpprptypeok', 'ppr_override-redirect-type', 'ppr_override-active', 'ppr_override-URL', 'ppr_override-rewrite', 'qppr_meta_addon_content', 'ppr_meta-message', 'qppr_meta_addon_sec', 'ppr_meta-seconds', 'ppr_override-casesensitive', 'ppr_show-columns', 'ppr_use-custom-post-types', 'qppr_jQuery_hide_message2', 'qppr_meta_addon_load', 'qppr_meta_addon_trigger', 'qppr_meta_append_to', 'qppr_jQuery_hide_message');
