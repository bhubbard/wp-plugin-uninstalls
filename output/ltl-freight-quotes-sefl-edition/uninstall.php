...
// Delete Options
delete_option('sefl_db_version');
delete_site_option('sefl_db_version');
delete_option('EN_Plugins');
delete_site_option('EN_Plugins');
delete_option('sefl_quotes_web_hook_plan_requests');
delete_site_option('sefl_quotes_web_hook_plan_requests');
delete_option('sefl_quotes_packages_quotes_package');
delete_site_option('sefl_quotes_packages_quotes_package');
delete_option('sefl_quotes_store_type');
delete_site_option('sefl_quotes_store_type');
delete_option('sefl_package_expire_days');
delete_site_option('sefl_package_expire_days');
delete_option('sefl_package_expire_date');
delete_site_option('sefl_package_expire_date');
delete_option('sefl_residential');
delete_site_option('sefl_residential');
delete_option('sefl_liftgate');
delete_site_option('sefl_liftgate');
...
delete_option('wc_settings_sefl_plugin_licence_key');
delete_site_option('wc_settings_sefl_plugin_licence_key');
...
delete_option('sefl_freight_order_cut_off_time');
delete_site_option('sefl_freight_order_cut_off_time');
...
delete_option('sefl_ltl_backup_rates_fixed_rate');
delete_site_option('sefl_ltl_backup_rates_fixed_rate');
delete_option('sefl_ltl_backup_rates_cart_price_percentage');
delete_site_option('sefl_ltl_backup_rates_cart_price_percentage');
delete_option('sefl_ltl_backup_rates_weight_function');
delete_site_option('sefl_ltl_backup_rates_weight_function');
delete_option('en_self_update_now');
delete_site_option('en_self_update_now');
...
delete_option('sefl_label_as');
delete_site_option('sefl_label_as');
delete_option('sefl_ltl_backup_rates_display');
delete_site_option('sefl_ltl_backup_rates_display');
delete_option('enable_backup_rates_sefl_ltl');
delete_site_option('enable_backup_rates_sefl_ltl');
delete_option('sefl_allow_other_plugins');
delete_site_option('sefl_allow_other_plugins');
delete_option('sefl_delivery_estimates');
delete_site_option('sefl_delivery_estimates');
delete_option('wc_settings_sefl_billing_accountno');
delete_site_option('wc_settings_sefl_billing_accountno');
delete_option('wc_settings_sefl_accountno');
delete_site_option('wc_settings_sefl_accountno');
delete_option('customer_zip_code_sefl');
delete_site_option('customer_zip_code_sefl');
...
delete_option('wc_settings_sefl_username');
delete_site_option('wc_settings_sefl_username');
delete_option('wc_settings_sefl_password');
delete_site_option('wc_settings_sefl_password');
delete_option('customer_name_sefl');
delete_site_option('customer_name_sefl');
delete_option('customer_street_address_sefl');
delete_site_option('customer_street_address_sefl');
delete_option('customer_city_sefl');
delete_site_option('customer_city_sefl');
delete_option('customer_state_sefl');
delete_site_option('customer_state_sefl');
...
delete_option('handling_weight_sefl');
delete_site_option('handling_weight_sefl');
delete_option('maximum_handling_weight_sefl');
delete_site_option('maximum_handling_weight_sefl');
delete_option('eniture_plugin_12');
delete_site_option('eniture_plugin_12');
delete_option('all_shipment_days_sefl');
delete_site_option('all_shipment_days_sefl');
delete_option('monday_shipment_day_sefl');
delete_site_option('monday_shipment_day_sefl');
delete_option('tuesday_shipment_day_sefl');
delete_site_option('tuesday_shipment_day_sefl');
delete_option('wednesday_shipment_day_sefl');
delete_site_option('wednesday_shipment_day_sefl');
delete_option('thursday_shipment_day_sefl');
delete_site_option('thursday_shipment_day_sefl');
delete_option('friday_shipment_day_sefl');
delete_site_option('friday_shipment_day_sefl');
...
delete_option('sefl_quotes_liftgate_delivery_as_option');
delete_site_option('sefl_quotes_liftgate_delivery_as_option');
...
delete_option('sefl_handling_fee');
delete_site_option('sefl_handling_fee');
delete_option('sefl_ltl_backup_rates_carrier_returns_error');
delete_site_option('sefl_ltl_backup_rates_carrier_returns_error');
delete_option('sefl_ltl_backup_rates_carrier_fails_to_return_response');
delete_site_option('sefl_ltl_backup_rates_carrier_fails_to_return_response');
...
delete_option('sefl_freight_shipment_offset_days');
delete_site_option('sefl_freight_shipment_offset_days');
delete_option('shipping_methods_do_not_sort_by_price');
delete_site_option('shipping_methods_do_not_sort_by_price');
delete_option('sefl_ltl_backup_rates_category');
delete_site_option('sefl_ltl_backup_rates_category');
delete_option('sefl_ltl_backup_rates_label');
delete_site_option('sefl_ltl_backup_rates_label');
delete_option('enale_logs_sefl');
delete_site_option('enale_logs_sefl');
