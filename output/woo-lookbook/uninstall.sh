...
# Delete Options
wp option delete 'woo_lookbook_params'
...
# Delete Transients
wp transient delete 'wlb_instagram_data'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'wlb_params'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'wlb_params'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'wlb_params'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'wlb_params'"
