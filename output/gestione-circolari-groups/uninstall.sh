...
wp option delete 'Circolari_NumPerPag'
wp option delete 'Circolari_GGScadenza'
wp option delete 'Circolari_NrCircHome'
wp option delete 'Circolari_IntestElenco'
wp option delete 'Circolari_IntestElencoDest'
wp option delete 'Circolari_TestiRisposte'
wp option delete 'Circolari_Tipo'
wp option delete 'Circolari_CleanUninstall'
wp option delete 'Circolari_UsaGroups'
wp option delete 'Circolari_GestPerm'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_sign'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_sign'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_sign'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_sign'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_destinatari'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_destinatari'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_destinatari'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_destinatari'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'groups-read'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'groups-read'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'groups-read'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'groups-read'"
