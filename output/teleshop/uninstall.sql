...
DELETE FROM wp_options WHERE option_name LIKE '%_allowed_updates';
DELETE FROM wp_options WHERE option_name LIKE '%_keyboard';
DELETE FROM wp_options WHERE option_name LIKE '%_remove_plugin_settings';
