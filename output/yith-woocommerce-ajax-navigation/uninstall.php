...
delete_option('yith_wcan_version');
delete_site_option('yith_wcan_version');
delete_option('yith_wcan_db_version');
delete_site_option('yith_wcan_db_version');
delete_option('yith_wcan_default_preset_created');
delete_site_option('yith_wcan_default_preset_created');
delete_option('yith_wcan_upgrade_note_status');
delete_site_option('yith_wcan_upgrade_note_status');
delete_option('yit_wcan_options');
delete_site_option('yit_wcan_options');
delete_option('yith_wcan_lazy_load_filters');
delete_site_option('yith_wcan_lazy_load_filters');
delete_option('yith_wcan_paginate_terms');
delete_site_option('yith_wcan_paginate_terms');
delete_option('woocommerce_attribute_lookup_enabled');
delete_site_option('woocommerce_attribute_lookup_enabled');
delete_option('yith_woocommerce_variations_filtering');
delete_site_option('yith_woocommerce_variations_filtering');
delete_option('yith-wccl-show-single-variations-loop');
delete_site_option('yith-wccl-show-single-variations-loop');
delete_option('yith-wccl-hide-parent-products-loop');
delete_site_option('yith-wccl-hide-parent-products-loop');
...
delete_option('yith_wcan_ajax_filters');
delete_site_option('yith_wcan_ajax_filters');
