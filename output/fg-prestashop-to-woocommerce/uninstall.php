...
// Delete Options
delete_option('fgp2wc_options');
delete_site_option('fgp2wc_options');
delete_option('fgp2wc_last_cms_id');
delete_site_option('fgp2wc_last_cms_id');
delete_option('fgp2wc_last_product_id');
delete_site_option('fgp2wc_last_product_id');
delete_option('fgp2wc_last_update');
delete_site_option('fgp2wc_last_update');
delete_option('fgp2wc_save_posts');
delete_site_option('fgp2wc_save_posts');
delete_option('fgp2wc_save_terms');
delete_site_option('fgp2wc_save_terms');
delete_option('fgp2wc_save_term_relationships');
delete_site_option('fgp2wc_save_term_relationships');
global $wpdb;
...
delete_option('fgp2wc_stop_import');
delete_site_option('fgp2wc_stop_import');
delete_option('fgp2wc_default_language');
delete_site_option('fgp2wc_default_language');
global $wpdb;
...
delete_option('fgp2wc_ftp_options');
delete_site_option('fgp2wc_ftp_options');
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgp2wc_old_cms_article_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgp2wc_old_cms_article_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgp2wc_old_cms_article_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgp2wc_old_cms_article_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgp2wc_imported' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgp2wc_imported' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgp2wc_imported' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgp2wc_imported' ) );
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgp2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgp2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgp2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgp2wc_old_file' ) );
