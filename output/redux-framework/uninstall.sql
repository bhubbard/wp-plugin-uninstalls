...
DELETE FROM wp_options WHERE option_name LIKE 'redux_token_%';
...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('ignore_hints', '_wp_page_template', '_visibility', '_stock_status');
DELETE FROM wp_usermeta WHERE meta_key IN ('ignore_hints', '_wp_page_template', '_visibility', '_stock_status');
DELETE FROM wp_termmeta WHERE meta_key IN ('ignore_hints', '_wp_page_template', '_visibility', '_stock_status');
DELETE FROM wp_commentmeta WHERE meta_key IN ('ignore_hints', '_wp_page_template', '_visibility', '_stock_status');
