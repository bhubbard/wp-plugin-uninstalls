...
delete_site_option('sktnurc_recaptcha_language');
delete_option('sktnurc_data_theme');
delete_site_option('sktnurc_data_theme');
delete_option('sktnurc_data_type');
delete_site_option('sktnurc_data_type');
delete_option('sktnurc_login_recaptcha');
delete_site_option('sktnurc_login_recaptcha');
delete_option('sktnurc_publkey');
delete_site_option('sktnurc_publkey');
delete_option('sktnurc_privtkey');
delete_site_option('sktnurc_privtkey');
delete_option('sktnurc_username_help');
delete_site_option('sktnurc_username_help');
delete_option('sktnurc_email_help');
delete_site_option('sktnurc_email_help');
delete_option('sktnurc_v2_reCaptcha_help');
delete_site_option('sktnurc_v2_reCaptcha_help');
delete_option('sktnurc_usrhlp_opt');
delete_site_option('sktnurc_usrhlp_opt');
delete_option('sktnurc_emlhlp_opt');
delete_site_option('sktnurc_emlhlp_opt');
delete_option('sktnurc_rechlp_opt');
delete_site_option('sktnurc_rechlp_opt');
delete_option('sktnurc_logpage_limit');
delete_site_option('sktnurc_logpage_limit');
delete_option('sktnurc_regbutton');
delete_site_option('sktnurc_regbutton');
delete_option('sktnurc_custom_page_list');
delete_site_option('sktnurc_custom_page_list');
delete_option('sktnurc_botscoutkey');
delete_site_option('sktnurc_botscoutkey');
delete_option('sktnurc_theme');
delete_site_option('sktnurc_theme');
delete_option('sktnurclog_db_version');
delete_site_option('sktnurclog_db_version');
