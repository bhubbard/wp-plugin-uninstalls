...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('sp_icon', 'sp_color', 'sp_singular', 'sp_timed');
DELETE FROM wp_usermeta WHERE meta_key IN ('sp_icon', 'sp_color', 'sp_singular', 'sp_timed');
DELETE FROM wp_termmeta WHERE meta_key IN ('sp_icon', 'sp_color', 'sp_singular', 'sp_timed');
DELETE FROM wp_commentmeta WHERE meta_key IN ('sp_icon', 'sp_color', 'sp_singular', 'sp_timed');
