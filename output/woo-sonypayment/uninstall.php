...
// Delete Options
delete_option('woocommerce_sonypayment_settings');
delete_site_option('woocommerce_sonypayment_settings');
delete_option('woocommerce_sonypayment_cvs_settings');
delete_site_option('woocommerce_sonypayment_cvs_settings');
