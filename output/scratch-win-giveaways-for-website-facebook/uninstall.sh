...
# Delete Options
wp option delete 'apmswn_payload'
wp option delete 'apmswn_shop_id'
wp option delete 'apmswn_appid'
wp option delete 'apmswn_register'
wp option delete 'woocommerce_enable_coupons'
wp option delete 'apmswn_plgtyp'
wp option delete 'apmswn_admin_email'
