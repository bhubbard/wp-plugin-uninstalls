...
// Delete Options
delete_option('jltma_mcb_activation_time');
delete_site_option('jltma_mcb_activation_time');
delete_option('recently_activated');
delete_site_option('recently_activated');
delete_option('jltma_mcb');
delete_site_option('jltma_mcb');
...
delete_option('jltma_mcb_3_2_4_data_updated');
delete_site_option('jltma_mcb_3_2_4_data_updated');
