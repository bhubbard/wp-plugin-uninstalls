...
delete_site_option('blg_api_key');
delete_option('babylovegrowth_api_key');
delete_site_option('babylovegrowth_api_key');
delete_option('babylovegrowth_category');
delete_site_option('babylovegrowth_category');
delete_option('babylovegrowth_author');
delete_site_option('babylovegrowth_author');
delete_option('babylovegrowth_tags');
delete_site_option('babylovegrowth_tags');
delete_option('babylovegrowth_feature_image_enabled');
delete_site_option('babylovegrowth_feature_image_enabled');
delete_option('babylovegrowth_post_status');
delete_site_option('babylovegrowth_post_status');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_babylovegrowth_jsonld' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_babylovegrowth_jsonld' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_babylovegrowth_jsonld' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_babylovegrowth_jsonld' ) );
