...
# Delete Options
wp option delete 'blg_api_key'
wp option delete 'babylovegrowth_api_key'
wp option delete 'babylovegrowth_category'
wp option delete 'babylovegrowth_author'
wp option delete 'babylovegrowth_tags'
wp option delete 'babylovegrowth_feature_image_enabled'
wp option delete 'babylovegrowth_post_status'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_babylovegrowth_jsonld'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_babylovegrowth_jsonld'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_babylovegrowth_jsonld'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_babylovegrowth_jsonld'"
