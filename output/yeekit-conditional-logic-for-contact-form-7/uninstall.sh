...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'cf7_logic_email'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'cf7_logic_email'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'cf7_logic_email'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'cf7_logic_email'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'cf7_logic'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'cf7_logic'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'cf7_logic'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'cf7_logic'"
