...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('cf7_logic_email', 'cf7_logic');
DELETE FROM wp_usermeta WHERE meta_key IN ('cf7_logic_email', 'cf7_logic');
DELETE FROM wp_termmeta WHERE meta_key IN ('cf7_logic_email', 'cf7_logic');
DELETE FROM wp_commentmeta WHERE meta_key IN ('cf7_logic_email', 'cf7_logic');
