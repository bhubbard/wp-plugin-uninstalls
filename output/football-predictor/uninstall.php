...
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%promo_link' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
...
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%adjust_knockout' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
...
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%user_predictions' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
...
delete_option('fp_adjust_knockout');
delete_site_option('fp_adjust_knockout');
global $wpdb;
...
delete_site_option('fp_db_version');
delete_option('fp_promo_link');
delete_site_option('fp_promo_link');
delete_option('fp_group_stats');
delete_site_option('fp_group_stats');
delete_option('fp_scoring');
delete_site_option('fp_scoring');
delete_option('fp_countdown_format');
delete_site_option('fp_countdown_format');
delete_option('fp_browser_locale');
delete_site_option('fp_browser_locale');
