...
# Delete Options
wp option delete 'revenue_bundle_parent_product_id'
wp option delete 'woocommerce_tax_display_cart'
wp option delete 'woocommerce_tax_display_shop'
wp option delete 'revenue_settings'
wp option delete 'edd_revenue_license_data'
wp option delete 'woocommerce_cart_page_id'
wp option delete 'woocommerce_checkout_page_id'
wp option delete 'revenue_installed_time'
wp option delete 'active_sitewide_plugins'
wp option delete 'edd_revenue_license_key'

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_revenue_%' OR option_name LIKE '_site_transient_revenue_%'"
wp transient delete '_revenue_activation_redirect'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_revx_next_order_coupon_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_revx_next_order_coupon_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_revx_next_order_coupon_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_revx_next_order_coupon_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '_revx_next_order_campaign_id_%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '_revx_next_order_campaign_id_%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '_revx_next_order_campaign_id_%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '_revx_next_order_campaign_id_%'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_revx_next_order_coupon_enable'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_revx_next_order_coupon_enable'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_revx_next_order_coupon_enable'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_revx_next_order_coupon_enable'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_revx_custom_coupon_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_revx_custom_coupon_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_revx_custom_coupon_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_revx_custom_coupon_text'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '_revx_next_order_coupon_eligible_%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '_revx_next_order_coupon_eligible_%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '_revx_next_order_coupon_eligible_%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '_revx_next_order_coupon_eligible_%'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '%_views_counter'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '%_views_counter'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '%_views_counter'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '%_views_counter'"
