...
# Delete Options
wp option delete 'fgoc2wc_options'
wp option delete 'fgoc2wc_last_information_id'
wp option delete 'fgoc2wc_last_product_id'
wp option delete 'fgoc2wc_last_update'
wp option delete 'fgoc2wc_save_posts'
wp option delete 'fgoc2wc_save_terms'
wp option delete 'fgoc2wc_save_term_relationships'
...
wp option delete 'fgoc2wc_stop_import'
wp option delete 'fgoc2wc_default_language'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_children'"
wp option delete 'fgoc2wc_ftp_options'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fgoc2wc_old_information_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fgoc2wc_old_information_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fgoc2wc_old_information_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fgoc2wc_old_information_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fgoc2wc_imported'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fgoc2wc_imported'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fgoc2wc_imported'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fgoc2wc_imported'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fgoc2wc_old_product_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fgoc2wc_old_product_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fgoc2wc_old_product_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fgoc2wc_old_product_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_fgoc2wc_old_file'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_fgoc2wc_old_file'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_fgoc2wc_old_file'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_fgoc2wc_old_file'"
