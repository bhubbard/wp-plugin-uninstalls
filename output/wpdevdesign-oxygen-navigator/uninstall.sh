...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'ct_template_type'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'ct_template_type'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'ct_template_type'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'ct_template_type'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'ct_parent_template'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'ct_parent_template'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'ct_parent_template'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'ct_parent_template'"
