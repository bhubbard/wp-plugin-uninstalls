...
DELETE FROM wp_options WHERE option_name IN ('options_option_name', 'rss_language', 'acf_repeater_ac', 'acf_gallery_ac', 'acf_options_page_ac', 'acf_flexible_content_ac', 'acf_version');
