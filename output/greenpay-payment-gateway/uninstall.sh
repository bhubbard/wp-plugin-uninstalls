...
# Delete Options
wp option delete 'wc_greenpay_version'
wp option delete 'woocommerce_greenpay_settings'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'greenpay_credix_quote'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'greenpay_credix_quote'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'greenpay_credix_quote'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'greenpay_credix_quote'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'greenpay_authorization_number'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'greenpay_authorization_number'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'greenpay_authorization_number'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'greenpay_authorization_number'"
