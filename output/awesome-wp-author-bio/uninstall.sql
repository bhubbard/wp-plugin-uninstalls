...
DELETE FROM wp_options WHERE option_name IN ('jltauthorbio_sheet_promo_data', 'jltauthorbio_sheet_promo_data_hash', 'jltauthorbio_activation_time');
DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking';
DELETE FROM wp_options WHERE option_name LIKE 'jltauthorbio-plugin-info-%';
