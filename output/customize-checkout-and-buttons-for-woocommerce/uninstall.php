...
delete_option('customize_woocommerce_checkout_notice');
delete_site_option('customize_woocommerce_checkout_notice');
...
delete_option('customize_woocommerce_checkout_default_color');
delete_site_option('customize_woocommerce_checkout_default_color');
delete_option('customize_woocommerce_checkout_add_to_cart_text');
delete_site_option('customize_woocommerce_checkout_add_to_cart_text');
