...
wp option delete 'wtr_settings'
wp option delete 'wtr_debug_messages'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'wtr-disable-reading-progress'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'wtr-disable-reading-progress'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'wtr-disable-reading-progress'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'wtr-disable-reading-progress'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'wtr-disable-time-commitment'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'wtr-disable-time-commitment'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'wtr-disable-time-commitment'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'wtr-disable-time-commitment'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'wtr-custom-time-label'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'wtr-custom-time-label'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'wtr-custom-time-label'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'wtr-custom-time-label'"
