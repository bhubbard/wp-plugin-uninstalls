...
// Delete Options
delete_option('sliderpath_api_response');
delete_site_option('sliderpath_api_response');
delete_option('sliderpath_elements_active');
delete_site_option('sliderpath_elements_active');

// Clear Cron Jobs
wp_clear_scheduled_hook('sliderpath_update_data');
