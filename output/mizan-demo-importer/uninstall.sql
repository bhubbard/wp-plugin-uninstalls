...
DELETE FROM wp_options WHERE option_name IN ('mizan_importer_do_activation_redirect', 'hfe_start_onboarding', 'hfe_onboarding_triggered', 'sbi_statuses', 'sbi_plugin_do_activation_redirect', 'charitable_started_onboarding', 'mizan_importer_pro_theme_validation_status', 'mizan_importer_pro_suspension_status', 'wp_pro_theme_key', 'mizan_importer_plugin_license_key', 'recently_activated', '_epl_activation_redirect', 'charitable_activation_redirect', 'charitable_install', 'mizan_importer_free_theme_activation_redirect', 'elementor_activation_redirect', 'update_plugins');
...
DELETE FROM wp_postmeta WHERE meta_key LIKE 'mizan_demo_importer_tgmpa_dismissed_notice_%';
DELETE FROM wp_usermeta WHERE meta_key LIKE 'mizan_demo_importer_tgmpa_dismissed_notice_%';
DELETE FROM wp_termmeta WHERE meta_key LIKE 'mizan_demo_importer_tgmpa_dismissed_notice_%';
DELETE FROM wp_commentmeta WHERE meta_key LIKE 'mizan_demo_importer_tgmpa_dismissed_notice_%';
