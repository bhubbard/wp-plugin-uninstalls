...
# Delete Options
wp option delete 'ccpa_policy_page'
wp option delete 'ccpa_popup_content'
wp option delete 'ccpa_popup_dismiss_text'
wp option delete 'ccpa_popup_allow_text'
wp option delete 'ccpa_popup_learnmore_text'
wp option delete 'ccpa_popup_position'
wp option delete 'ccpa_header'
wp option delete 'ccpa_popup_background'
wp option delete 'ccpa_popup_text'
wp option delete 'ccpa_popup_button_background'
wp option delete 'ccpa_popup_button_text'
wp option delete 'ccpa_popup_link_target'
wp option delete 'ccpa_popup_border_text'
wp option delete 'ccpa_popup_theme'
wp option delete 'ccpa_policy_popup'
wp option delete 'ccpa_onetime_popup'
wp option delete 'ccpa_enable_popup'
wp option delete 'ccpa_custom_policy_page'
wp option delete 'ccpa_consent_until_display'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_db_version'"
wp option delete 'ccpa_privacy_safe_params'
wp option delete 'ccpa_privacy_safe_imagecode'
wp option delete 'ccpa_privacy_safe_backlink_selected'
wp option delete 'ccpa_privacy_safe_backlink'
wp option delete 'ccpa_name_from'
wp option delete 'ccpa_email_from'
wp option delete 'woocommerce_terms_page_id'
wp option delete 'ccpa_plugin_version'
...
wp option delete 'ccpa_enable_stylesheet'
wp option delete 'ccpa_enable'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'ccpa_anonymized_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'ccpa_anonymized_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'ccpa_anonymized_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'ccpa_anonymized_id'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'ccpa_cf7_email_field'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'ccpa_cf7_email_field'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'ccpa_cf7_email_field'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'ccpa_cf7_email_field'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'ccpa_cf7_enabled'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'ccpa_cf7_enabled'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'ccpa_cf7_enabled'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'ccpa_cf7_enabled'"
