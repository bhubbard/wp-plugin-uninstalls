...
DELETE FROM wp_options WHERE option_name IN ('Activated_Plugin', 'rivio_settings', 'rivio_just_installed', 'default_star_ratings_enabled', 'woocommerce_enable_review_rating');
