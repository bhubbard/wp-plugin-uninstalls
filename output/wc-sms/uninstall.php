...
// Delete Options
delete_option('wcsms_logs');
delete_site_option('wcsms_logs');
delete_option('wc_fields_billing');
delete_site_option('wc_fields_billing');
delete_option('woocommerce_cashapp_settings');
delete_site_option('woocommerce_cashapp_settings');
delete_option('woocommerce_cashapp-pro_settings');
delete_site_option('woocommerce_cashapp-pro_settings');
delete_option('woocommerce_venmo_settings');
delete_site_option('woocommerce_venmo_settings');
delete_option('woocommerce_venmo-pro_settings');
delete_site_option('woocommerce_venmo-pro_settings');
delete_option('woocommerce_zelle_settings');
delete_site_option('woocommerce_zelle_settings');
delete_option('woocommerce_zelle-pro_settings');
delete_site_option('woocommerce_zelle-pro_settings');
delete_option('woocommerce_momo_settings');
delete_site_option('woocommerce_momo_settings');
delete_option('woocommerce_momo-pro_settings');
delete_site_option('woocommerce_momo-pro_settings');
delete_option('wcsms_enable_bulksms_on_users');
delete_site_option('wcsms_enable_bulksms_on_users');
delete_option('bulksms_settings');
delete_site_option('bulksms_settings');
