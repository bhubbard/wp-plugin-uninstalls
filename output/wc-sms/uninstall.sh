...
# Delete Options
wp option delete 'wcsms_logs'
wp option delete 'wc_fields_billing'
wp option delete 'woocommerce_cashapp_settings'
wp option delete 'woocommerce_cashapp-pro_settings'
wp option delete 'woocommerce_venmo_settings'
wp option delete 'woocommerce_venmo-pro_settings'
wp option delete 'woocommerce_zelle_settings'
wp option delete 'woocommerce_zelle-pro_settings'
wp option delete 'woocommerce_momo_settings'
wp option delete 'woocommerce_momo-pro_settings'
wp option delete 'wcsms_enable_bulksms_on_users'
wp option delete 'bulksms_settings'
