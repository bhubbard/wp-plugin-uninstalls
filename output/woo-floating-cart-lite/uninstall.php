...
delete_site_option('woo-floating-cart-version');
delete_option('woofc');
delete_site_option('woofc');
delete_option('xt-woo-floating-cart-version');
delete_site_option('xt-woo-floating-cart-version');
delete_option('xt_woofc');
delete_site_option('xt_woofc');
