...
# Delete Options
wp option delete 'superaddons_products_uploads'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_product_uploads_meta'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_product_uploads_meta'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_product_uploads_meta'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_product_uploads_meta'"
