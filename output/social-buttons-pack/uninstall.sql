...
DELETE FROM wp_options WHERE option_name IN ('lnkdn_options', 'pntrst_options', 'bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'fcbkbttn_options', 'sclbttns_options', 'twttr_options', 'update_plugins', 'bws_plugins_update');
