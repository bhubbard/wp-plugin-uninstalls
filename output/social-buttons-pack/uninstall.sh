...
# Delete Options
wp option delete 'lnkdn_options'
wp option delete 'pntrst_options'
wp option delete 'bstwbsftwppdtplgns_options'
wp option delete 'recently_activated'
wp option delete 'active_sitewide_plugins'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_options'"
wp option delete 'fcbkbttn_options'
wp option delete 'sclbttns_options'
wp option delete 'twttr_options'
