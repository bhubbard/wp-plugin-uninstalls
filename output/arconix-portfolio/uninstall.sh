...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_acp_link_type'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_acp_link_type'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_acp_link_type'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_acp_link_type'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_acp_link_value'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_acp_link_value'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_acp_link_value'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_acp_link_value'"
