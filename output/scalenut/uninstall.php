...
// Delete Options
delete_option('crd_id');
delete_site_option('crd_id');

// Delete Transients
delete_transient('scalenut_plugin_error_message');
delete_site_transient('scalenut_plugin_error_message');
delete_transient('scalenut_plugin_warning_message');
delete_site_transient('scalenut_plugin_warning_message');
