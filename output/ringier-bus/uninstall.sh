...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_bus_user_update_%' OR option_name LIKE '_site_transient_bus_user_update_%'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_triggered_bus_event_%' OR option_name LIKE '_site_transient_triggered_bus_event_%'"
