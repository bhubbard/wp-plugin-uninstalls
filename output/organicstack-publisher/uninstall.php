...
// Delete Options
delete_option('organicstack_publisher_api_key');
delete_site_option('organicstack_publisher_api_key');
delete_option('organicstack_publisher_default_author');
delete_site_option('organicstack_publisher_default_author');
delete_option('organicstack_publisher_llms_txt');
delete_site_option('organicstack_publisher_llms_txt');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'organicstack_avatar_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'organicstack_avatar_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'organicstack_avatar_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'organicstack_avatar_id' ) );
