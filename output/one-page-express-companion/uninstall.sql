...
DELETE FROM wp_options WHERE option_name IN ('sidebars_widgets', 'cp_initialize_notifications', 'widget_block');
...
DELETE FROM wp_options WHERE option_name LIKE '%-notice-dismissed';
