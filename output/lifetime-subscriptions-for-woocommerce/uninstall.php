...
delete_option('lifetime_subscription_label');
delete_site_option('lifetime_subscription_label');
delete_option('lifetime_subscriptions_switch_link');
delete_site_option('lifetime_subscriptions_switch_link');
delete_option('lifetime_subscriptions_switch_between_types');
delete_site_option('lifetime_subscriptions_switch_between_types');
