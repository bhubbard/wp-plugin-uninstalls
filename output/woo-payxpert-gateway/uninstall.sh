...
# Delete Options
wp option delete 'payxpert_seamless_library'
wp option delete 'payxpert_conn_status'
wp option delete 'payxpert_originator_id'
wp option delete 'payxpert_password'
wp option delete 'woocommerce_version'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_enabled'"
wp option delete 'woocommerce_email_header_image'

# Delete Transients
wp transient delete 'payxpert_settings_saved'
wp transient delete 'payxpert_admin_error'
wp transient delete 'payxpert_admin_success'
wp transient delete 'payxpert_admin_info'

# Clear Cron Jobs
wp cron event delete 'payxpert_sync_installment_transactions_cron'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_payxpert_paybylink_last_sent'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_payxpert_paybylink_last_sent'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_payxpert_paybylink_last_sent'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_payxpert_paybylink_last_sent'"
