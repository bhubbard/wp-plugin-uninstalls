...
// Delete Options
delete_option('jltdfsm_sheet_promo_data');
delete_site_option('jltdfsm_sheet_promo_data');
delete_option('jltdfsm_sheet_promo_data_hash');
delete_site_option('jltdfsm_sheet_promo_data_hash');
delete_option('jltdfsm_activation_time');
delete_site_option('jltdfsm_activation_time');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('jltdfsm_sheet_promo_data_remote_sync');
