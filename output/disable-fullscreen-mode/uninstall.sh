...
# Delete Options
wp option delete 'jltdfsm_sheet_promo_data'
wp option delete 'jltdfsm_sheet_promo_data_hash'
wp option delete 'jltdfsm_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Clear Cron Jobs
wp cron event delete 'jltdfsm_sheet_promo_data_remote_sync'
