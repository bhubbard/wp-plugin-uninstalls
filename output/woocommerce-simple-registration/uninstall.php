...
// Delete Options
delete_option('role_requests');
delete_site_option('role_requests');
delete_option('select_role_registration');
delete_site_option('select_role_registration');
delete_option('wc_social_login_display');
delete_site_option('wc_social_login_display');
