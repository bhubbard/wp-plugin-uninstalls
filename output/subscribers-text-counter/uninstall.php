...
// Delete Options
delete_option('widget_subscribers_text_counter');
delete_site_option('widget_subscribers_text_counter');
delete_option('widget_subscribers_text_counter_dynamic');
delete_site_option('widget_subscribers_text_counter_dynamic');
