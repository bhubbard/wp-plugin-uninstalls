...
wp option delete 'berocket_tab_manager_third_party_tabs'
wp option delete 'berocket_tabs_cron_enabled'
...
# Clear Cron Jobs
wp cron event delete 'berocket_tabs_cron_func'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_product_tab'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_product_tab'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_product_tab'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_product_tab'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_tabs'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_tabs'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_tabs'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_tabs'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_sku'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_sku'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_sku'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_sku'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_use_specific_tabs'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_use_specific_tabs'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_use_specific_tabs'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_use_specific_tabs'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br-tab_manager-options'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br-tab_manager-options'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br-tab_manager-options'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br-tab_manager-options'"
