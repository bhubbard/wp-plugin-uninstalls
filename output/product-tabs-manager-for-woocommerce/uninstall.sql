...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_product_tab', 'br_tabs', '_sku', 'br_use_specific_tabs', 'br-tab_manager-options');
DELETE FROM wp_usermeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_product_tab', 'br_tabs', '_sku', 'br_use_specific_tabs', 'br-tab_manager-options');
DELETE FROM wp_termmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_product_tab', 'br_tabs', '_sku', 'br_use_specific_tabs', 'br-tab_manager-options');
DELETE FROM wp_commentmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_product_tab', 'br_tabs', '_sku', 'br_use_specific_tabs', 'br-tab_manager-options');
