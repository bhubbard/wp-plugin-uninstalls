...
delete_option('power_daily_cards_plugin_version');
delete_site_option('power_daily_cards_plugin_version');
delete_option('wp_fortune_telling_cards_plugin_option');
delete_site_option('wp_fortune_telling_cards_plugin_option');
