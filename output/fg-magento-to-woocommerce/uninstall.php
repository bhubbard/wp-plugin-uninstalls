...
// Delete Options
delete_option('fgm2wc_options');
delete_site_option('fgm2wc_options');
delete_option('fgm2wc_last_magento_product_id');
delete_site_option('fgm2wc_last_magento_product_id');
delete_option('fgm2wc_last_category_id');
delete_site_option('fgm2wc_last_category_id');
delete_option('fgm2wc_last_magento_cms_id');
delete_site_option('fgm2wc_last_magento_cms_id');
delete_option('fgm2wc_last_update');
delete_site_option('fgm2wc_last_update');
global $wpdb;
...
delete_option('fgm2wc_save_posts');
delete_site_option('fgm2wc_save_posts');
delete_option('fgm2wc_save_terms');
delete_site_option('fgm2wc_save_terms');
delete_option('fgm2wc_save_term_relationships');
delete_site_option('fgm2wc_save_term_relationships');
global $wpdb;
...
delete_option('fgm2wc_stop_import');
delete_site_option('fgm2wc_stop_import');
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgm2wc_old_cms_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgm2wc_old_cms_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgm2wc_old_cms_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgm2wc_old_cms_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'thumbnail_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'thumbnail_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'thumbnail_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'thumbnail_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgm2wc_old_product_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgm2wc_old_product_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgm2wc_old_product_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgm2wc_old_product_id' ) );
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_fgm2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_fgm2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_fgm2wc_old_file' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_fgm2wc_old_file' ) );
