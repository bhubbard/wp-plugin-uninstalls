...
wp option delete 'omfe_opts'
wp option delete 'omfe_install_date'
wp option delete 'omfe_review_notice'
...
wp transient delete 'omfe_activated'
wp transient delete 'omfe_updated'
