...
# Delete Options
wp option delete 'vts_ai_content_logs'
wp option delete 'vts_ai_content_prompts'
wp option delete 'vts_ai_content_user_email'
wp option delete 'vts_ai_content_registration_step'
wp option delete 'vts_ai_content_api_key'
wp option delete 'vts_ai_google_access_token'
wp option delete 'vts_ai_google_refresh_token'
wp option delete 'vts_ai_google_token_expires_at'
wp option delete 'vts_ai_google_token_type'
wp option delete 'vts_ai_google_scope'
wp option delete 'vts_ai_google_id_token'
wp option delete 'vts_ai_content_model'
