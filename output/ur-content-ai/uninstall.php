...
// Delete Options
delete_option('vts_ai_content_logs');
delete_site_option('vts_ai_content_logs');
delete_option('vts_ai_content_prompts');
delete_site_option('vts_ai_content_prompts');
delete_option('vts_ai_content_user_email');
delete_site_option('vts_ai_content_user_email');
delete_option('vts_ai_content_registration_step');
delete_site_option('vts_ai_content_registration_step');
delete_option('vts_ai_content_api_key');
delete_site_option('vts_ai_content_api_key');
delete_option('vts_ai_google_access_token');
delete_site_option('vts_ai_google_access_token');
delete_option('vts_ai_google_refresh_token');
delete_site_option('vts_ai_google_refresh_token');
delete_option('vts_ai_google_token_expires_at');
delete_site_option('vts_ai_google_token_expires_at');
delete_option('vts_ai_google_token_type');
delete_site_option('vts_ai_google_token_type');
delete_option('vts_ai_google_scope');
delete_site_option('vts_ai_google_scope');
delete_option('vts_ai_google_id_token');
delete_site_option('vts_ai_google_id_token');
delete_option('vts_ai_content_model');
delete_site_option('vts_ai_content_model');
