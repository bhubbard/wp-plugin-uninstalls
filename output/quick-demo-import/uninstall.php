...
// Delete Options
delete_option('_quick_demo_import_imported_demo_id');
delete_site_option('_quick_demo_import_imported_demo_id');
global $wpdb;
...
// Delete Transients
delete_transient('_quick_demo_import_activation_redirect');
delete_site_transient('_quick_demo_import_activation_redirect');
