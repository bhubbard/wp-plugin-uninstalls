...
// Delete Options
delete_option('bulk_alt_text_processing');
delete_site_option('bulk_alt_text_processing');
delete_option('altgen_attachments_jobs');
delete_site_option('altgen_attachments_jobs');
delete_option('bdaiatg_bulk_generating');
delete_site_option('bdaiatg_bulk_generating');
delete_option('error_during_background_task_no_credit');
delete_site_option('error_during_background_task_no_credit');
delete_option('altgen_last_bulk_stats');
delete_site_option('altgen_last_bulk_stats');
