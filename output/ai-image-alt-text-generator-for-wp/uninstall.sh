...
# Delete Options
wp option delete 'bulk_alt_text_processing'
wp option delete 'altgen_attachments_jobs'
wp option delete 'bdaiatg_bulk_generating'
wp option delete 'error_during_background_task_no_credit'
wp option delete 'altgen_last_bulk_stats'
