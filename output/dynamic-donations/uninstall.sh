...
# Delete Options
wp option delete 'dydo_options'
wp option delete 'woocommerce_currency'
wp option delete 'dydo_woocommerce_enabled'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'dydo_stripe_customer_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'dydo_stripe_customer_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'dydo_stripe_customer_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'dydo_stripe_customer_id'"
