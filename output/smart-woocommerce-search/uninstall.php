...
// Delete Options
delete_option('sws_update_notice');
delete_site_option('sws_update_notice');
...
delete_option('ywp_smart_search_enable_synonyms_indexing');
delete_site_option('ywp_smart_search_enable_synonyms_indexing');
