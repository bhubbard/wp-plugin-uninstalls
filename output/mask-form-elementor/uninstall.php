...
delete_option('mask-form-install-by');
delete_site_option('mask-form-install-by');
...
delete_option('mfe-v');
delete_site_option('mfe-v');
delete_option('mfe-install-date');
delete_site_option('mfe-install-date');
...
');
delete_option('mfe_marketing_dismissed');
delete_site_option('mfe_marketing_dismissed');
delete_option('mfe_tec_notice_dismissed');
delete_site_option('mfe_tec_notice_dismissed');
delete_option('cfef_formdb_marketing_dismissed');
delete_site_option('cfef_formdb_marketing_dismissed');
...
delete_option('fme_elementor_notice_dismiss');
delete_site_option('fme_elementor_notice_dismiss');
delete_option('mfe-installDate');
delete_site_option('mfe-installDate');
delete_option('mfe_migration_done');
delete_site_option('mfe_migration_done');
delete_option('mfe_old_widget_id');
delete_site_option('mfe_old_widget_id');
delete_option('mfe-type');
delete_site_option('mfe-type');
