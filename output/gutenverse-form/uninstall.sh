...
wp option delete 'gutenverse_form_action_notice'
wp option delete 'gutenverse_form_pro_notice'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'entry-data'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'entry-data'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'entry-data'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'entry-data'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'form-data'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'form-data'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'form-data'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'form-data'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'form-id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'form-id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'form-id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'form-id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'post-id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'post-id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'post-id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'post-id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'browser-data'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'browser-data'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'browser-data'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'browser-data'"
