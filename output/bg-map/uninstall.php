...
delete_option('link_19');
delete_site_option('link_19');
delete_option('link_20');
delete_site_option('link_20');
delete_option('link_21');
delete_site_option('link_21');
delete_option('link_23');
delete_site_option('link_23');
delete_option('link_22');
delete_site_option('link_22');
delete_option('link_24');
delete_site_option('link_24');
delete_option('link_25');
delete_site_option('link_25');
delete_option('link_26');
delete_site_option('link_26');
delete_option('link_27');
delete_site_option('link_27');
delete_option('link_28');
delete_site_option('link_28');
