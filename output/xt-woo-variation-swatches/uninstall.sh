...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'swatch_tooltip_image'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'swatch_tooltip_image'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'swatch_tooltip_image'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'swatch_tooltip_image'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'swatch_tooltip_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'swatch_tooltip_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'swatch_tooltip_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'swatch_tooltip_text'"
