...
// Delete Options
delete_option('jltelcl_sheet_promo_data');
delete_site_option('jltelcl_sheet_promo_data');
delete_option('jltelcl_sheet_promo_data_hash');
delete_site_option('jltelcl_sheet_promo_data_hash');
delete_option('jltelcl_activation_time');
delete_site_option('jltelcl_activation_time');
global $wpdb;
