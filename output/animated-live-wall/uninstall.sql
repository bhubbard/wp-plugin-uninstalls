...
DELETE FROM wp_postmeta WHERE meta_key LIKE 'awl_animated_live_wall%';
DELETE FROM wp_usermeta WHERE meta_key LIKE 'awl_animated_live_wall%';
DELETE FROM wp_termmeta WHERE meta_key LIKE 'awl_animated_live_wall%';
DELETE FROM wp_commentmeta WHERE meta_key LIKE 'awl_animated_live_wall%';
