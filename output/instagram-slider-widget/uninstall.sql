...
DELETE FROM wp_options WHERE option_name IN ('sidebars_widgets', 'widget_jr_insta_slider', 'widget_wyoutube_feed', 'widget_wfacebook_feed', 'instagram_slider_widget_logger_flag', 'factory_plugin_versions', 'wis_account', 'wis_youtube_account', 'themeisle_sdk_notifications', 'otter_reference_key', 'optimole_reference_key', 'rop_reference_key', 'neve_reference_key', 'hyve_reference_key', 'wp_full_pay_reference_key', 'feedzy_reference_key', 'themeisle_sdk_promotions_otter', 'jr_insta_user_ids', 'app_ids_cache', 'wbcr_factory_google_fonts', 'wbcr_factory_google_fonts_raw', 'wis_instagram_widget_195', 'wis_youtube_widget_195', 'themeisle_sdk_cache_token', 'themeisle_sdk_feed_items', 'themeisle_sdk_products', 'tsk_attachment_count', 'tsk_posts_count', 'update_plugins', 'update_themes');
