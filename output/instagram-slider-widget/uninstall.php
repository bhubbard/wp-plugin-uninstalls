...
delete_option('widget_jr_insta_slider');
delete_site_option('widget_jr_insta_slider');
delete_option('widget_wyoutube_feed');
delete_site_option('widget_wyoutube_feed');
delete_option('widget_wfacebook_feed');
delete_site_option('widget_wfacebook_feed');
delete_option('instagram_slider_widget_logger_flag');
delete_site_option('instagram_slider_widget_logger_flag');
...
delete_option('wis_account');
delete_site_option('wis_account');
delete_option('wis_youtube_account');
delete_site_option('wis_youtube_account');
global $wpdb;
...
// Delete Transients
delete_transient('jr_insta_user_ids');
delete_site_transient('jr_insta_user_ids');
delete_transient('app_ids_cache');
delete_site_transient('app_ids_cache');
...
delete_transient('wis_instagram_widget_195');
delete_site_transient('wis_instagram_widget_195');
delete_transient('wis_youtube_widget_195');
delete_site_transient('wis_youtube_widget_195');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('jr_insta_cron');
