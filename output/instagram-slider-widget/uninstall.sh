...
wp option delete 'widget_jr_insta_slider'
wp option delete 'widget_wyoutube_feed'
wp option delete 'widget_wfacebook_feed'
wp option delete 'instagram_slider_widget_logger_flag'
wp option delete 'factory_plugin_versions'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_is_active'"
wp option delete 'wis_account'
wp option delete 'wis_youtube_account'
...
# Delete Transients
wp transient delete 'jr_insta_user_ids'
wp transient delete 'app_ids_cache'
wp transient delete 'wbcr_factory_google_fonts'
wp transient delete 'wbcr_factory_google_fonts_raw'
wp transient delete 'wis_instagram_widget_195'
wp transient delete 'wis_youtube_widget_195'
...
# Clear Cron Jobs
wp cron event delete 'jr_insta_cron'
