...
// Delete Options
delete_option('udisg_title');
delete_site_option('udisg_title');
delete_option('udisg_width');
delete_site_option('udisg_width');
delete_option('udisg_height');
delete_site_option('udisg_height');
delete_option('udisg_pause');
delete_site_option('udisg_pause');
delete_option('udisg_cycles');
delete_site_option('udisg_cycles');
delete_option('udisg_persist');
delete_site_option('udisg_persist');
delete_option('udisg_slideduration');
delete_site_option('udisg_slideduration');
delete_option('udisg_random');
delete_site_option('udisg_random');
delete_option('udisg_type');
delete_site_option('udisg_type');
