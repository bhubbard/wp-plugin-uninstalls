...
// Delete Options
delete_option('ywcfav_video_placeholder_id');
delete_site_option('ywcfav_video_placeholder_id');
delete_option('yith_wcmg_enable_mobile');
delete_site_option('yith_wcmg_enable_mobile');
delete_option('yith_wcmg_enable_plugin');
delete_site_option('yith_wcmg_enable_plugin');
...
delete_option('ywcfav_aspectratio');
delete_site_option('ywcfav_aspectratio');
