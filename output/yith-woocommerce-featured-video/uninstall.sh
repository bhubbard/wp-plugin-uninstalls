...
# Delete Options
wp option delete 'ywcfav_video_placeholder_id'
wp option delete 'yith_wcmg_enable_mobile'
wp option delete 'yith_wcmg_enable_plugin'
...
wp option delete 'ywcfav_aspectratio'
