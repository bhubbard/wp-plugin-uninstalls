...
DELETE FROM wp_options WHERE option_name IN ('bwssmtp_options', 'bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'update_plugins', 'bws_plugins_update');
