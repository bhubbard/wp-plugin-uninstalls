...
// Delete Options
delete_option('jlt_loginfy_sheet_promo_data');
delete_site_option('jlt_loginfy_sheet_promo_data');
delete_option('jlt_loginfy_sheet_promo_data_hash');
delete_site_option('jlt_loginfy_sheet_promo_data_hash');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_is_synced' ) );
...
delete_option('jlt_loginfy_activation_time');
delete_site_option('jlt_loginfy_activation_time');
global $wpdb;
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_jlt_loginfy-plugin-info-%', '_site_transient_jlt_loginfy-plugin-info-%' ) );
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key LIKE %s", '_loginfy_errors_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key LIKE %s", '_loginfy_errors_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key LIKE %s", '_loginfy_errors_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key LIKE %s", '_loginfy_errors_%' ) );
