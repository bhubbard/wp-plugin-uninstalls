...
wp option delete 'ced_tiktok_woo_connection_data'
...
wp option delete 'ced_woo_cedcommerce_connection_data'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_ced_marketplace'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_ced_marketplace'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_ced_marketplace'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_ced_marketplace'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'shipping_label'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'shipping_label'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'shipping_label'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'shipping_label'"
