...
delete_site_option('sema_settings');
delete_option('woocommerce_weight_unit');
delete_site_option('woocommerce_weight_unit');
delete_option('sema_plugin_version');
delete_site_option('sema_plugin_version');
delete_option('woocommerce_permalinks');
delete_site_option('woocommerce_permalinks');
delete_option('sema_hide_productwoimage');
delete_site_option('sema_hide_productwoimage');
