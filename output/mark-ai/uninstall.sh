...
# Delete Options
wp option delete 'markai_api_key'
wp option delete 'markai_api_user'
wp option delete 'markai_integration_id'
wp option delete 'markai_author_mode'
wp option delete 'markai_association_id'
