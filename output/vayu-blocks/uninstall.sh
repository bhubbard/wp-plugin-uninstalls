...
# Delete Options
wp option delete 'vayu_blocks_settings'
wp option delete 'vayu_blocks_options'
wp option delete 'themehunk-settings'
wp option delete 'themehunk_recent_import_log_file'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'sidebars_widgets'

# Delete Transients
wp transient delete 'vayu_remote_manifest'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_vayu_source_url'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_vayu_source_url'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_vayu_source_url'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_vayu_source_url'"
