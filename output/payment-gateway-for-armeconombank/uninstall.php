...
// Delete Options
delete_option('hkd_armeconom_version_option');
delete_site_option('hkd_armeconom_version_option');
delete_option('language_payment_aeb');
delete_site_option('language_payment_aeb');
delete_option('hkd_armeconombank_checkout_id');
delete_site_option('hkd_armeconombank_checkout_id');
delete_option('hkd_check_activation_aeb');
delete_site_option('hkd_check_activation_aeb');
...
// Clear Cron Jobs
wp_clear_scheduled_hook('cronCheckOrderArmeconombank');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'bindingInfo_armeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'bindingInfo_armeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'bindingInfo_armeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'bindingInfo_armeconombank' ) );
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key LIKE %s", 'recurringChargeAEB%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key LIKE %s", 'recurringChargeAEB%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key LIKE %s", 'recurringChargeAEB%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key LIKE %s", 'recurringChargeAEB%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'FailedMessageArmeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'FailedMessageArmeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'FailedMessageArmeconombank' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'FailedMessageArmeconombank' ) );
