...
# Delete Options
wp option delete 'hkd_armeconom_version_option'
wp option delete 'language_payment_aeb'
wp option delete 'hkd_armeconombank_checkout_id'
wp option delete 'hkd_check_activation_aeb'
wp option delete 'hkdump'
wp option delete 'woocommerce_checkout_page_id'

# Clear Cron Jobs
wp cron event delete 'cronCheckOrderArmeconombank'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'bindingInfo_armeconombank'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'bindingInfo_armeconombank'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'bindingInfo_armeconombank'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'bindingInfo_armeconombank'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE 'recurringChargeAEB%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE 'recurringChargeAEB%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE 'recurringChargeAEB%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE 'recurringChargeAEB%'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'FailedMessageArmeconombank'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'FailedMessageArmeconombank'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'FailedMessageArmeconombank'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'FailedMessageArmeconombank'"
