...
# Delete Options
wp option delete 'easy_announcements'
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_easy_announcements_%' OR option_name LIKE '_site_transient_easy_announcements_%'"
