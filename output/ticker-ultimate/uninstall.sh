...
# Delete Transients
wp transient delete 'wptu_install_notice'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '%more_link'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '%more_link'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '%more_link'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '%more_link'"
