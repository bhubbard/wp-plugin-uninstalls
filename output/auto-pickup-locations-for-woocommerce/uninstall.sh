...
wp option delete 'digages_aplwoo_send_data_option'
wp option delete 'digages_aplwoo_plugin_onboarding_redirect'
wp option delete 'woocommerce_digages_aplwoo_local_shipping_settings'
wp option delete 'digages_aplwoo_label'
