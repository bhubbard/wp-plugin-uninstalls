...
delete_option('digages_aplwoo_send_data_option');
delete_site_option('digages_aplwoo_send_data_option');
delete_option('digages_aplwoo_plugin_onboarding_redirect');
delete_site_option('digages_aplwoo_plugin_onboarding_redirect');
delete_option('woocommerce_digages_aplwoo_local_shipping_settings');
delete_site_option('woocommerce_digages_aplwoo_local_shipping_settings');
delete_option('digages_aplwoo_label');
delete_site_option('digages_aplwoo_label');
