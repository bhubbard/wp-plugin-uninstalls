...
wp option delete 'uris_updated_slider_ids'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE 'gspint_metabox_%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE 'gspint_metabox_%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE 'gspint_metabox_%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE 'gspint_metabox_%'"
