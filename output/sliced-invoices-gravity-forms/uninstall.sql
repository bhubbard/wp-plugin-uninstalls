...
DELETE FROM wp_options WHERE option_name IN ('sliced_general', 'sliced_translate', 'sliced_invoices', 'sliced_quotes', 'sliced_tax');

-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('_sliced_description', '_sliced_number', '_sliced_order_number', '_sliced_tax_calc_method', '_sliced_tax', '_sliced_tax_name', '_sliced_additional_tax_name', '_sliced_additional_tax_rate', '_sliced_additional_tax_type', '_sliced_payment_methods', '_sliced_invoice_due', '_sliced_quote_valid_until', '_sliced_items', '_sliced_client_business', '_sliced_client_address', '_sliced_client_extra_info', '_sliced_client');
DELETE FROM wp_usermeta WHERE meta_key IN ('_sliced_description', '_sliced_number', '_sliced_order_number', '_sliced_tax_calc_method', '_sliced_tax', '_sliced_tax_name', '_sliced_additional_tax_name', '_sliced_additional_tax_rate', '_sliced_additional_tax_type', '_sliced_payment_methods', '_sliced_invoice_due', '_sliced_quote_valid_until', '_sliced_items', '_sliced_client_business', '_sliced_client_address', '_sliced_client_extra_info', '_sliced_client');
DELETE FROM wp_termmeta WHERE meta_key IN ('_sliced_description', '_sliced_number', '_sliced_order_number', '_sliced_tax_calc_method', '_sliced_tax', '_sliced_tax_name', '_sliced_additional_tax_name', '_sliced_additional_tax_rate', '_sliced_additional_tax_type', '_sliced_payment_methods', '_sliced_invoice_due', '_sliced_quote_valid_until', '_sliced_items', '_sliced_client_business', '_sliced_client_address', '_sliced_client_extra_info', '_sliced_client');
DELETE FROM wp_commentmeta WHERE meta_key IN ('_sliced_description', '_sliced_number', '_sliced_order_number', '_sliced_tax_calc_method', '_sliced_tax', '_sliced_tax_name', '_sliced_additional_tax_name', '_sliced_additional_tax_rate', '_sliced_additional_tax_type', '_sliced_payment_methods', '_sliced_invoice_due', '_sliced_quote_valid_until', '_sliced_items', '_sliced_client_business', '_sliced_client_address', '_sliced_client_extra_info', '_sliced_client');
