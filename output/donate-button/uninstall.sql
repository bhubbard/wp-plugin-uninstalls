...
DELETE FROM wp_options WHERE option_name IN ('bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'dnt_options', 'widget_donate_widget', 'update_plugins', 'bws_plugins_update');
