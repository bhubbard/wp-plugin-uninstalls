...
DELETE FROM wp_options WHERE option_name IN ('viredis_params', 'woocommerce_tax_display_shop', 'villatheme_hide_admin_toolbar', 'villatheme_call', 'villatheme_notices', 'villatheme_called', 'villatheme_ads');
