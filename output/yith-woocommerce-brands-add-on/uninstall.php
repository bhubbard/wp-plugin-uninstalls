...
// Delete Options
delete_option('yith_wcbr_single_product_brands_size');
delete_site_option('yith_wcbr_single_product_brands_size');
delete_option('yith_wcbr_brands_label');
delete_site_option('yith_wcbr_brands_label');
delete_option('yith_wcbr_single_product_brands_content');
delete_site_option('yith_wcbr_single_product_brands_content');
