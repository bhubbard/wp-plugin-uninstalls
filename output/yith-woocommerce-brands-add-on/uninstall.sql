...
DELETE FROM wp_options WHERE option_name IN ('yith_wcbr_single_product_brands_size', 'yith_wcbr_brands_label', 'yith_wcbr_single_product_brands_content', 'yit_font_awesome_list', 'yit_dashicons_list', 'yit_plugin_fw_panel_wc_default_options_set', 'yit_recently_activated', 'yith_system_info', 'yith-plugin-fw-latest-hc-articles', 'yith-plugin-fw-system-status-tls-version', 'yith-plugin-fw-system-status-output-ip', 'update_plugins');
