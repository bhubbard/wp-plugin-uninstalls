...
// Delete Options
delete_option('woopei_show_rating');
delete_site_option('woopei_show_rating');
delete_option('woopei_hide_rating');
delete_site_option('woopei_hide_rating');

// Delete Transients
delete_transient('woopei_notified');
delete_site_transient('woopei_notified');
delete_transient('woopei_notification');
delete_site_transient('woopei_notification');
