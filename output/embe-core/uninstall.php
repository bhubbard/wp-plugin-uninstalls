...
// Delete Options
delete_option('alith_option');
delete_site_option('alith_option');
...
delete_site_option('wbc_imported_demos');
delete_option('wbc_import_progress');
delete_site_option('wbc_import_progress');
...
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_st_instagram_%', '_site_transient_st_instagram_%' ) );
foreach ( $transients as $transient ) {
	delete_option( $transient );
}
delete_transient('aliththeme_alith_tweet_feed');
delete_site_transient('aliththeme_alith_tweet_feed');
