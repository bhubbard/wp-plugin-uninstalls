...
wp option delete 'woocommerce_plationline_additional_settings'
wp option delete 'woocommerce_plationline_settings'
wp option delete 'woocommerce_plationline_recurrence_settings'
wp option delete 'woocommerce_plationline_woocommerce_subscriptions_settings'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'plationline_redirect_url'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'plationline_redirect_url'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'plationline_redirect_url'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'plationline_redirect_url'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'plationline_status_history'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'plationline_status_history'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'plationline_status_history'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'plationline_status_history'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_plationline_recurrence_master_order_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_plationline_recurrence_master_order_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_plationline_recurrence_master_order_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_plationline_recurrence_master_order_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_plationline_recurrence_master_transaction_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_plationline_recurrence_master_transaction_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_plationline_recurrence_master_transaction_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_plationline_recurrence_master_transaction_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_plationline_transaction_type'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_plationline_transaction_type'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_plationline_transaction_type'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_plationline_transaction_type'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_plationline_enable_recurrence'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_plationline_enable_recurrence'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_plationline_enable_recurrence'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_plationline_enable_recurrence'"
