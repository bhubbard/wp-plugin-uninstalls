...
delete_option('th23_terms_title');
delete_site_option('th23_terms_title');
delete_option('th23_terms_url');
delete_site_option('th23_terms_url');
delete_option('th23_contact_options');
delete_site_option('th23_contact_options');
