...
// Delete Options
delete_option('mapfy_sheet_promo_data');
delete_site_option('mapfy_sheet_promo_data');
delete_option('mapfy_sheet_promo_data_hash');
delete_site_option('mapfy_sheet_promo_data_hash');
delete_option('element_pack_api_settings');
delete_site_option('element_pack_api_settings');
delete_option('mapfy_activation_time');
delete_site_option('mapfy_activation_time');
global $wpdb;
