...
# Delete Options
wp option delete 'mapfy_sheet_promo_data'
wp option delete 'mapfy_sheet_promo_data_hash'
wp option delete 'element_pack_api_settings'
wp option delete 'mapfy_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Clear Cron Jobs
wp cron event delete 'mapfy_sheet_promo_data_remote_sync'
