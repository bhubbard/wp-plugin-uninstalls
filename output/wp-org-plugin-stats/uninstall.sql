...
DELETE FROM wp_options WHERE option_name IN ('jltwporgst_sheet_promo_data', 'jltwporgst_sheet_promo_data_hash', 'worg_plugin_request', 'jltwporgst_activation_time');
