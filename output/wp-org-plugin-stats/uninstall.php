...
// Delete Options
delete_option('jltwporgst_sheet_promo_data');
delete_site_option('jltwporgst_sheet_promo_data');
delete_option('jltwporgst_sheet_promo_data_hash');
delete_site_option('jltwporgst_sheet_promo_data_hash');
delete_option('worg_plugin_request');
delete_site_option('worg_plugin_request');
delete_option('jltwporgst_activation_time');
delete_site_option('jltwporgst_activation_time');
global $wpdb;
