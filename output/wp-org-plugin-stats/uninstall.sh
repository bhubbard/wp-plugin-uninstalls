...
# Delete Options
wp option delete 'jltwporgst_sheet_promo_data'
wp option delete 'jltwporgst_sheet_promo_data_hash'
wp option delete 'worg_plugin_request'
wp option delete 'jltwporgst_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Clear Cron Jobs
wp cron event delete 'jltwporgst_sheet_promo_data_remote_sync'
wp cron event delete 'cron_save_org_downloads'
