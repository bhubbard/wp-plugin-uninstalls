...
// Delete Options
delete_option('ppom_css_output');
delete_site_option('ppom_css_output');
delete_option('ppom_settings_migration_done');
delete_site_option('ppom_settings_migration_done');
global $wpdb;
...
delete_option('ppom_legacy_user');
delete_site_option('ppom_legacy_user');
delete_option('personalizedproduct_db_version');
delete_site_option('personalizedproduct_db_version');
...
delete_site_option('ppom_demo_meta_installed');
delete_option('woocommerce_product_addon_install');
delete_site_option('woocommerce_product_addon_install');
...
delete_option('ppom_pro_license_data');
delete_site_option('ppom_pro_license_data');
global $wpdb;
...
delete_site_transient('ppom_meta_imported');
global $wpdb;
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_ppom_fields' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_ppom_fields' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_ppom_fields' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_ppom_fields' ) );
