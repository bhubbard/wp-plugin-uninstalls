...
// Delete Options
delete_option('duplica_version');
delete_site_option('duplica_version');
delete_option('duplica_install_time');
delete_site_option('duplica_install_time');
delete_option('duplica_settings_init');
delete_site_option('duplica_settings_init');
delete_option('duplica_docs_json');
delete_site_option('duplica_docs_json');
