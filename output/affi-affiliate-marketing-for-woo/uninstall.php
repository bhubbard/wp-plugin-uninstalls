...
delete_option('villatheme_affi_data');
delete_site_option('villatheme_affi_data');
delete_option('uap_mlm_enable');
delete_site_option('uap_mlm_enable');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('affi_execute_rank_cron');
