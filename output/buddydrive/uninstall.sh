...
wp option delete '_buddydrive_db_version'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_buddydrive_user_quota'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_buddydrive_user_quota'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_buddydrive_user_quota'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_buddydrive_user_quota'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_buddydrive_sharing_members'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_buddydrive_sharing_members'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_buddydrive_sharing_members'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_buddydrive_sharing_members'"
