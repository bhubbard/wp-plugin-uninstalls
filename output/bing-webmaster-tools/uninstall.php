...
delete_site_option('bwt-failed_count');
delete_option('bwt-passed_count');
delete_site_option('bwt-passed_count');
delete_option('bwt-is_valid_api_key');
delete_site_option('bwt-is_valid_api_key');
delete_option('bwt-admin_api_key');
delete_site_option('bwt-admin_api_key');
delete_option('bwt-auto_submission_enabled');
delete_site_option('bwt-auto_submission_enabled');
