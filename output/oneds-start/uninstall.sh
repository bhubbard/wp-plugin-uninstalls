...
wp transient delete 'online_users'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'admin_acf_menu'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'admin_acf_menu'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'admin_acf_menu'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'admin_acf_menu'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'no_theme_switch'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'no_theme_switch'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'no_theme_switch'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'no_theme_switch'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'admin_dashboard_widgets'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'admin_dashboard_widgets'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'admin_dashboard_widgets'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'admin_dashboard_widgets'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'admin_language_switcher'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'admin_language_switcher'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'admin_language_switcher'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'admin_language_switcher'"
