...
// Delete Options
delete_option('mantrabrain_starter_sites_admin_footer_text_rated');
delete_site_option('mantrabrain_starter_sites_admin_footer_text_rated');
delete_option('mantrabrain_starter_sites_activated_id');
delete_site_option('mantrabrain_starter_sites_activated_id');
global $wpdb;
...
delete_site_transient('mantrabrain_get_theme_demo_configuration');
delete_transient('_mantrabrain_starter_sites_activation_redirect');
delete_site_transient('_mantrabrain_starter_sites_activation_redirect');
