...
// Delete Options
delete_option('sinatra_wpforms_imported_ids');
delete_site_option('sinatra_wpforms_imported_ids');
...
// Delete Transients
delete_transient('sinatra_check_plugin_update');
delete_site_transient('sinatra_check_plugin_update');
delete_transient('sinatra_core_demo_templates');
delete_site_transient('sinatra_core_demo_templates');
