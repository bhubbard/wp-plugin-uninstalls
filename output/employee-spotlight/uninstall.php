...
delete_option('employee_spotlight_access_views');
delete_site_option('employee_spotlight_access_views');
delete_option('employee_spotlight_ent_map_list');
delete_site_option('employee_spotlight_ent_map_list');
delete_option('employee_spotlight_tax_settings');
delete_site_option('employee_spotlight_tax_settings');
delete_option('employee_spotlight_tools');
delete_site_option('employee_spotlight_tools');
global $wpdb;
...
delete_site_option('empslight_com_vcard_field_list');
delete_option('employee_spotlight_tracking_optin');
delete_site_option('employee_spotlight_tracking_optin');
delete_option('employee_spotlight_show_rateme_plugin_min');
delete_site_option('employee_spotlight_show_rateme_plugin_min');
delete_option('employee_spotlight_ent_list');
delete_site_option('employee_spotlight_ent_list');
delete_option('employee_spotlight_activation_date');
delete_site_option('employee_spotlight_activation_date');
delete_option('employee_spotlight_tax_list');
delete_site_option('employee_spotlight_tax_list');
delete_option('employee_spotlight_rel_list');
delete_site_option('employee_spotlight_rel_list');
delete_option('employee_spotlight_shc_list');
delete_site_option('employee_spotlight_shc_list');
global $wpdb;
...
delete_option('employee_spotlight_attr_list');
delete_site_option('employee_spotlight_attr_list');
