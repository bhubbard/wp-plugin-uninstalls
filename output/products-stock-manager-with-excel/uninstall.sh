...
# Delete Options
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%lowStockValue'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%addStockNumber'"

# Delete Transients
wp transient delete 'stock_manager_notification'
