...
wp option delete 'country-code-install-by'
...
wp option delete 'country_code_initial_version'
wp option delete 'ccfef-install-date'
wp option delete 'cfef_usage_share_data'
wp option delete 'ccfef-v'
wp option delete 'cfef_formdb_marketing_dismissed
'
wp option delete 'ccfef_marketing_dismissed'
