...
# Delete Options
wp option delete 'unifiedsmb_log_cleanup_settings'
wp option delete 'unifiedsmb_last_sync'
wp option delete 'unifiedsmb_settings'
wp option delete 'unifiedsmb_default_user_role'
wp option delete 'unifiedsmb_quick_sync_type'
wp option delete 'unifiedsmb_user_roles'
wp option delete 'unifiedsmb_brands_sync_as_attribute'
wp option delete 'unifiedsmb_order_webhook_hook'
wp option delete 'unifiedsmb_prefix'

# Delete Transients
wp transient delete 'unifiedsmb_settings_error'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_unifiedsmb_notice_dismissed_%' OR option_name LIKE '_site_transient_unifiedsmb_notice_dismissed_%'"
wp transient delete 'unifiedsmb_backoffice_payment_gateways'
wp transient delete 'unifiedsmb_settings_retail_error'
wp transient delete 'unifiedsmb_settings_latest_collection_error'
wp transient delete 'unifiedsmb_backoffice_connection_check'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'unifiedsmb_user'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'unifiedsmb_user'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'unifiedsmb_user'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'unifiedsmb_user'"
