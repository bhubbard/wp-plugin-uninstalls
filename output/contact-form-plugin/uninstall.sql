...
DELETE FROM wp_options WHERE option_name IN ('bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'cntctfrm_options', 'cntctfrmmlt_options', 'cntctfrmmltpr_options_main', 'cntctfrmmlt_options_1', 'cntctfrmmlt_options_main', 'cptch_options', 'gglcptch_options', 'sbscrbr_options', 'cntctfrmtdb_options', 'update_plugins', 'bws_plugins_update');
