...
// Delete Options
delete_option('gutenverse-companion-base-theme');
delete_site_option('gutenverse-companion-base-theme');
delete_option('gutenverse_active_time');
delete_site_option('gutenverse_active_time');
delete_option('gutenverse_theme_select_complete');
delete_site_option('gutenverse_theme_select_complete');
...
delete_site_transient('gutenverse_wizard_redirect');
