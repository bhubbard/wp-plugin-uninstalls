...
delete_option('wccbel-version');
delete_site_option('wccbel-version');
delete_option('wccbe_update_table_log');
delete_site_option('wccbe_update_table_log');
delete_option('wccbe_meta_fields');
delete_site_option('wccbe_meta_fields');
delete_option('wccbe_column_fields');
delete_site_option('wccbe_column_fields');
delete_option('wccbe_pro_last_check_for_update');
delete_site_option('wccbe_pro_last_check_for_update');
global $wpdb;
...
delete_option('wccbel_some_setting');
delete_site_option('wccbel_some_setting');
delete_option('wccbel_usage_track');
delete_site_option('wccbel_usage_track');
delete_option('wccbel_onboarding');
delete_site_option('wccbel_onboarding');
delete_option('wccbel_opt_in');
delete_site_option('wccbel_opt_in');
...
delete_option('wbebl-version');
delete_site_option('wbebl-version');
delete_option('wbebl_free_gifts_plugin_banner_dismissed');
delete_site_option('wbebl_free_gifts_plugin_banner_dismissed');
delete_option('wbebl_is_active');
delete_site_option('wbebl_is_active');
delete_option('wbebl_some_setting');
delete_site_option('wbebl_some_setting');
delete_option('wbebl_usage_track');
delete_site_option('wbebl_usage_track');
delete_option('wbebl_onboarding');
delete_site_option('wbebl_onboarding');
delete_option('wbebl_opt_in');
delete_site_option('wbebl_opt_in');
