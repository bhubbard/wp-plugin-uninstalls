...
// Delete Options
delete_option('ANANTA_demo_installed');
delete_site_option('ANANTA_demo_installed');
global $wpdb;
...
delete_option('compare_template_select');
delete_site_option('compare_template_select');
