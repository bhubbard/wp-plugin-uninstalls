...
// Delete Options
delete_option('wp_ai_pilot_models');
delete_site_option('wp_ai_pilot_models');
delete_option('wpaico-pilotpro_license_options');
delete_site_option('wpaico-pilotpro_license_options');
