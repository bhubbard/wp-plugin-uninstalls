...
delete_option('premmerce_multicurrency_ajax_prices_redraw');
delete_site_option('premmerce_multicurrency_ajax_prices_redraw');
...
delete_site_transient('premmerce_products_recalculate');
delete_transient('premmerce_multicurrency_check_main_currency');
delete_site_transient('premmerce_multicurrency_check_main_currency');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_product_currency' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_product_currency' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_product_currency' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_product_currency' ) );
