...
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_has_ratings' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
...
delete_option('knowledge_center_access_views');
delete_site_option('knowledge_center_access_views');
delete_option('knowledge_center_ent_map_list');
delete_site_option('knowledge_center_ent_map_list');
delete_option('knowledge_center_tax_settings');
delete_site_option('knowledge_center_tax_settings');
delete_option('knowledge_center_tools');
delete_site_option('knowledge_center_tools');
delete_option('knowledge_center_tracking_optin');
delete_site_option('knowledge_center_tracking_optin');
delete_option('knowledge_center_show_rateme_plugin_min');
delete_site_option('knowledge_center_show_rateme_plugin_min');
delete_option('knowledge_center_ent_list');
delete_site_option('knowledge_center_ent_list');
delete_option('knowledge_center_activation_date');
delete_site_option('knowledge_center_activation_date');
delete_option('knowledge_center_tax_list');
delete_site_option('knowledge_center_tax_list');
delete_option('knowledge_center_rel_list');
delete_site_option('knowledge_center_rel_list');
delete_option('knowledge_center_shc_list');
delete_site_option('knowledge_center_shc_list');
delete_option('knowledge_center_misc_settings');
delete_site_option('knowledge_center_misc_settings');
global $wpdb;
...
delete_option('knowledge_center_attr_list');
delete_site_option('knowledge_center_attr_list');
