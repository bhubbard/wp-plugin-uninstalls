...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_ratings'"
...
wp option delete 'knowledge_center_access_views'
wp option delete 'knowledge_center_ent_map_list'
wp option delete 'knowledge_center_tax_settings'
wp option delete 'knowledge_center_tools'
wp option delete 'knowledge_center_tracking_optin'
wp option delete 'knowledge_center_show_rateme_plugin_min'
wp option delete 'knowledge_center_ent_list'
wp option delete 'knowledge_center_activation_date'
wp option delete 'knowledge_center_tax_list'
wp option delete 'knowledge_center_rel_list'
wp option delete 'knowledge_center_shc_list'
wp option delete 'knowledge_center_misc_settings'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'emd_license_settings'
wp option delete 'knowledge_center_attr_list'
