...
DELETE FROM wp_options WHERE option_name IN ('emd_inline_ent_list', 'emd_activated_plugins', 'knowledge_center_access_views', 'knowledge_center_ent_map_list', 'knowledge_center_tax_settings', 'knowledge_center_tools', 'knowledge_center_tracking_optin', 'knowledge_center_show_rateme_plugin_min', 'knowledge_center_ent_list', 'knowledge_center_activation_date', 'knowledge_center_tax_list', 'knowledge_center_rel_list', 'knowledge_center_shc_list', 'knowledge_center_misc_settings', 'emd_license_settings', 'knowledge_center_attr_list');
...
DELETE FROM wp_options WHERE option_name LIKE '%_has_ratings';
