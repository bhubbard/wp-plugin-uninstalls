...
DELETE FROM wp_options WHERE option_name IN ('roku_direct_publisher', 'rss_language', 'acf_repeater_ac', 'acf_gallery_ac', 'acf_options_page_ac', 'acf_flexible_content_ac', 'acf_version');
