...
wp option delete 'yeepdf_wpforms_setup'
wp option delete 'yeepdf_download_wpforms'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_pdfcreator_wpforms'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_pdfcreator_wpforms'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_pdfcreator_wpforms'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_pdfcreator_wpforms'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_pdfcreator_wpforms_entry'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_pdfcreator_wpforms_entry'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_pdfcreator_wpforms_entry'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_pdfcreator_wpforms_entry'"
