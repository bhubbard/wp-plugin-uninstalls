...
# Delete Options
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_setting_field'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_update_checktime'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_update_new_version'"
