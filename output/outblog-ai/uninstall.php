...
// Delete Options
delete_option('outblog_api_key');
delete_site_option('outblog_api_key');
delete_option('outblog_post_as_draft');
delete_site_option('outblog_post_as_draft');

// Delete Transients
delete_transient('outblog_activation_redirect');
delete_site_transient('outblog_activation_redirect');

// Clear Cron Jobs
wp_clear_scheduled_hook('outblog_daily_sync');
