...
delete_option('ims_text');
delete_site_option('ims_text');
delete_option('ims_dept');
delete_site_option('ims_dept');
delete_option('ims_url');
delete_site_option('ims_url');
delete_option('ims_bgcolor');
delete_site_option('ims_bgcolor');
delete_option('ims_bgofflinecolor');
delete_site_option('ims_bgofflinecolor');
delete_option('ims_textcolor');
delete_site_option('ims_textcolor');
delete_option('ims_controlcolor');
delete_site_option('ims_controlcolor');
delete_option('ims_useshadow');
delete_site_option('ims_useshadow');
delete_option('ims_bodywidth');
delete_site_option('ims_bodywidth');
delete_option('ims_bodyheight');
delete_site_option('ims_bodyheight');
delete_option('ims_withoutminmax');
delete_site_option('ims_withoutminmax');
delete_option('ims_dynamicchatcolor');
delete_site_option('ims_dynamicchatcolor');
delete_option('ims_usebtnshadow');
delete_site_option('ims_usebtnshadow');
delete_option('ims_widgettype');
delete_site_option('ims_widgettype');
