...
DELETE FROM wp_options WHERE option_name IN ('auto_updater.lock', 'factory_plugin_versions', 'themeisle_sdk_notifications', 'otter_reference_key', 'optimole_reference_key', 'rop_reference_key', 'neve_reference_key', 'hyve_reference_key', 'wp_full_pay_reference_key', 'feedzy_reference_key', 'themeisle_sdk_promotions_otter', 'update_themes', 'update_plugins', 'wbcr_factory_google_fonts', 'wbcr_factory_google_fonts_raw', 'themeisle_sdk_cache_token', 'themeisle_sdk_feed_items', 'themeisle_sdk_products', 'tsk_attachment_count', 'tsk_posts_count');
