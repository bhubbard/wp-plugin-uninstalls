...
# Delete Options
wp option delete 'm_ua_active_plugins'
wp option delete 'mrkv_api_last_check_np'
wp option delete 'mrkv_api_fixed_np'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_m_ua_settings'"
wp option delete 'nova-poshta_m_ua_settings'
wp option delete 'ukr-poshta_m_ua_settings'
wp option delete 'rozetka-delivery_m_ua_settings'
wp option delete 'nova-global_m_ua_settings'
