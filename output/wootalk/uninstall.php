...
// Delete Options
delete_option('wootalk_status');
delete_site_option('wootalk_status');
delete_option('wootalk_email_notification');
delete_site_option('wootalk_email_notification');
delete_option('wootalk_email_logo');
delete_site_option('wootalk_email_logo');
