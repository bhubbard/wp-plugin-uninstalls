...
// Delete Options
delete_option('fpr_options');
delete_site_option('fpr_options');
delete_option('fpr_store_key');
delete_site_option('fpr_store_key');
delete_option('followprice_activated');
delete_site_option('followprice_activated');
delete_option('followprice_activation_redirect');
delete_site_option('followprice_activation_redirect');
delete_option('followprice_activated_count');
delete_site_option('followprice_activated_count');
delete_option('product_page_priorities');
delete_site_option('product_page_priorities');
