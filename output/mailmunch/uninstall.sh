...
wp option delete 'mailmunch_activation_redirect'
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%class-mailmunchaccess_token'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%class-mailmunchlist_id'"
