...
// Delete Options
delete_option('woocommerce_pay_by_paynow_pl_settings');
delete_site_option('woocommerce_pay_by_paynow_pl_settings');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%click_to_pay_settings' ) );
