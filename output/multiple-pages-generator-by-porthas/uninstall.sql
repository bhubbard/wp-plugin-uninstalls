...
DELETE FROM wp_options WHERE option_name IN ('mpg_branding_position', 'mpg_cache_hook_name', 'mpg_cache_hook_priority', 'mpg_legacy_user', 'mpg_database_version', 'wpseo', 'mpg_hook_name', 'mpg_hook_priority', 'mpg_site_basepath', 'mpg_search_settings', 'multi_pages_plugin_premium_license_data', 'multiple_pages_generator_by_porthas_install', 'multi_pages_plugin_premium_install', 'multi_pages_plugin_logger_flag', 'rank-math-options-titles', 'themeisle_sdk_notifications', 'otter_reference_key', 'optimole_reference_key', 'rop_reference_key', 'neve_reference_key', 'hyve_reference_key', 'wp_full_pay_reference_key', 'feedzy_reference_key', 'themeisle_sdk_promotions_otter', 'themeisle_sdk_cache_token', 'themeisle_sdk_feed_items', 'themeisle_sdk_products', 'tsk_attachment_count', 'tsk_posts_count', 'update_plugins', 'update_themes');
...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('_mpg_dismiss_subscribe_notice', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_usermeta WHERE meta_key IN ('_mpg_dismiss_subscribe_notice', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_termmeta WHERE meta_key IN ('_mpg_dismiss_subscribe_notice', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_commentmeta WHERE meta_key IN ('_mpg_dismiss_subscribe_notice', 'themeisle_sdk_dismissed_notice_black_friday');
