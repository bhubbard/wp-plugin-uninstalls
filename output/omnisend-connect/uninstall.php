...
delete_site_option('omnisend_connect_token');
delete_option('omnisend_environment');
delete_site_option('omnisend_environment');
delete_option('omnisend_connected_domain');
delete_site_option('omnisend_connected_domain');
delete_option('omnisend_plugin_version');
delete_site_option('omnisend_plugin_version');
delete_option('omnisend_wp_version');
delete_site_option('omnisend_wp_version');
delete_option('omnisend_batches_inProgress');
delete_site_option('omnisend_batches_inProgress');
delete_option('omnisend_woo_partner_link');
delete_site_option('omnisend_woo_partner_link');
delete_option('omnisend_landing_page_content');
delete_site_option('omnisend_landing_page_content');
delete_option('omnisend_sync_contacts_finished');
delete_site_option('omnisend_sync_contacts_finished');
delete_option('omnisend_sync_products_finished');
delete_site_option('omnisend_sync_products_finished');
delete_option('omnisend_sync_categories_finished');
delete_site_option('omnisend_sync_categories_finished');
delete_option('omnisend_initial_sync');
delete_site_option('omnisend_initial_sync');
...
wp_clear_scheduled_hook('omnisend_plugin_updated');
