...
delete_option('elex_settings_tab_fields_data');
delete_site_option('elex_settings_tab_fields_data');
delete_option('woocommerce_weight_unit');
delete_site_option('woocommerce_weight_unit');
delete_option('woocommerce_dimension_unit');
delete_site_option('woocommerce_dimension_unit');
delete_option('elex_gpf_cron_projects');
delete_site_option('elex_gpf_cron_projects');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('elex_run_every_thirty_minutes');
