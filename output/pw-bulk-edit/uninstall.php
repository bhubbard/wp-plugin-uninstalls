...
delete_site_option('pwbe_views');
delete_option('pwbe_database_version');
delete_site_option('pwbe_database_version');
delete_option('pwbe_hide_pimwick_menu');
delete_site_option('pwbe_hide_pimwick_menu');
delete_option('hide_pimwick_menu');
delete_site_option('hide_pimwick_menu');
delete_option('pwbe_requires_capability');
delete_site_option('pwbe_requires_capability');
delete_option('pwbe_selected_view');
delete_site_option('pwbe_selected_view');
delete_option('pwbe_help_minimize_filter_help');
delete_site_option('pwbe_help_minimize_filter_help');
delete_option('pwbe_help_dismiss_intro');
delete_site_option('pwbe_help_dismiss_intro');
