...
# Delete Options
wp option delete 'jlt_rpsi_sheet_promo_data'
wp option delete 'jlt_rpsi_sheet_promo_data_hash'
wp option delete 'jeweltheme_rpi_options'
wp option delete 'jlt_rpsi_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"
wp option delete 'recently_activated'

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_jlt_rpsi-plugin-info-%' OR option_name LIKE '_site_transient_jlt_rpsi-plugin-info-%'"
wp transient delete 'update_plugins'

# Clear Cron Jobs
wp cron event delete 'jlt_rpsi_sheet_promo_data_remote_sync'
