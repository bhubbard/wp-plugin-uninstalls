...
# Delete Options
wp option delete 'vi_s2w_update_data_new_version_free'
wp option delete 'woocommerce_manage_stock'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_history'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_history_orders'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_history_customers'"
wp option delete 's2w_params'
wp option delete 's2w_woocommerce_placeholder_img_src'
...
# Delete Transients
wp transient delete 's2w_background_processing_complete'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_s2w_shopify_image_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_s2w_shopify_image_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_s2w_shopify_image_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_s2w_shopify_image_id'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_shopify_variation_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_shopify_variation_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_shopify_variation_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_shopify_variation_id'"
