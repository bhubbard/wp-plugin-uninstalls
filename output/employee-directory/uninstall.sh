...
wp option delete 'empd_com_access_views'
wp option delete 'empd_com_ent_map_list'
wp option delete 'empd_com_tax_settings'
wp option delete 'empd_com_tools'
...
wp option delete 'empd_com_vcard_field_list'
wp option delete 'empd_com_tracking_optin'
wp option delete 'empd_com_show_rateme_plugin_min'
wp option delete 'empd_com_ent_list'
wp option delete 'empd_com_activation_date'
wp option delete 'empd_com_tax_list'
wp option delete 'empd_com_rel_list'
wp option delete 'empd_com_shc_list'
wp option delete 'empd_com_misc_settings'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'empd_com_attr_list'
wp option delete 'empd_com_setup_pages_list'
