...
delete_site_option('cartsguru_db_version');
delete_option('carts_guru_feature_facebook');
delete_site_option('carts_guru_feature_facebook');
delete_option('carts_guru_feature_fbm');
delete_site_option('carts_guru_feature_fbm');
delete_option('carts_guru_feature_ci');
delete_site_option('carts_guru_feature_ci');
delete_option('carts_guru_facebook_catalogId');
delete_site_option('carts_guru_facebook_catalogId');
delete_option('carts_guru_facebook_pixel');
delete_site_option('carts_guru_facebook_pixel');
delete_option('carts_guru_tracker_url');
delete_site_option('carts_guru_tracker_url');
delete_option('carts_guru_facebook_pageId');
delete_site_option('carts_guru_facebook_pageId');
delete_option('carts_guru_facebook_appId');
delete_site_option('carts_guru_facebook_appId');
delete_option('carts_guru_feature_widgets');
delete_site_option('carts_guru_feature_widgets');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'apply_after_tax' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'apply_after_tax' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'apply_after_tax' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'apply_after_tax' ) );
