...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_notify_list'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_notify_init_list'"
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_limitby_caps'"
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_inline_ent'"
wp option delete 'emd_inline_entity_apps'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_woocommerce'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_woocommerce_forms_list'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_edd'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_has_edd_forms_list'"
...
wp option delete 'wp_ticket_com_ent_map_list'
wp option delete 'wp_ticket_com_tools'
...
wp option delete 'wp_ticket_com_access_views'
wp option delete 'wp_ticket_com_tax_settings'
wp option delete 'wp_ticket_com_tracking_optin'
wp option delete 'wp_ticket_com_show_rateme_plugin_min'
wp option delete 'wp_ticket_com_ent_list'
wp option delete 'wp_ticket_com_activation_date'
wp option delete 'wp_ticket_com_tax_list'
wp option delete 'wp_ticket_com_rel_list'
wp option delete 'wp_ticket_com_shc_list'
wp option delete 'wp_ticket_com_misc_settings'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'wp_ticket_com_attr_list'
wp option delete 'wp_ticket_com_setup_pages_list'
