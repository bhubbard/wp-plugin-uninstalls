...
// Delete Options
delete_option('_fodw_coupon_id');
delete_site_option('_fodw_coupon_id');
delete_option('_fodw_configuration');
delete_site_option('_fodw_configuration');
delete_option('woocommerce_enable_coupons');
delete_site_option('woocommerce_enable_coupons');

// Delete Transients
delete_transient('wooextend_plugins');
delete_site_transient('wooextend_plugins');
