...
# Delete Options
wp option delete 'wcpostnl_admin_notices'
wp option delete 'wcpostnl_print_queue'
wp option delete 'wcpostnl_admin_error_notices'
wp option delete 'wcpostnl_admin_error_notice'
wp option delete 'woocommerce_weight_unit'
wp option delete 'postnl_hide_be_notice'
wp option delete 'woocommerce_force_ssl_checkout'
wp option delete 'woocommerce_shipping_tax_class'
wp option delete 'wcpostnl_settings'
wp option delete 'woocommerce_postnl_general_settings'
wp option delete 'woocommerce_postnl_export_defaults_settings'
