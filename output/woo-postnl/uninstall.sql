...
DELETE FROM wp_options WHERE option_name IN ('wcpostnl_admin_notices', 'wcpostnl_print_queue', 'wcpostnl_admin_error_notices', 'wcpostnl_admin_error_notice', 'woocommerce_weight_unit', 'postnl_hide_be_notice', 'woocommerce_force_ssl_checkout', 'woocommerce_shipping_tax_class', 'wcpostnl_settings', 'woocommerce_postnl_general_settings', 'woocommerce_postnl_export_defaults_settings', 'woocommerce_postnl_checkout_settings', 'active_sitewide_plugins');
