...
// Delete Options
delete_option('afcmpn_disable');
delete_site_option('afcmpn_disable');
delete_option('afcmpn_api');
delete_site_option('afcmpn_api');
delete_option('afcmpn_disable_image');
delete_site_option('afcmpn_disable_image');
