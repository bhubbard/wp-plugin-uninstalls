...
# Delete Options
wp option delete 'lgpd_privacy_safe_params'
wp option delete 'lgpd_privacy_safe_imagecode'
...
wp option delete 'lgpd_enable_stylesheet'
wp option delete 'lgpd_enable'
wp option delete 'lgpd_policy_page'
wp option delete 'lgpd_popup_content'
wp option delete 'lgpd_popup_dismiss_text'
wp option delete 'lgpd_popup_allow_text'
wp option delete 'lgpd_popup_learnmore_text'
wp option delete 'lgpd_popup_position'
wp option delete 'lgpd_header'
wp option delete 'lgpd_popup_background'
wp option delete 'lgpd_popup_text'
wp option delete 'lgpd_popup_button_background'
wp option delete 'lgpd_popup_button_text'
wp option delete 'lgpd_popup_link_target'
wp option delete 'lgpd_popup_border_text'
wp option delete 'lgpd_popup_theme'
wp option delete 'lgpd_policy_popup'
wp option delete 'lgpd_onetime_popup'
wp option delete 'lgpd_enable_popup'
wp option delete 'lgpd_custom_policy_page'
wp option delete 'lgpd_consent_until_display'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_db_version'"
wp option delete 'lgpd_privacy_safe_backlink_selected'
wp option delete 'lgpd_privacy_safe_backlink'
wp option delete 'lgpd_name_from'
wp option delete 'lgpd_email_from'
wp option delete 'woocommerce_terms_page_id'
wp option delete 'lgpd_plugin_version'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'lgpd_anonymized_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'lgpd_anonymized_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'lgpd_anonymized_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'lgpd_anonymized_id'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'lgpd_cf7_email_field'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'lgpd_cf7_email_field'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'lgpd_cf7_email_field'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'lgpd_cf7_email_field'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'lgpd_cf7_enabled'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'lgpd_cf7_enabled'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'lgpd_cf7_enabled'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'lgpd_cf7_enabled'"
