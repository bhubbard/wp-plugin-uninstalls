...
wp option delete 'en_quote_settings_enable_logs_daylight'
wp option delete 'en_fdo_company_id'
wp option delete 'en_fdo_company_id_status'
wp option delete 'en_connection_settings_license_key_daylight'
wp option delete 'en_quote_settings_show_delivery_estimate_daylight'
wp option delete 'en_quote_settings_delivery_estimate_options_daylight'
wp option delete 'en_plugins_return_LTL_quotes'
wp option delete 'en_weight_threshold_lfq'
wp option delete 'daylight_backup_rates_category'
wp option delete 'daylight_backup_rates_display'
wp option delete 'en_daylight_plan_number'
wp option delete 'en_daylight_plan_message'
wp option delete 'active_sitewide_plugins'
wp option delete 'en_daylight_plan_expire_days'
wp option delete 'en_daylight_plan_expire_date'
wp option delete 'en_daylight_store_type'
wp option delete 'en_daylight_ltl_update_now'
wp option delete 'eniture_show_rate_limit_notice_with_time'
wp option delete 'eniture_rate_limit_reset_timestamp'
wp option delete 'daylight_backup_rates_fixed_rate'
wp option delete 'daylight_backup_rates_cart_price_percentage'
wp option delete 'daylight_backup_rates_weight_function'
wp option delete 'en_quote_settings_order_cut_off_time_daylight'
wp option delete 'enable_backup_rates_daylight'
wp option delete 'en_quote_settings_allow_other_plugins_daylight'
wp option delete 'EN_Plugins'
wp option delete 'eniture_show_rate_limit_notice_without_time'
wp option delete 'en_quote_settings_residential_delivery_daylight'
wp option delete 'en_quote_settings_liftgate_delivery_daylight'
...
wp option delete 'en_quote_settings_own_arrangment_daylight'
wp option delete 'en_quote_settings_text_for_own_arrangment_daylight'
wp option delete 'en_quote_settings_number_of_options_daylight'
wp option delete 'en_quote_settings_custom_label_daylight'
wp option delete 'en_quote_settings_handling_unit_weight_daylight'
wp option delete 'maximum_handling_weight_daylight'
wp option delete 'en_quote_settings_handling_fee_daylight'
wp option delete 'daylight_liftgate_delivery_as_option'
wp option delete 'en_woo_addons_liftgate_with_auto_residential'
wp option delete 'en_quote_settings_checkout_error_message_daylight'
wp option delete 'daylight_backup_rates_carrier_returns_error'
wp option delete 'daylight_backup_rates_carrier_fails_to_return_response'
...
wp option delete 'daylight_backup_rates_label'
wp option delete 'en_quote_settings_shipment_offset_days_daylight'
wp option delete 'en_quote_settings_all_shipment_days_daylight'
wp option delete 'en_quote_settings_monday_shipment_day_daylight'
wp option delete 'en_quote_settings_tuesday_shipment_day_daylight'
wp option delete 'en_quote_settings_wednesday_shipment_day_daylight'
wp option delete 'en_quote_settings_thursday_shipment_day_daylight'
wp option delete 'en_quote_settings_friday_shipment_day_daylight'
