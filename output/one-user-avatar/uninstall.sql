...
DELETE FROM wp_options WHERE option_name IN ('avatar_default_wp_user_avatar', 'wp_user_avatar_tinymce', 'wp_user_avatar_allow_upload', 'wp_user_avatar_disable_um_avatars', 'wp_user_avatar_force_file_uploader', 'wp_user_avatar_disable_gravatar', 'wp_user_avatar_edit_avatar', 'wp_user_avatar_resize_crop', 'wp_user_avatar_resize_h', 'wp_user_avatar_resize_upload', 'wp_user_avatar_resize_w', 'wp_user_avatar_upload_size_limit', 'wpua_hash_gravatar', 'wp_user_avatar_default_avatar_updated', 'wp_user_avatar_users_updated', 'wp_user_avatar_media_updated', 'cron', 'wp_user_avatar_load_scripts', 'wpua_has_gravatar');
