...
delete_option('wp_user_avatar_disable_um_avatars');
delete_site_option('wp_user_avatar_disable_um_avatars');
delete_option('wp_user_avatar_force_file_uploader');
delete_site_option('wp_user_avatar_force_file_uploader');
