...
DELETE FROM wp_options WHERE option_name IN ('cherry_customiser_fonts_inited', 'cherry_customiser_fonts_google', 'recently_activated', 'update_plugins');
DELETE FROM wp_options WHERE option_name LIKE '%_options';
DELETE FROM wp_options WHERE option_name LIKE 'cherry_customiser_fonts_%';
