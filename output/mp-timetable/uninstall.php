...
// Delete Options
delete_option('mp_timetable_permalinks');
delete_site_option('mp_timetable_permalinks');
delete_option('mp_timetable_general');
delete_site_option('mp_timetable_general');
