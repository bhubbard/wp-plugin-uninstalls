...
wp option delete 'form-masks-install-by'
...
wp option delete 'fme-install-date'
wp option delete 'fme-v'
wp option delete 'cfef_usage_share_data'
wp option delete 'fme_marketing_dismissed'
wp option delete 'fme_tec_notice_dismissed'
