...
delete_option('form-masks-install-by');
delete_site_option('form-masks-install-by');
...
delete_option('fme-install-date');
delete_site_option('fme-install-date');
delete_option('fme-v');
delete_site_option('fme-v');
delete_option('cfef_usage_share_data');
delete_site_option('cfef_usage_share_data');
delete_option('fme_marketing_dismissed');
delete_site_option('fme_marketing_dismissed');
delete_option('fme_tec_notice_dismissed');
delete_site_option('fme_tec_notice_dismissed');
...
delete_option('fme-type');
delete_site_option('fme-type');
