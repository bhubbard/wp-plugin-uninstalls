...
DELETE FROM wp_options WHERE option_name IN ('ciam_api_settings', 'ciam_authentication_settings', 'ciam_uninstall_settings', 'Ciam_Authentication_settings', 'Ciam_Sso_Page_settings', 'LoginRadius_API_settings');
