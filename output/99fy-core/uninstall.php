...
// Delete Options
delete_option('nnfy_header_layout');
delete_site_option('nnfy_header_layout');
delete_option('nnfy_footer_layout');
delete_site_option('nnfy_footer_layout');
delete_option('nnfy_page_title_custom_postion');
delete_site_option('nnfy_page_title_custom_postion');
delete_option('nnfy_blog_img_size');
delete_site_option('nnfy_blog_img_size');
delete_option('nnfy_do_activation_redirect');
delete_site_option('nnfy_do_activation_redirect');
...
delete_site_transient('nnfy_template_info');
