...
# Delete Options
wp option delete 'nnfy_header_layout'
wp option delete 'nnfy_footer_layout'
wp option delete 'nnfy_page_title_custom_postion'
wp option delete 'nnfy_blog_img_size'
wp option delete 'nnfy_do_activation_redirect'
...
# Delete Transients
wp transient delete 'nnfy_template_info'
