...
wp option delete 'reales_fields_settings'
wp option delete 'reales_prop_fields_settings'
wp option delete 'reales_amenities_settings'
wp option delete 'reales_cities_settings'
