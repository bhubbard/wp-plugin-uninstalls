...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'service_icon_name'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'service_icon_name'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'service_icon_name'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'service_icon_name'"
