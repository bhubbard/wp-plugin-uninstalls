...
// Delete Options
delete_option('gc_price_format');
delete_site_option('gc_price_format');
delete_option('gc_description_length');
delete_site_option('gc_description_length');
delete_option('gc_news_days');
delete_site_option('gc_news_days');
