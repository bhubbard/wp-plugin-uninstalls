...
# Delete Options
wp option delete 'robin_image_optimizer_logger_flag'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_install'"
wp option delete 'wbcr_io_license'
wp option delete 'wrio_freemius_uid'
...
# Clear Cron Jobs
wp cron event delete 'wrio/cron/optimization_process'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'wrio_avif_banner_dismissed'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'wrio_avif_banner_dismissed'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'wrio_avif_banner_dismissed'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'wrio_avif_banner_dismissed'"
