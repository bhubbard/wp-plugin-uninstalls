...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('_thumbnail_id', 'skip_post_thumb', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_usermeta WHERE meta_key IN ('_thumbnail_id', 'skip_post_thumb', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_termmeta WHERE meta_key IN ('_thumbnail_id', 'skip_post_thumb', 'themeisle_sdk_dismissed_notice_black_friday');
DELETE FROM wp_commentmeta WHERE meta_key IN ('_thumbnail_id', 'skip_post_thumb', 'themeisle_sdk_dismissed_notice_black_friday');
