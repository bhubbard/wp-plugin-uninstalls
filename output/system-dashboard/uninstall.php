...
// Delete Options
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '_site_transient_timeout_%' ) );
...
// Delete Transients
delete_transient('sd_cpu_count');
delete_site_transient('sd_cpu_count');
delete_transient('sd_cpu_core_count');
delete_site_transient('sd_cpu_core_count');
delete_transient('sd_total_ram');
delete_site_transient('sd_total_ram');
delete_transient('sd_db_disk_usage');
delete_site_transient('sd_db_disk_usage');
