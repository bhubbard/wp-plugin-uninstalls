...
delete_site_option('woo-quick-view-version');
delete_option('wooqv');
delete_site_option('wooqv');
delete_option('xt-woo-quick-view-version');
delete_site_option('xt-woo-quick-view-version');
delete_option('xt_wooqv');
delete_site_option('xt_wooqv');
