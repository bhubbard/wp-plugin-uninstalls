...
// Delete Transients
delete_transient('aarambha_ds_author_themes');
delete_site_transient('aarambha_ds_author_themes');
delete_transient('aarambha_ds_demo_categories');
delete_site_transient('aarambha_ds_demo_categories');
delete_transient('aarambha_ds_plugins');
delete_site_transient('aarambha_ds_plugins');
