...
// Delete Options
delete_option('gpttkconnect_show_onboarding');
delete_site_option('gpttkconnect_show_onboarding');
delete_option('gpttkconnect_onboarding_step');
delete_site_option('gpttkconnect_onboarding_step');
delete_option('gpttkconnect_safe_mode');
delete_site_option('gpttkconnect_safe_mode');
