...
DELETE FROM wp_options WHERE option_name IN ('vicaca_params', 'villatheme_hide_admin_toolbar', 'vicaca_clear_autoptimize_cache', 'villatheme_call', 'villatheme_ads', 'villatheme_notices', 'villatheme_called');
