...
# Delete Options
wp option delete 'gcpqr_product_id'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'recipient_email'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'recipient_email'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'recipient_email'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'recipient_email'"
