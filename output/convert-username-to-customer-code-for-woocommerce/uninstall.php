...
// Delete Options
delete_option('wccutccfw_nascondi_emailbenvenuto');
delete_site_option('wccutccfw_nascondi_emailbenvenuto');
delete_option('wccutccfw_nascondi_colonna_wooadmin');
delete_site_option('wccutccfw_nascondi_colonna_wooadmin');
delete_option('wccutccfw_nascondi_colonna_wooorder');
delete_site_option('wccutccfw_nascondi_colonna_wooorder');
delete_option('wccutccfw_nascondi_codiceareaclienti');
delete_site_option('wccutccfw_nascondi_codiceareaclienti');
