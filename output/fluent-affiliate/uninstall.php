...
delete_site_option('_fa_referral_settings');
delete_option('affwp_settings');
delete_site_option('affwp_settings');
delete_option('_fla_affwp_migrations_status');
delete_site_option('_fla_affwp_migrations_status');
delete_option('_fla_solid_affiliate_migrations_status');
delete_site_option('_fla_solid_affiliate_migrations_status');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_migrations_status' ) );
...
// Clear Cron Jobs
wp_clear_scheduled_hook('fluent_affiliate/send_new_referral_notification');
