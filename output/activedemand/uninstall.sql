...
DELETE FROM wp_options WHERE option_name IN ('run_only_once_indexes', 'woocommerce_currency');
...
DELETE FROM wp_options WHERE option_name LIKE '%_enable_access_control';
