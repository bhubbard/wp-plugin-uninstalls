...
wp option delete 'templatespare_custom_post_images'
wp option delete 'templatespare_use_images_in_content'
wp option delete 'templatespare_use_images_in_featued'
wp option delete 'templatespare_wizard_next_step'
wp option delete 'templatespare_wizard_category_value'
wp option delete 'templatespare_image_upload_cache'
wp option delete 'templatespare_uploaded_image_ids'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'sidebars_widgets'
wp option delete 'nav_menus_created_posts'
wp option delete 'wp_css'
...
wp transient delete 'AFTMLS_importer_data'
wp transient delete 'wc_attribute_taxonomies'
wp transient delete 'theme_roots'
wp transient delete 'templatespare-kit_activation_notice'
