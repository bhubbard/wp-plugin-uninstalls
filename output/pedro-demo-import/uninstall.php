...
// Delete Options
delete_option('pedro_demo_installed');
delete_site_option('pedro_demo_installed');
delete_option('pedro_demo_version');
delete_site_option('pedro_demo_version');
delete_option('recently_activated');
delete_site_option('recently_activated');
delete_option('pdi_installed');
delete_site_option('pdi_installed');
delete_option('pdi_version');
delete_site_option('pdi_version');
