...
delete_option('Pcode_Apf_Page_Settings');
delete_site_option('Pcode_Apf_Page_Settings');
delete_option('PcodeApfPageSettings');
delete_site_option('PcodeApfPageSettings');
