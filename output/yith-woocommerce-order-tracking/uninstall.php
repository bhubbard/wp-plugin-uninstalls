...
// Delete Options
delete_option('yith-ywot-welcome-modal');
delete_site_option('yith-ywot-welcome-modal');
delete_option('ywot_carrier_default_name');
delete_site_option('ywot_carrier_default_name');
delete_option('ywot_order_tracking_text_position');
delete_site_option('ywot_order_tracking_text_position');
delete_option('ywot_order_tracking_text');
delete_site_option('ywot_order_tracking_text');
