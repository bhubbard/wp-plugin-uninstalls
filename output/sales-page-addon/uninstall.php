...
// Delete Options
delete_option('sales-page-builders');
delete_site_option('sales-page-builders');
delete_option('sales-page-builder-active');
delete_site_option('sales-page-builder-active');
delete_option('spa-woo-checkout-config');
delete_site_option('spa-woo-checkout-config');
delete_option('spa-woo-thankyou-config');
delete_site_option('spa-woo-thankyou-config');
delete_option('sales_page_flush_rewrite_rules_flag');
delete_site_option('sales_page_flush_rewrite_rules_flag');
...
delete_option('spa_bw_settings');
delete_site_option('spa_bw_settings');
delete_option('spa_pw_settings');
delete_site_option('spa_pw_settings');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_css_class' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_css_class' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_css_class' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_css_class' ) );
