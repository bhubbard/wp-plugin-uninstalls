...
delete_option('show-ab');
delete_site_option('show-ab');
delete_option('adminbar_frontend_items');
delete_site_option('adminbar_frontend_items');
delete_option('jlt_admin_bar_multisite_exclude');
delete_site_option('jlt_admin_bar_multisite_exclude');
delete_option('jlt_admin_bar_editor_sheet_promo_data');
delete_site_option('jlt_admin_bar_editor_sheet_promo_data');
delete_option('jlt_admin_bar_editor_sheet_promo_data_hash');
delete_site_option('jlt_admin_bar_editor_sheet_promo_data_hash');
delete_option('active_sitewide_plugins');
delete_site_option('active_sitewide_plugins');
delete_option('jlt_admin_bar_editor_activation_time');
delete_site_option('jlt_admin_bar_editor_activation_time');
global $wpdb;
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_jlt_admin_bar_editor-plugin-info-%', '_site_transient_jlt_admin_bar_editor-plugin-info-%' ) );
