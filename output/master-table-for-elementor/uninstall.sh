...
# Delete Options
wp option delete 'jlt_elementor_master_table_sheet_promo_data'
wp option delete 'jlt_elementor_master_table_sheet_promo_data_hash'
wp option delete 'jlt_elementor_master_table_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Clear Cron Jobs
wp cron event delete 'jlt_elementor_master_table_sheet_promo_data_remote_sync'
