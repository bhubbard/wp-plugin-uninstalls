...
// Delete Options
delete_option('jlt_elementor_master_table_sheet_promo_data');
delete_site_option('jlt_elementor_master_table_sheet_promo_data');
delete_option('jlt_elementor_master_table_sheet_promo_data_hash');
delete_site_option('jlt_elementor_master_table_sheet_promo_data_hash');
delete_option('jlt_elementor_master_table_activation_time');
delete_site_option('jlt_elementor_master_table_activation_time');
global $wpdb;
...
// Clear Cron Jobs
wp_clear_scheduled_hook('jlt_elementor_master_table_sheet_promo_data_remote_sync');
