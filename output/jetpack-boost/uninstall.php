...
// Delete Options
delete_option('jetpack_boost_version');
delete_site_option('jetpack_boost_version');
delete_option('jetpack_boost_static_minification');
delete_site_option('jetpack_boost_static_minification');
delete_option('jetpack_boost_404_tester_last_run');
delete_site_option('jetpack_boost_404_tester_last_run');
delete_option('jetpack_boost_minify_cron_cache_cleanup_last_run');
...
delete_option('jetpack_boost_status_minify-js');
delete_site_option('jetpack_boost_status_minify-js');
delete_option('jetpack_boost_ds_minify_js_excludes');
delete_site_option('jetpack_boost_ds_minify_js_excludes');
delete_option('page_optimize-css');
delete_site_option('page_optimize-css');
delete_option('jetpack_boost_status_minify-css');
delete_site_option('jetpack_boost_status_minify-css');
delete_option('jetpack_boost_ds_minify_css_excludes');
delete_site_option('jetpack_boost_ds_minify_css_excludes');
...
delete_transient('jb_boost_migration_complete');
delete_site_transient('jb_boost_migration_complete');
delete_transient('jb_boost_migration_tracked');
delete_site_transient('jb_boost_migration_tracked');
...
// Clear Cron Jobs
wp_clear_scheduled_hook('jetpack_boost_handle_version_change_cron');
wp_clear_scheduled_hook('jetpack_boost_general_cleanup');
wp_clear_scheduled_hook('jetpack_boost_minify_cron_cleanup_concat_paths');
wp_clear_scheduled_hook('jetpack_boost_minify_cron_cleanup_concat_paths_followup');
wp_clear_scheduled_hook('jetpack_boost_404_tester_cron');
wp_clear_scheduled_hook('jetpack_boost_minify_cron_cache_cleanup');
wp_clear_scheduled_hook('jetpack_boost_preload_cornerstone');
wp_clear_scheduled_hook('jetpack_boost_preload');
