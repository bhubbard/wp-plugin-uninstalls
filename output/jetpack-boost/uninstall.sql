...
DELETE FROM wp_options WHERE option_name IN ('jetpack_boost_version', 'jetpack_boost_static_minification', 'jetpack_boost_404_tester_last_run', 'jetpack_boost_minify_cron_cache_cleanup_last_run', 'endurance_cache_level', 'page_optimize-js', 'jetpack_boost_status_minify-js', 'jetpack_boost_ds_minify_js_excludes', 'page_optimize-css', 'jetpack_boost_status_minify-css', 'jetpack_boost_ds_minify_css_excludes', 'stats_options', 'jetpack_activation_source', 'jetpack_affiliate_code', 'jetpack_partner_subsidiary_id', 'jetpack_offline_mode', 'vaultpress', 'vaultpress_auto_register', 'jetpack_sso_remove_login_form', 'jetpack_sso_match_by_email', 'jetpack_sso_require_two_step', 'medium_large_size_w', 'medium_large_size_h', 'trusted_ip_header', 'wordpress_api_key', 'jb_get_started', 'jetpack_protect_blocked_attempts', 'jetpack_protect_active', 'wpcom_public_coming_soon', 'jetpack_plugin_api_action_links', 'jetpack_site_icon_url', 'jetpack_sync_non_blocking', 'jetpack_updates', 'jetpack_full_sync_status', 'has_jetpack_search_product', 'jb_cache_moved_to_boost', 'jb_boost_migration_complete', 'jb_boost_migration_tracked', 'jetpack_assumed_site_creation_date', 'jetpack_idc_possible_dynamic_site_url_detected', 'jetpack_idc_validation_lock', 'jetpack_idc_local', 'jetpack_last_plugin_sync', 'my_jetpack_write_access', 'jetpack_partner_data', 'my_jetpack_product_activated', 'jetpack_is_single_user', 'jetpack_plugin_api_action_links_refresh', 'update_core', 'update_plugins');
DELETE FROM wp_options WHERE option_name IN ('update_themes');
