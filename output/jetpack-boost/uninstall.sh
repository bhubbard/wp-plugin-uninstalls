...
# Delete Options
wp option delete 'jetpack_boost_version'
wp option delete 'jetpack_boost_static_minification'
wp option delete 'jetpack_boost_404_tester_last_run'
wp option delete 'jetpack_boost_minify_cron_cache_cleanup_last_run'
...
wp option delete 'jetpack_boost_status_minify-js'
wp option delete 'jetpack_boost_ds_minify_js_excludes'
wp option delete 'page_optimize-css'
wp option delete 'jetpack_boost_status_minify-css'
wp option delete 'jetpack_boost_ds_minify_css_excludes'
...
wp transient delete 'jb_boost_migration_complete'
wp transient delete 'jb_boost_migration_tracked'
...
# Clear Cron Jobs
wp cron event delete 'jetpack_boost_handle_version_change_cron'
wp cron event delete 'jetpack_boost_general_cleanup'
wp cron event delete 'jetpack_boost_minify_cron_cleanup_concat_paths'
wp cron event delete 'jetpack_boost_minify_cron_cleanup_concat_paths_followup'
wp cron event delete 'jetpack_boost_404_tester_cron'
wp cron event delete 'jetpack_boost_minify_cron_cache_cleanup'
wp cron event delete 'jetpack_boost_preload_cornerstone'
wp cron event delete 'jetpack_boost_preload'
