...
delete_site_option('uifmfbuild_version');
delete_option('zgfm-b-hide_upgrade_notice');
delete_site_option('zgfm-b-hide_upgrade_notice');
delete_option('zgfm-b-install-type');
delete_site_option('zgfm-b-install-type');
delete_option('zgfm_fields_fastload');
delete_site_option('zgfm_fields_fastload');
delete_option('zgfm_b_activated');
delete_site_option('zgfm_b_activated');
delete_option('zgfm_b_modalmode');
delete_site_option('zgfm_b_modalmode');
delete_option('zigaform_f_notice_1');
delete_site_option('zigaform_f_notice_1');
delete_option('zgfm_wpfb_code');
delete_site_option('zgfm_wpfb_code');
