...
delete_option('wri_general_settings');
delete_site_option('wri_general_settings');
delete_option('wsl_last_activation_tech_info');
delete_site_option('wsl_last_activation_tech_info');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", 'wri_related_items___%' ) );
...
delete_site_option('wc_pac_columns');
delete_option('wri_related_items___product');
delete_site_option('wri_related_items___product');
