...
# Delete Options
wp option delete 'mapster_tutorial'
wp option delete 'mapster_default_popup'
wp option delete 'mapster_settings_page'
wp option delete 'mapster_default_image_text'
wp option delete 'mapster_default_header'
wp option delete 'mapster_welcome_message'
