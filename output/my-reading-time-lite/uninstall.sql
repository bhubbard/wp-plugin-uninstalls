...
DELETE FROM wp_options WHERE option_name IN ('jltmrt_sheet_promo_data', 'jltmrt_sheet_promo_data_hash', 'jltmrt_activation_time');
DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking';
DELETE FROM wp_options WHERE option_name LIKE 'jltmrt-plugin-info-%';
