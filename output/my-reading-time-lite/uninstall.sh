...
# Delete Options
wp option delete 'jltmrt_sheet_promo_data'
wp option delete 'jltmrt_sheet_promo_data_hash'
wp option delete 'jltmrt_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_jltmrt-plugin-info-%' OR option_name LIKE '_site_transient_jltmrt-plugin-info-%'"

# Clear Cron Jobs
wp cron event delete 'jltmrt_sheet_promo_data_remote_sync'
