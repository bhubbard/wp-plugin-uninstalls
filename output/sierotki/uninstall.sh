...
# Delete Options
wp option delete 'iworks_orphans_options_import_messages'
wp option delete 'iworks_orphan_own_orphans'
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'iworks_orphan_%'"
