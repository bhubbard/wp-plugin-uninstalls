...
DELETE FROM wp_options WHERE option_name IN ('bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'rlt_options', 'rewrite_rules', 'update_plugins', 'bws_plugins_update');
