...
delete_option('desert_demo_installed');
delete_site_option('desert_demo_installed');
global $wpdb;
...
delete_option('atua_media_id');
delete_site_option('atua_media_id');
...
delete_option('chromax_media_id');
delete_site_option('chromax_media_id');
delete_option('corpiva_media_id');
delete_site_option('corpiva_media_id');
delete_option('cosmobit_media_id');
delete_site_option('cosmobit_media_id');
delete_option('softme_media_id');
delete_site_option('softme_media_id');
