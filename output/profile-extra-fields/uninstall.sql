...
DELETE FROM wp_options WHERE option_name IN ('bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'prflxtrflds_options', 'update_plugins', 'bws_plugins_update');
