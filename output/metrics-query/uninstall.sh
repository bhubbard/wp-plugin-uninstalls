...
# Delete Options
wp option delete 'gadwp_got_updated'
wp option delete 'gadwp_redeemed_code'
wp option delete 'gadwp_network_options'
wp option delete 'gadwp_options'
wp option delete 'gadwp_version'
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'gadwp_cache_%'"
