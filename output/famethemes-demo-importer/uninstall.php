...
delete_site_transient('_wxr_imported_posts');
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient__demo_contents_file_%', '_site_transient__demo_contents_file_%' ) );
foreach ( $transients as $transient ) {
	delete_option( $transient );
}
...
delete_site_transient('_wxr_imported_users');
delete_transient('_wxr_imported_terms');
delete_site_transient('_wxr_imported_terms');
delete_transient('_wxr_orphaned_terms');
delete_site_transient('_wxr_orphaned_terms');
delete_transient('wc_attribute_taxonomies');
delete_site_transient('wc_attribute_taxonomies');
delete_transient('_wxr_orphaned_posts');
delete_site_transient('_wxr_orphaned_posts');
delete_transient('_wxr_orphaned_comments');
delete_site_transient('_wxr_orphaned_comments');
delete_transient('_wxr_imported_comments');
delete_site_transient('_wxr_imported_comments');
