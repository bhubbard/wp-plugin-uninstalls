...
DELETE FROM wp_options WHERE option_name IN ('woowhole_to_emailaddress', 'woowhole_from_emailaddress', 'woowhole_from_name', 'woowhole_success_msg', 'woowhole_failed_msg', 'woowhole_title');
