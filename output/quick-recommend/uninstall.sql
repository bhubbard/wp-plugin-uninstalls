...
DELETE FROM wp_options WHERE option_name IN ('qrec_search_check', 'qrec_archive_check', 'rss_language', 'acf_repeater_ac', 'acf_gallery_ac', 'acf_options_page_ac', 'acf_flexible_content_ac', 'acf_version', 'qrec_divider_location', 'qrec_divider_type', 'qrec_box_class', 'qrec_image_class', 'qrec_box_title_tag', 'qrec_box_title_class', 'qrec_title_tag', 'qrec_title_class', 'qrec_author_tag', 'qrec_author_class');
