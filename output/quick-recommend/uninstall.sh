...
# Delete Options
wp option delete 'qrec_search_check'
wp option delete 'qrec_archive_check'
...
wp option delete 'qrec_divider_location'
wp option delete 'qrec_divider_type'
wp option delete 'qrec_box_class'
wp option delete 'qrec_image_class'
wp option delete 'qrec_box_title_tag'
wp option delete 'qrec_box_title_class'
wp option delete 'qrec_title_tag'
wp option delete 'qrec_title_class'
wp option delete 'qrec_author_tag'
wp option delete 'qrec_author_class'
