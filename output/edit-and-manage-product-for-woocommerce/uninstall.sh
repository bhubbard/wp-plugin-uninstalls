...
# Delete Options
wp option delete 'woobemp_version'
wp option delete 'woobemp_installed'
wp option delete 'BEMP_bulk_single_edit'
wp option delete 'wooBEMP_per_batch_count'
wp option delete 'wooBEMP_column_settings'
