...
# Delete Options
wp option delete 'elmpath_api_response'
wp option delete 'elmpath_elements_active'
wp option delete 'woocommerce_hide_out_of_stock_items'

# Clear Cron Jobs
wp cron event delete 'elmpath_update_data'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'team_social'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'team_social'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'team_social'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'team_social'"
