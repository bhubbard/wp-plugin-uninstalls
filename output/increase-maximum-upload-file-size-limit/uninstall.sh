...
# Delete Options
wp option delete 'jltiusl_sheet_promo_data'
wp option delete 'jltiusl_sheet_promo_data_hash'
wp option delete 'jltiusl_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_jltiusl-plugin-info-%' OR option_name LIKE '_site_transient_jltiusl-plugin-info-%'"

# Clear Cron Jobs
wp cron event delete 'jltiusl_sheet_promo_data_remote_sync'
