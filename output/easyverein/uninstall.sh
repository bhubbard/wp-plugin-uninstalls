...
# Clear Cron Jobs
wp cron event delete 'easyVerein_member_sync_hook'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'easyVereinId'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'easyVereinId'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'easyVereinId'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'easyVereinId'"
