...
DELETE FROM wp_options WHERE option_name IN ('wfspb-param', 'woocommerce_shop_page_id', 'woocommerce_tax_display_shop', 'woocommerce_tax_round_at_subtotal', 'villatheme_hide_admin_toolbar', 'villatheme_call', 'villatheme_notices', 'villatheme_called', 'villatheme_ads');
