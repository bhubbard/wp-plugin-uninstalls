...
delete_site_option('vifewc_sections_params');
delete_option('vifewc_settings_params');
delete_site_option('vifewc_settings_params');
...
// Delete Transients
delete_transient('vifewc_get_section_fields');
delete_site_transient('vifewc_get_section_fields');
