...
wp option delete 'berocket_brands_permalink'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'brand_banner_url'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'brand_banner_url'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'brand_banner_url'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'brand_banner_url'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_brand_url'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_brand_url'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_brand_url'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_brand_url'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'exclude_berocket_brand'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'exclude_berocket_brand'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'exclude_berocket_brand'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'exclude_berocket_brand'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_brand_order'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_brand_order'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_brand_order'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_brand_order'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_brand_tooltip'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_brand_tooltip'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_brand_tooltip'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_brand_tooltip'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_brand_category'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_brand_category'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_brand_category'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_brand_category'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_brand_related'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_brand_related'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_brand_related'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_brand_related'"
