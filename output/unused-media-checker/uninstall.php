...
// Delete Transients
delete_transient('umchk_admin_notice');
delete_site_transient('umchk_admin_notice');
delete_transient('umchk_pg_admin_notice');
delete_site_transient('umchk_pg_admin_notice');
