...
// Delete Options
delete_option('bpb_settings');
delete_site_option('bpb_settings');
delete_option('bpb_imported_templates');
delete_site_option('bpb_imported_templates');
delete_option('bpb_starter_kit_imported');
delete_site_option('bpb_starter_kit_imported');
delete_option('bp_nouveau_appearance');
delete_site_option('bp_nouveau_appearance');
delete_option('_bpb_installed_time');
delete_site_option('_bpb_installed_time');
delete_option('bpb_profile_listings');
delete_site_option('bpb_profile_listings');
delete_option('bp-pages');
delete_site_option('bp-pages');
delete_option('bpb_listings');
delete_site_option('bpb_listings');
