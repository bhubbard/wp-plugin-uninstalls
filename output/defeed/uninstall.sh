...
# Delete Options
wp option delete 'defeed_additional_options'
wp option delete 'defeed_options'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_defeed_item_info'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_defeed_item_info'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_defeed_item_info'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_defeed_item_info'"
