...
# Delete Options
wp option delete 'shopex_activation_redirect'
wp option delete 'shopex_db_version'
wp option delete 'shopex_version'
wp option delete 'shopex_installed_date'
wp option delete 'shop_explorer_frontend_settings'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%database_mode_enabled'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%multivendor_enabled'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%auto_sync_enabled'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%sync_interval'"
wp option delete 'wpnts_schedules_interval_woocommerce_settings'
wp option delete 'shopex_multivendor_enabled'
wp option delete 'shopex_last_sync'
wp option delete 'shopex_database_mode_enabled'
wp option delete 'woocommerce_notify_low_stock_amount'
wp option delete 'shop_explorer_install_time'
...
wp option delete 'shop_explorer_dashboard_page_id'
wp option delete 'shopex_sync_customer_username'
wp option delete 'shopex_sync_customer_email'
wp option delete 'shopex_sync_customer_first_name'
wp option delete 'shopex_sync_customer_last_name'
wp option delete 'shopex_sync_customer_phone'
wp option delete 'shopex_sync_customer_billing_address'
wp option delete 'shopex_sync_customer_shipping_address'
wp option delete 'shopex_sync_customer_total_orders'
wp option delete 'shopex_sync_customer_total_spent'
wp option delete 'shopex_sync_customer_date_registered'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'shopex_sync_customer_%'"
wp option delete 'shopex_encryption_key'
wp option delete 'shopex_sync_order_status'
wp option delete 'shopex_sync_order_total'
wp option delete 'shopex_sync_product_names'
wp option delete 'shopex_sync_product_skus'
wp option delete 'shopex_sync_total_items'
wp option delete 'shopex_sync_customer_name'
wp option delete 'shopex_sync_order_date'
wp option delete 'shopex_sync_payment_method'
wp option delete 'shopex_sync_billing_address'
wp option delete 'shopex_sync_shipping_address'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'shopex_sync_%'"
wp option delete 'shopex_sync_product_name'
wp option delete 'shopex_sync_sku'
wp option delete 'shopex_sync_regular_price'
wp option delete 'shopex_sync_sale_price'
wp option delete 'shopex_sync_stock_quantity'
wp option delete 'shopex_sync_stock_status'
wp option delete 'shopex_sync_product_type'
wp option delete 'shopex_sync_categories'
wp option delete 'shopex_sync_weight'
wp option delete 'shopex_last_order_sync'
wp option delete 'shopex_real_time_sync'
wp option delete 'shopex_last_product_sync'
wp option delete 'shopex_sync_message'
wp option delete 'shopex_sheets_config'
...
# Delete Transients
wp transient delete 'shopex_activation_error'
wp transient delete 'shopex_wc_deactivated_notice'
...
# Clear Cron Jobs
wp cron event delete 'shopex_sync_cron'
wp cron event delete 'shopex_cleanup_cron'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '_custom_field_config_%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '_custom_field_config_%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '_custom_field_config_%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '_custom_field_config_%'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'vendor_sheet_configurations'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'vendor_sheet_configurations'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'vendor_sheet_configurations'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'vendor_sheet_configurations'"
