...
wp option delete 'BeRocket_force_sell_version'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_force_sell'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_force_sell'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_force_sell'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_force_sell'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_force_sell_linked'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_force_sell_linked'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_force_sell_linked'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_force_sell_linked'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_force_sell_once'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_force_sell_once'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_force_sell_once'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_force_sell_once'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_force_sell_linked_once'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_force_sell_linked_once'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_force_sell_linked_once'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_force_sell_linked_once'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_force_sell'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_force_sell'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_force_sell'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_force_sell'"
