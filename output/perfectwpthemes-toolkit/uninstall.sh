...
# Delete Options
wp option delete 'perfectwpthemes_themes'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"
wp option delete 'sidebars_widgets'
wp option delete 'perfetwpthemes_themes'

# Delete Transients
wp transient delete 'PWPT_importer_data'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'masonry-blog-pro_notice_ignore'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'masonry-blog-pro_notice_ignore'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'masonry-blog-pro_notice_ignore'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'masonry-blog-pro_notice_ignore'"
