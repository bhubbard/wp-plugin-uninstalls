...
// Delete Options
delete_option('perfectwpthemes_themes');
delete_site_option('perfectwpthemes_themes');
global $wpdb;
...
delete_option('perfetwpthemes_themes');
delete_site_option('perfetwpthemes_themes');

// Delete Transients
delete_transient('PWPT_importer_data');
delete_site_transient('PWPT_importer_data');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'masonry-blog-pro_notice_ignore' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'masonry-blog-pro_notice_ignore' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'masonry-blog-pro_notice_ignore' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'masonry-blog-pro_notice_ignore' ) );
