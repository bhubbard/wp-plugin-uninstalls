...
delete_option('request_a_quote_ent_map_list');
delete_site_option('request_a_quote_ent_map_list');
delete_option('request_a_quote_tax_settings');
delete_site_option('request_a_quote_tax_settings');
delete_option('request_a_quote_tools');
delete_site_option('request_a_quote_tools');
delete_option('request_a_quote_tracking_optin');
delete_site_option('request_a_quote_tracking_optin');
delete_option('request_a_quote_show_rateme_plugin_min');
delete_site_option('request_a_quote_show_rateme_plugin_min');
delete_option('request_a_quote_ent_list');
delete_site_option('request_a_quote_ent_list');
delete_option('request_a_quote_activation_date');
delete_site_option('request_a_quote_activation_date');
delete_option('request_a_quote_tax_list');
delete_site_option('request_a_quote_tax_list');
delete_option('request_a_quote_rel_list');
delete_site_option('request_a_quote_rel_list');
delete_option('request_a_quote_shc_list');
delete_site_option('request_a_quote_shc_list');
delete_option('request_a_quote_attr_list');
delete_site_option('request_a_quote_attr_list');
delete_option('emd_license_settings');
delete_site_option('emd_license_settings');
delete_option('request_a_quote_setup_pages_list');
delete_site_option('request_a_quote_setup_pages_list');
