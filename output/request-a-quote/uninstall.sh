...
wp option delete 'request_a_quote_ent_map_list'
wp option delete 'request_a_quote_tax_settings'
wp option delete 'request_a_quote_tools'
wp option delete 'request_a_quote_tracking_optin'
wp option delete 'request_a_quote_show_rateme_plugin_min'
wp option delete 'request_a_quote_ent_list'
wp option delete 'request_a_quote_activation_date'
wp option delete 'request_a_quote_tax_list'
wp option delete 'request_a_quote_rel_list'
wp option delete 'request_a_quote_shc_list'
wp option delete 'request_a_quote_attr_list'
wp option delete 'emd_license_settings'
wp option delete 'request_a_quote_setup_pages_list'
