...
delete_site_option('robotspeed_api_token');
delete_option('robotspeed_stats');
delete_site_option('robotspeed_stats');
delete_option('robotspeed_connected');
delete_site_option('robotspeed_connected');
delete_option('robotspeed_connected_email');
delete_site_option('robotspeed_connected_email');
delete_option('robotspeed_connected_site');
delete_site_option('robotspeed_connected_site');
delete_option('robotspeed_connection_token');
delete_site_option('robotspeed_connection_token');
delete_option('robotspeed_analytics_umami_url');
delete_site_option('robotspeed_analytics_umami_url');
delete_option('robotspeed_analytics_website_id');
delete_site_option('robotspeed_analytics_website_id');
