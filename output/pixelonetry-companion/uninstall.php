...
// Delete Options
delete_option('ella_media_id');
delete_site_option('ella_media_id');
...
delete_option('pixelonetry_companion_item_details_page');
delete_site_option('pixelonetry_companion_item_details_page');
