...
// Delete Options
delete_option('youtubesidebar_formvalidation');
delete_site_option('youtubesidebar_formvalidation');
delete_option('youtubesidebar_installedversion');
delete_site_option('youtubesidebar_installedversion');
delete_option('youtubesidebar_installeddate');
delete_site_option('youtubesidebar_installeddate');
delete_option('youtubesidebar_schedule');
delete_site_option('youtubesidebar_schedule');
delete_option('youtubesidebar_notifications');
delete_site_option('youtubesidebar_notifications');
delete_option('youtubesidebar_is_installed');
delete_site_option('youtubesidebar_is_installed');
delete_option('youtubesidebar_capabilities');
delete_site_option('youtubesidebar_capabilities');
delete_option('youtubesidebar_settings');
delete_site_option('youtubesidebar_settings');

// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'youtubesidebar' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'youtubesidebar' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'youtubesidebar' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'youtubesidebar' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'youtubesidebar_project_code' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'youtubesidebar_project_code' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'youtubesidebar_project_code' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'youtubesidebar_project_code' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'youtubesidebar_record_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'youtubesidebar_record_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'youtubesidebar_record_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'youtubesidebar_record_id' ) );
