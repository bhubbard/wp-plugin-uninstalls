...
// Delete Options
delete_option('roxslider_settings_list');
delete_site_option('roxslider_settings_list');
delete_option('__roxslider_oppai__');
delete_site_option('__roxslider_oppai__');
delete_option('__roxslider_license_key__');
delete_site_option('__roxslider_license_key__');
delete_option('roxslider_fse_fonts');
delete_site_option('roxslider_fse_fonts');
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'roxslider_posts_fonts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'roxslider_posts_fonts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'roxslider_posts_fonts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'roxslider_posts_fonts' ) );
