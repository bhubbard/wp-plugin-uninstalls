...
DELETE FROM wp_options WHERE option_name IN ('r_notice_data', 'active_sitewide_plugins', 'ReduxFrameworkPlugin', 'redux-framework-tracking', 'redux_version_upgraded_from', 'redux_support_hash', 'sl_settings', 'redux_tracking_cache', 'redux-extensions-fetch', '_redux_activation_redirect', 'redux_contributors');
