...
delete_site_option('mirrorgrid_themes');
global $wpdb;
...
delete_option('widget_newspaper_lite_featured_slider');
delete_site_option('widget_newspaper_lite_featured_slider');

// Delete Transients
delete_transient('MG_importer_data');
delete_site_transient('MG_importer_data');
