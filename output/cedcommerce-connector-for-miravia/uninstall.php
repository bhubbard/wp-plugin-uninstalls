...
// Delete Options
delete_option('ced_arise_shipping_carriers');
delete_site_option('ced_arise_shipping_carriers');
delete_option('ced_miravia_woo_connection_data');
delete_site_option('ced_miravia_woo_connection_data');
