...
delete_option('wpfp_user_v1');
delete_site_option('wpfp_user_v1');
delete_option('fullstripe_options_f');
delete_site_option('fullstripe_options_f');
delete_option('fullstripe_options');
delete_site_option('fullstripe_options');
global $wpdb;
...
delete_site_transient('wpfs_transaction_volume_notice_check');
global $wpdb;
