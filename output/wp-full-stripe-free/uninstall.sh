...
wp option delete 'wpfp_user_v1'
wp option delete 'fullstripe_options_f'
wp option delete 'fullstripe_options'
...
# Delete Transients
wp transient delete 'wpfs_transaction_volume_notice_check'
