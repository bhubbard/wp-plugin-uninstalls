...
DELETE FROM wp_options WHERE option_name LIKE 'br_product_preview_%';
...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_product_preview_related');
DELETE FROM wp_usermeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_product_preview_related');
DELETE FROM wp_termmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_product_preview_related');
DELETE FROM wp_commentmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_product_preview_related');
