...
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'br_product_preview_%'"
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_product_preview_related'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_product_preview_related'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_product_preview_related'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_product_preview_related'"
