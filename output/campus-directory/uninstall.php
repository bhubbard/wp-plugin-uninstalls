...
delete_option('campus_directory_ent_map_list');
delete_site_option('campus_directory_ent_map_list');
delete_option('campus_directory_tax_settings');
delete_site_option('campus_directory_tax_settings');
delete_option('campus_directory_tools');
delete_site_option('campus_directory_tools');
delete_option('campus_directory_vcard_field_list');
delete_site_option('campus_directory_vcard_field_list');
delete_option('campus_directory_tracking_optin');
delete_site_option('campus_directory_tracking_optin');
delete_option('campus_directory_show_rateme_plugin_min');
delete_site_option('campus_directory_show_rateme_plugin_min');
delete_option('campus_directory_ent_list');
delete_site_option('campus_directory_ent_list');
delete_option('campus_directory_activation_date');
delete_site_option('campus_directory_activation_date');
delete_option('campus_directory_tax_list');
delete_site_option('campus_directory_tax_list');
delete_option('campus_directory_rel_list');
delete_site_option('campus_directory_rel_list');
delete_option('campus_directory_shc_list');
delete_site_option('campus_directory_shc_list');
delete_option('campus_directory_misc_settings');
delete_site_option('campus_directory_misc_settings');
delete_option('campus_directory_attr_list');
delete_site_option('campus_directory_attr_list');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'emd_person_photo' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'emd_person_photo' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'emd_person_photo' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'emd_person_photo' ) );
