...
wp option delete 'campus_directory_ent_map_list'
wp option delete 'campus_directory_tax_settings'
wp option delete 'campus_directory_tools'
wp option delete 'campus_directory_vcard_field_list'
wp option delete 'campus_directory_tracking_optin'
wp option delete 'campus_directory_show_rateme_plugin_min'
wp option delete 'campus_directory_ent_list'
wp option delete 'campus_directory_activation_date'
wp option delete 'campus_directory_tax_list'
wp option delete 'campus_directory_rel_list'
wp option delete 'campus_directory_shc_list'
wp option delete 'campus_directory_misc_settings'
wp option delete 'campus_directory_attr_list'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'emd_person_photo'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'emd_person_photo'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'emd_person_photo'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'emd_person_photo'"
