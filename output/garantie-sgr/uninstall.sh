...
# Delete Options
wp option delete 'garantie_sgr_creating'
wp option delete 'garantie_sgr_version'
wp option delete 'garantie_sgr_product_id'
wp option delete 'garantie_sgr_pending_setup'

# Clear Cron Jobs
wp cron event delete 'garantie_sgr_setup_event'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_enable_sgr'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_enable_sgr'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_enable_sgr'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_enable_sgr'"
