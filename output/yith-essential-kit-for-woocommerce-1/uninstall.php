...
// Delete Options
delete_option('yith_jetpack_active_modules1');
delete_site_option('yith_jetpack_active_modules1');
delete_option('yith_essential_kit_main_version');
delete_site_option('yith_essential_kit_main_version');
...
delete_transient('yith_essential_kit_modules_info');
delete_site_transient('yith_essential_kit_modules_info');
