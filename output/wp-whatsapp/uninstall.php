...
delete_option('nta_wa_url');
delete_site_option('nta_wa_url');
delete_option('nta_wa_user_role');
delete_site_option('nta_wa_user_role');
...
delete_option('njt_wa_first_time_active');
delete_site_option('njt_wa_first_time_active');
delete_option('njt_wa_version');
delete_site_option('njt_wa_version');
delete_option('default_post_edit_rows');
delete_site_option('default_post_edit_rows');
delete_option('nta_whatsapp_setting');
delete_site_option('nta_whatsapp_setting');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'nta_whatsapp_accounts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'nta_whatsapp_accounts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'nta_whatsapp_accounts' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'nta_whatsapp_accounts' ) );
