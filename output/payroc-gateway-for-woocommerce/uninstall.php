...
delete_option('woocommerce_payroc_settings');
delete_site_option('woocommerce_payroc_settings');
delete_option('wc_payroc_version');
delete_site_option('wc_payroc_version');
delete_option('wc_payroc_show_request_api_notice');
delete_site_option('wc_payroc_show_request_api_notice');
