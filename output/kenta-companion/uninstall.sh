...
wp option delete 'kcmp_dynamic_css_cached_version'
wp option delete 'kcmp_customizer_default_settings_version'
wp option delete 'kenta_active_template'
wp option delete 'kb_sync_kenta_theme'
...
wp transient delete 'kcmp_demos'
wp transient delete 'kcmp_demos_version'
