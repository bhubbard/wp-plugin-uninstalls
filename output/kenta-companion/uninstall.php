...
delete_option('kcmp_dynamic_css_cached_version');
delete_site_option('kcmp_dynamic_css_cached_version');
delete_option('kcmp_customizer_default_settings_version');
delete_site_option('kcmp_customizer_default_settings_version');
delete_option('kenta_active_template');
delete_site_option('kenta_active_template');
delete_option('kb_sync_kenta_theme');
delete_site_option('kb_sync_kenta_theme');
global $wpdb;
...
delete_site_transient('kcmp_demos');
delete_transient('kcmp_demos_version');
delete_site_transient('kcmp_demos_version');
