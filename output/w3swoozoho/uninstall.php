...
// Delete Options
delete_option('w3swoozoho_zoho_crm_config');
delete_site_option('w3swoozoho_zoho_crm_config');
delete_option('w3swoozoho_zoho_crm_authorized');
delete_site_option('w3swoozoho_zoho_crm_authorized');
delete_option('w3swoozoho_installed');
delete_site_option('w3swoozoho_installed');
