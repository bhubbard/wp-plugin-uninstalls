...
// Delete Options
delete_option('invelity_gls_connect_options');
delete_site_option('invelity_gls_connect_options');
delete_option('invelity_gls_export_options');
delete_site_option('invelity_gls_export_options');

// Delete Transients
delete_transient('invelity-gls-connect-ad');
delete_site_transient('invelity-gls-connect-ad');
