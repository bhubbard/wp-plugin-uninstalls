...
DELETE FROM wp_options WHERE option_name IN ('emd_session_db_version', 'emd_inline_ent_list', 'emd_activated_plugins', 'secure_cookies', 'cookie_http_only', 'session_delete_batch_size', 'youtube_showcase_access_views', 'youtube_showcase_ent_map_list', 'youtube_showcase_tools', 'youtube_showcase_tracking_optin', 'youtube_showcase_show_rateme_plugin_min', 'youtube_showcase_ent_list', 'youtube_showcase_activation_date', 'youtube_showcase_tax_list', 'youtube_showcase_rel_list', 'youtube_showcase_shc_list', 'youtube_showcase_misc_settings', 'youtube_showcase_attr_list');
