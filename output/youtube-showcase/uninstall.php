...
delete_option('youtube_showcase_access_views');
delete_site_option('youtube_showcase_access_views');
global $wpdb;
...
delete_option('youtube_showcase_ent_map_list');
delete_site_option('youtube_showcase_ent_map_list');
delete_option('youtube_showcase_tools');
delete_site_option('youtube_showcase_tools');
delete_option('youtube_showcase_tracking_optin');
delete_site_option('youtube_showcase_tracking_optin');
delete_option('youtube_showcase_show_rateme_plugin_min');
delete_site_option('youtube_showcase_show_rateme_plugin_min');
delete_option('youtube_showcase_ent_list');
delete_site_option('youtube_showcase_ent_list');
delete_option('youtube_showcase_activation_date');
delete_site_option('youtube_showcase_activation_date');
delete_option('youtube_showcase_tax_list');
delete_site_option('youtube_showcase_tax_list');
delete_option('youtube_showcase_rel_list');
delete_site_option('youtube_showcase_rel_list');
delete_option('youtube_showcase_shc_list');
delete_site_option('youtube_showcase_shc_list');
delete_option('youtube_showcase_misc_settings');
delete_site_option('youtube_showcase_misc_settings');
global $wpdb;
...
delete_option('youtube_showcase_attr_list');
delete_site_option('youtube_showcase_attr_list');
