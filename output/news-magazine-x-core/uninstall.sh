...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_newsx_demo_import_item'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_newsx_demo_import_item'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_newsx_demo_import_item'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_newsx_demo_import_item'"
