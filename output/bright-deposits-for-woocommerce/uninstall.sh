...
# Delete Options
wp option delete 'bdfwbp_installed'
wp option delete 'woocommerce_tax_display_cart'
wp option delete 'bdfwbp_deposits_settings'
wp option delete 'bdfwbp_deposits_settings[days_before_due]'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_bdfwbp_enable_deposit'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_bdfwbp_enable_deposit'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_bdfwbp_enable_deposit'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_bdfwbp_enable_deposit'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_bdfwbp_deposits_type'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_bdfwbp_deposits_type'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_bdfwbp_deposits_type'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_bdfwbp_deposits_type'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_bdfwbp_deposits_value'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_bdfwbp_deposits_value'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_bdfwbp_deposits_value'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_bdfwbp_deposits_value'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_bdfwbp_enable_variation_deposit'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_bdfwbp_enable_variation_deposit'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_bdfwbp_enable_variation_deposit'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_bdfwbp_enable_variation_deposit'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_bdfwbp_force_deposit_checked'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_bdfwbp_force_deposit_checked'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_bdfwbp_force_deposit_checked'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_bdfwbp_force_deposit_checked'"
