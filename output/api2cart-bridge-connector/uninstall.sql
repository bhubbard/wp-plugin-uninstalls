...
DELETE FROM wp_options WHERE option_name IN ('woocommerce_custom_orders_table_enabled', 'woocommerce_weight_unit', 'woocommerce_manage_stock', 'active_sitewide_plugins');
