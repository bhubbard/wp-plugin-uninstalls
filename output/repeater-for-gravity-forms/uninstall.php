...
// Delete Options
delete_option('yeeaddons_gf_input_mask');
delete_site_option('yeeaddons_gf_input_mask');
delete_option('_redmuber_item_1540');
delete_site_option('_redmuber_item_1540');
global $wpdb;
