...
delete_site_option('wcc_gf_lawmatics_ignore_spam_entry');
...
delete_site_option('wcc_gf_lawmatics_uninstall');
delete_option('wcc_gf_lawmatics_db_version');
delete_site_option('wcc_gf_lawmatics_db_version');
