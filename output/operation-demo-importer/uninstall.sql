...
DELETE FROM wp_options WHERE option_name IN ('_cs_options', 'sidebars_widgets', '_wc_needs_pages', 'elementor_disable_color_schemes', 'elementor_disable_typography_schemes', 'elementor_load_fa4_shim', 'elementor_container_width', '_wc_activation_redirect');
