...
wp option delete 'mailchimp_api_status'
wp option delete 'aweber_api_status'
wp option delete 'aweber_consumer_key'
wp option delete 'aweber_consumer_secret'
wp option delete 'aweber_access_token'
wp option delete 'aweber_access_secret'
wp option delete 'campaignmonitor_api_status'
wp option delete 'getresponse_api_status'
wp option delete 'convertkit_api_status'
wp option delete 'custom_html_form_action'
wp option delete 'custom_html_hidden_inputs'
wp option delete 'custom_html_name_input'
wp option delete 'custom_html_email_input'
wp option delete 'custom_html_normal_inputs'
