...
wp option delete 'handmade_params'
wp option delete 'woocommerce_logs_retention_period_days'
wp option delete 'handmade_setup_wizard'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_handmade_image_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_handmade_image_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_handmade_image_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_handmade_image_id'"
