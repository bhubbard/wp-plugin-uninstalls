...
delete_option('handmade_params');
delete_site_option('handmade_params');
delete_option('woocommerce_logs_retention_period_days');
delete_site_option('woocommerce_logs_retention_period_days');
delete_option('handmade_setup_wizard');
delete_site_option('handmade_setup_wizard');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", '_handmade_image_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", '_handmade_image_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", '_handmade_image_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", '_handmade_image_id' ) );
