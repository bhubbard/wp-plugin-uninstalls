...
// Delete Options
delete_option('_woocommerce_notification_prefix');
delete_site_option('_woocommerce_notification_prefix');
delete_option('wnotification_params');
delete_site_option('wnotification_params');
global $wpdb;
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_wn_product_child%', '_site_transient_wn_product_child%' ) );
