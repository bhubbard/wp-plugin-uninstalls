...
delete_option('en_tql_carriers');
delete_site_option('en_tql_carriers');
delete_option('en_connection_settings_api_tql');
delete_site_option('en_connection_settings_api_tql');
delete_option('en_quote_settings_enable_logs_tql');
delete_site_option('en_quote_settings_enable_logs_tql');
...
delete_option('en_connection_settings_license_key_tql');
delete_site_option('en_connection_settings_license_key_tql');
delete_option('en_quote_settings_show_delivery_estimate_tql');
delete_site_option('en_quote_settings_show_delivery_estimate_tql');
delete_option('en_quote_settings_delivery_estimate_options_tql');
delete_site_option('en_quote_settings_delivery_estimate_options_tql');
...
delete_option('tql_backup_rates_category');
delete_site_option('tql_backup_rates_category');
delete_option('tql_backup_rates_display');
delete_site_option('tql_backup_rates_display');
delete_option('en_tql_plan_number');
delete_site_option('en_tql_plan_number');
delete_option('en_tql_plan_message');
delete_site_option('en_tql_plan_message');
delete_option('active_sitewide_plugins');
delete_site_option('active_sitewide_plugins');
delete_option('en_tql_plan_expire_days');
delete_site_option('en_tql_plan_expire_days');
delete_option('en_tql_plan_expire_date');
delete_site_option('en_tql_plan_expire_date');
delete_option('en_tql_store_type');
delete_site_option('en_tql_store_type');
delete_option('en_tql_ltl_update_now');
delete_site_option('en_tql_ltl_update_now');
...
delete_option('tql_backup_rates_fixed_rate');
delete_site_option('tql_backup_rates_fixed_rate');
delete_option('tql_backup_rates_cart_price_percentage');
delete_site_option('tql_backup_rates_cart_price_percentage');
delete_option('tql_backup_rates_weight_function');
delete_site_option('tql_backup_rates_weight_function');
delete_option('en_quote_settings_order_cut_off_time_tql');
delete_site_option('en_quote_settings_order_cut_off_time_tql');
delete_option('enable_backup_rates_tql');
delete_site_option('enable_backup_rates_tql');
delete_option('en_quote_settings_allow_other_plugins_tql');
delete_site_option('en_quote_settings_allow_other_plugins_tql');
...
delete_option('en_quote_settings_residential_delivery_tql');
delete_site_option('en_quote_settings_residential_delivery_tql');
delete_option('en_quote_settings_liftgate_delivery_tql');
delete_site_option('en_quote_settings_liftgate_delivery_tql');
...
delete_option('en_quote_settings_rating_method_tql');
delete_site_option('en_quote_settings_rating_method_tql');
delete_option('en_quote_settings_custom_label_tql');
delete_site_option('en_quote_settings_custom_label_tql');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_shipment_day_tql' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
delete_option('en_quote_settings_shipment_offset_days_tql');
delete_site_option('en_quote_settings_shipment_offset_days_tql');
delete_option('en_quote_settings_own_arrangment_tql');
delete_site_option('en_quote_settings_own_arrangment_tql');
delete_option('en_quote_settings_text_for_own_arrangment_tql');
delete_site_option('en_quote_settings_text_for_own_arrangment_tql');
delete_option('en_quote_settings_number_of_options_tql');
delete_site_option('en_quote_settings_number_of_options_tql');
delete_option('en_quote_settings_handling_unit_weight_tql');
delete_site_option('en_quote_settings_handling_unit_weight_tql');
delete_option('en_quote_settings_max_handling_unit_weight_tql');
delete_site_option('en_quote_settings_max_handling_unit_weight_tql');
delete_option('en_quote_settings_handling_fee_tql');
delete_site_option('en_quote_settings_handling_fee_tql');
delete_option('tql_liftgate_delivery_as_option');
delete_site_option('tql_liftgate_delivery_as_option');
...
delete_option('tql_backup_rates_carrier_returns_error');
delete_site_option('tql_backup_rates_carrier_returns_error');
delete_option('tql_backup_rates_carrier_fails_to_return_response');
delete_site_option('tql_backup_rates_carrier_fails_to_return_response');
...
delete_option('tql_backup_rates_label');
delete_site_option('tql_backup_rates_label');
