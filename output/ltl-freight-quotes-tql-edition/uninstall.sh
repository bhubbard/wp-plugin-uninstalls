...
wp option delete 'en_tql_carriers'
wp option delete 'en_connection_settings_api_tql'
wp option delete 'en_quote_settings_enable_logs_tql'
wp option delete 'en_fdo_company_id'
wp option delete 'en_fdo_company_id_status'
wp option delete 'en_connection_settings_license_key_tql'
wp option delete 'en_quote_settings_show_delivery_estimate_tql'
wp option delete 'en_quote_settings_delivery_estimate_options_tql'
wp option delete 'en_plugins_return_LTL_quotes'
wp option delete 'en_weight_threshold_lfq'
wp option delete 'tql_backup_rates_category'
wp option delete 'tql_backup_rates_display'
wp option delete 'en_tql_plan_number'
wp option delete 'en_tql_plan_message'
wp option delete 'active_sitewide_plugins'
wp option delete 'en_tql_plan_expire_days'
wp option delete 'en_tql_plan_expire_date'
wp option delete 'en_tql_store_type'
wp option delete 'en_tql_ltl_update_now'
wp option delete 'eniture_show_rate_limit_notice_with_time'
wp option delete 'eniture_rate_limit_reset_timestamp'
wp option delete 'tql_backup_rates_fixed_rate'
wp option delete 'tql_backup_rates_cart_price_percentage'
wp option delete 'tql_backup_rates_weight_function'
wp option delete 'en_quote_settings_order_cut_off_time_tql'
wp option delete 'enable_backup_rates_tql'
wp option delete 'en_quote_settings_allow_other_plugins_tql'
wp option delete 'EN_Plugins'
wp option delete 'eniture_show_rate_limit_notice_without_time'
wp option delete 'en_quote_settings_residential_delivery_tql'
wp option delete 'en_quote_settings_liftgate_delivery_tql'
...
wp option delete 'en_quote_settings_rating_method_tql'
wp option delete 'en_quote_settings_custom_label_tql'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_shipment_day_tql'"
wp option delete 'en_quote_settings_shipment_offset_days_tql'
wp option delete 'en_quote_settings_own_arrangment_tql'
wp option delete 'en_quote_settings_text_for_own_arrangment_tql'
wp option delete 'en_quote_settings_number_of_options_tql'
wp option delete 'en_quote_settings_handling_unit_weight_tql'
wp option delete 'en_quote_settings_max_handling_unit_weight_tql'
wp option delete 'en_quote_settings_handling_fee_tql'
wp option delete 'tql_liftgate_delivery_as_option'
wp option delete 'en_woo_addons_liftgate_with_auto_residential'
wp option delete 'tql_backup_rates_carrier_returns_error'
wp option delete 'tql_backup_rates_carrier_fails_to_return_response'
...
wp option delete 'tql_backup_rates_label'
