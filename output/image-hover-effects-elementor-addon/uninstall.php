...
// Delete Options
delete_option('jltimghe_sheet_promo_data');
delete_site_option('jltimghe_sheet_promo_data');
delete_option('jltimghe_sheet_promo_data_hash');
delete_site_option('jltimghe_sheet_promo_data_hash');
delete_option('jltimghe_activation_time');
delete_site_option('jltimghe_activation_time');
global $wpdb;
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_jltimghe-plugin-info-%', '_site_transient_jltimghe-plugin-info-%' ) );
foreach ( $transients as $transient ) {
	delete_option( $transient );
}

// Clear Cron Jobs
wp_clear_scheduled_hook('jltimghe_sheet_promo_data_remote_sync');
