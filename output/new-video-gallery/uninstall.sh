...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE 'awl_vg_settings_%'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE 'awl_vg_settings_%'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE 'awl_vg_settings_%'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE 'awl_vg_settings_%'"
