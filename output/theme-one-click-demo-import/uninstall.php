...
// Delete Transients
delete_transient('theme404_ocdi_author_themes');
delete_site_transient('theme404_ocdi_author_themes');
delete_transient('theme404_ocdi_demo_categories');
delete_site_transient('theme404_ocdi_demo_categories');
delete_transient('theme404_ocdi_plugins');
delete_site_transient('theme404_ocdi_plugins');
