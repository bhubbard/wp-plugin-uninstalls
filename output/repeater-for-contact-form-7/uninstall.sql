...
DELETE FROM wp_options WHERE option_name IN ('_redmuber_item_1654', 'ninja_forms_addons_feed', 'yeekit_addons');
...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('cf7_repeater_datas');
DELETE FROM wp_usermeta WHERE meta_key IN ('cf7_repeater_datas');
DELETE FROM wp_termmeta WHERE meta_key IN ('cf7_repeater_datas');
DELETE FROM wp_commentmeta WHERE meta_key IN ('cf7_repeater_datas');
