...
# Delete Options
wp option delete '_redmuber_item_1654'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'cf7_repeater_datas'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'cf7_repeater_datas'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'cf7_repeater_datas'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'cf7_repeater_datas'"
