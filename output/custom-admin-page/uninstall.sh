...
wp option delete 'cstmdmnpg_options'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'bws-admin_page'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'bws-admin_page'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'bws-admin_page'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'bws-admin_page'"
