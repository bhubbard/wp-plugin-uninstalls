...
delete_site_option('devnet_fsl_general');
delete_option('devnet_fsl_bar');
delete_site_option('devnet_fsl_bar');
delete_option('devnet_fsl_gift_bar');
delete_site_option('devnet_fsl_gift_bar');
delete_option('devnet_fsl_notice_bar');
delete_site_option('devnet_fsl_notice_bar');
delete_option('devnet_fsl_label');
delete_site_option('devnet_fsl_label');
delete_option('devnet_fsl_multilingual_check');
delete_site_option('devnet_fsl_multilingual_check');
delete_option('devnet_fsl_layout_check');
delete_site_option('devnet_fsl_layout_check');
global $wpdb;
