...
// Delete Options
delete_option('learndash-hubspot-settings-key');
delete_site_option('learndash-hubspot-settings-key');
delete_option('learndash-hubspot-settings-deal');
delete_site_option('learndash-hubspot-settings-deal');
delete_option('learndash-hubspot-settings-contact');
delete_site_option('learndash-hubspot-settings-contact');
global $wpdb;
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key LIKE %s", 'ldhs_dl_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key LIKE %s", 'ldhs_dl_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key LIKE %s", 'ldhs_dl_%' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key LIKE %s", 'ldhs_dl_%' ) );
