...
DELETE FROM wp_postmeta WHERE meta_key LIKE 'apt_pricing_table_data_%';
DELETE FROM wp_usermeta WHERE meta_key LIKE 'apt_pricing_table_data_%';
DELETE FROM wp_termmeta WHERE meta_key LIKE 'apt_pricing_table_data_%';
DELETE FROM wp_commentmeta WHERE meta_key LIKE 'apt_pricing_table_data_%';
