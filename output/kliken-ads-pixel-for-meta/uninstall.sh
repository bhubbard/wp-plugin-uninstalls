...
wp option delete 'kk_fb_wc_settings'
wp option delete 'woocommerce_kk_fb_wc_integration_settings'
wp option delete 'kk_fb_wc_welcome_message_dismissed'
wp option delete 'kk_fb_wc_bootstrap_message_dismissed'

# Delete Transients
wp transient delete 'kk_fb_wc_activation_redirect'
wp transient delete 'kk_fb_wc_welcome_message'
wp transient delete 'kk_fb_wc_bootstrap_message'
