...
# Delete Options
wp option delete 'wc-to-invoicing-plus_api_key'
wp option delete 'wc-to-invoicing-plus_api_company'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_invoice_status'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_invoice_status'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_invoice_status'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_invoice_status'"
