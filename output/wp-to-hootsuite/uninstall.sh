...
# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%_hootsuite_api_profiles' OR option_name LIKE '_site_transient_%_hootsuite_api_profiles'"
