...
delete_option('woocommerce_wspa_checkout_form_settings');
delete_site_option('woocommerce_wspa_checkout_form_settings');
delete_option('wspa_sys_settings');
delete_site_option('wspa_sys_settings');
global $wpdb;
