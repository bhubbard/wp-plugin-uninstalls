...
# Delete Options
wp option delete '_adminify_activity_logs_days'
wp option delete 'adminify_activity_logs_version'
wp option delete 'jltwp_adminify_activitylogs_sheet_promo_data'
wp option delete 'jltwp_adminify_activitylogs_sheet_promo_data_hash'
...
wp option delete 'adminify_activitylogs_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_jltwp_adminify_activitylogs-plugin-info-%' OR option_name LIKE '_site_transient_jltwp_adminify_activitylogs-plugin-info-%'"
...
# Clear Cron Jobs
wp cron event delete 'jltwp_adminify_activitylogs_sheet_promo_data_remote_sync'
