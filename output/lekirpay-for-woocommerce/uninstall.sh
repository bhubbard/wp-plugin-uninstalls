...
# Delete Options
wp option delete 'woocommerce_lekirpay_settings'
wp option delete 'lekirpay_fpx_banks'
wp option delete 'lekirpay_fpx_banks_last'

# Clear Cron Jobs
wp cron event delete 'lekirpay_bills_invalidator'
