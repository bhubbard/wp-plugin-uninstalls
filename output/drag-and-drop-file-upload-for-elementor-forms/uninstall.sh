...
# Delete Options
wp option delete '_yeeaddons_dropbox_api_token'
wp option delete '_yeeaddons_dropbox_api_token_refresh_token'
wp option delete 'elementor_yeeaddons_drobox_client_id'
wp option delete 'elementor_yeeaddons_dropbox_client_secret'
