...
// Delete Options
delete_option('_yeeaddons_dropbox_api_token');
delete_site_option('_yeeaddons_dropbox_api_token');
delete_option('_yeeaddons_dropbox_api_token_refresh_token');
delete_site_option('_yeeaddons_dropbox_api_token_refresh_token');
delete_option('elementor_yeeaddons_drobox_client_id');
delete_site_option('elementor_yeeaddons_drobox_client_id');
delete_option('elementor_yeeaddons_dropbox_client_secret');
delete_site_option('elementor_yeeaddons_dropbox_client_secret');
global $wpdb;
