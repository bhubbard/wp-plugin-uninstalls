...
# Delete Options
wp option delete 'wpmm_fresh_install'
wp option delete 'wpmm_new_look'
wp option delete 'wpmm_settings_redirect'
wp option delete 'wpmm_settings'
wp option delete 'wpmm_page_category'
wp option delete 'wpmm_migration_time'
wp option delete 'themeisle_sdk_promotions_otter_installed'
wp option delete 'otter_reference_key'
wp option delete 'wpmm_notice'
wp option delete 'wpmm_show_migration'
wp option delete 'wpmm_activated'
wp option delete 'wp-maintenance-mode'
wp option delete 'wp-maintenance-mode-msqld'
wp option delete 'wpmm_version'
