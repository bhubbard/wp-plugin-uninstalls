...
DELETE FROM wp_options WHERE option_name IN ('church_event_option', 'church_announcements_option', 'church_ministries_option', 'church_sermons_option', 'church_people_option', 'church_verses_option', 'rss_language', 'acf_repeater_ac', 'acf_gallery_ac', 'acf_options_page_ac', 'acf_flexible_content_ac', 'acf_version');
