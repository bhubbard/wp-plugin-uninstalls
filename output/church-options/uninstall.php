...
// Delete Options
delete_option('church_event_option');
delete_site_option('church_event_option');
delete_option('church_announcements_option');
delete_site_option('church_announcements_option');
delete_option('church_ministries_option');
delete_site_option('church_ministries_option');
delete_option('church_sermons_option');
delete_site_option('church_sermons_option');
delete_option('church_people_option');
delete_site_option('church_people_option');
delete_option('church_verses_option');
delete_site_option('church_verses_option');
