...
// Delete Options
delete_option('marctv-moderation-text');
delete_site_option('marctv-moderation-text');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_members_only' ) );
