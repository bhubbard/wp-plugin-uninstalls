...
delete_option('tuext_fp_installed');
delete_site_option('tuext_fp_installed');
delete_option('tuext_dismiss_fp_create');
delete_site_option('tuext_dismiss_fp_create');
delete_option('sidebars_widgets');
delete_site_option('sidebars_widgets');
delete_option('tradeup_ext_widgets_bk');
delete_site_option('tradeup_ext_widgets_bk');
