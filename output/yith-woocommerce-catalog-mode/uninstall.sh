...
# Delete Options
wp option delete 'ywctm-plugin-welcome-modal'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'ywctm_admin_view%'"
wp option delete 'ywctm_disable_shop'
wp option delete 'ywctm_apply_users'
wp option delete 'ywctm_hide_add_to_cart_settings'
wp option delete 'ywctm_hide_variations'
