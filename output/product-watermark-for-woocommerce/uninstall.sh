...
wp option delete 'br_watermarked'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_watermark'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_watermark'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_watermark'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_watermark'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_thumbnail_id_watermarked'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_thumbnail_id_watermarked'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_thumbnail_id_watermarked'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_thumbnail_id_watermarked'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_product_image_gallery_watermarked'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_product_image_gallery_watermarked'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_product_image_gallery_watermarked'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_product_image_gallery_watermarked'"
