...
// Delete Options
delete_option('ssmhs_title_priority');
delete_site_option('ssmhs_title_priority');
delete_option('ssmhs_desc_priority');
delete_site_option('ssmhs_desc_priority');
delete_option('ssmhs_robots_priority');
delete_site_option('ssmhs_robots_priority');
