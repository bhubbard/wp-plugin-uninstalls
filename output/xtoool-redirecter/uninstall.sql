...
DELETE FROM wp_options WHERE option_name IN ('redirection_lookup', 'redirection_post', 'redirection_root', 'redirection_index', 'redirection_options', 'rss_language', 'prli_db_version', 'quickppr_redirects', '301_redirects');
