...
wp option delete 'br-sales_report-version'
...
# Clear Cron Jobs
wp cron event delete 'berocket_get_orders'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_report_send_date'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_report_send_date'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_report_send_date'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_report_send_date'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_last_report_time'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_last_report_time'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_last_report_time'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_last_report_time'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_sale_report'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_sale_report'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_sale_report'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_sale_report'"
