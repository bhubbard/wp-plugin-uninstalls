...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_report_send_date', 'berocket_last_report_time', 'br_sale_report', '_sku');
DELETE FROM wp_usermeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_report_send_date', 'berocket_last_report_time', 'br_sale_report', '_sku');
DELETE FROM wp_termmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_report_send_date', 'berocket_last_report_time', 'br_sale_report', '_sku');
DELETE FROM wp_commentmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'berocket_report_send_date', 'berocket_last_report_time', 'br_sale_report', '_sku');
