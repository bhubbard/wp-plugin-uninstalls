...
# Delete Options
wp option delete 'ef-domain'
wp option delete 'ef-apikey'
wp option delete 'ef-woocommerce-active'
wp option delete 'ef_courses_page_title'
wp option delete 'ef_courses_page_name'
wp option delete 'ef_courses_page_id'
wp option delete 'ef_signup_page_title'
wp option delete 'ef_signup_page_name'
wp option delete 'ef_signup_page_id'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_efront_course_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_efront_course_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_efront_course_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_efront_course_id'"
