...
// Delete Options
delete_option('sahcfwc_stripe_checkout_status');
delete_site_option('sahcfwc_stripe_checkout_status');
delete_option('sahcfwc_stripe_shipping_address_status');
delete_site_option('sahcfwc_stripe_shipping_address_status');
delete_option('sahcfwc_stripe_terms_condition_status');
delete_site_option('sahcfwc_stripe_terms_condition_status');
delete_option('sahcfwc_stripe_phone_num_status');
delete_site_option('sahcfwc_stripe_phone_num_status');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", 'sahcfwc_stripe_checkout_%' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
delete_option('sahcfwc_stripe_cancel_url');
delete_site_option('sahcfwc_stripe_cancel_url');
delete_option('sahcfwc_stripe_delete_temp_order_status');
delete_site_option('sahcfwc_stripe_delete_temp_order_status');
delete_option('woocommerce_prices_include_tax');
delete_site_option('woocommerce_prices_include_tax');
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%_wc_order_id' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
...
delete_option('sahcfwc_checkout_license_action');
delete_site_option('sahcfwc_checkout_license_action');
delete_option('sahcfwc_stripe_test_secret_key');
delete_site_option('sahcfwc_stripe_test_secret_key');
delete_option('sahcfwc_stripe_live_secret_key');
delete_site_option('sahcfwc_stripe_live_secret_key');
delete_option('woocommerce_default_country');
delete_site_option('woocommerce_default_country');
delete_option('sahcfwc_stripe_integration_mode');
delete_site_option('sahcfwc_stripe_integration_mode');
delete_option('sahcfwc_stripe_webhook_key');
delete_site_option('sahcfwc_stripe_webhook_key');
delete_option('sahcfwc_use_restricted_keys');
delete_site_option('sahcfwc_use_restricted_keys');
delete_option('sahcfwc_restricted_test_key');
delete_site_option('sahcfwc_restricted_test_key');
delete_option('sahcfwc_restricted_live_key');
delete_site_option('sahcfwc_restricted_live_key');
delete_option('sahcfwc_api_key_type');
delete_site_option('sahcfwc_api_key_type');
delete_option('sahcfwc_stripe_admin_test_mode_status');
delete_site_option('sahcfwc_stripe_admin_test_mode_status');
delete_option('sahcfwc_stripe_payment_methodes');
delete_site_option('sahcfwc_stripe_payment_methodes');

// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'sahcfwc_stripe_ch_customer_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'sahcfwc_stripe_ch_customer_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'sahcfwc_stripe_ch_customer_id' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'sahcfwc_stripe_ch_customer_id' ) );
