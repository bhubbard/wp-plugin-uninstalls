...
# Delete Options
wp option delete 'sahcfwc_stripe_checkout_status'
wp option delete 'sahcfwc_stripe_shipping_address_status'
wp option delete 'sahcfwc_stripe_terms_condition_status'
wp option delete 'sahcfwc_stripe_phone_num_status'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'sahcfwc_stripe_checkout_%'"
wp option delete 'sahcfwc_stripe_cancel_url'
wp option delete 'sahcfwc_stripe_delete_temp_order_status'
wp option delete 'woocommerce_prices_include_tax'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_wc_order_id'"
wp option delete 'woocommerce_enable_coupons'
wp option delete 'sahcfwc_checkout_license_action'
wp option delete 'sahcfwc_stripe_test_secret_key'
wp option delete 'sahcfwc_stripe_live_secret_key'
wp option delete 'woocommerce_default_country'
wp option delete 'sahcfwc_stripe_integration_mode'
wp option delete 'sahcfwc_stripe_webhook_key'
wp option delete 'sahcfwc_use_restricted_keys'
wp option delete 'sahcfwc_restricted_test_key'
wp option delete 'sahcfwc_restricted_live_key'
wp option delete 'sahcfwc_api_key_type'
wp option delete 'sahcfwc_stripe_admin_test_mode_status'
wp option delete 'sahcfwc_stripe_payment_methodes'

# Direct DB Queries (Fallback)
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'sahcfwc_stripe_ch_customer_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'sahcfwc_stripe_ch_customer_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'sahcfwc_stripe_ch_customer_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'sahcfwc_stripe_ch_customer_id'"
