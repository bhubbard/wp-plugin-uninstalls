...
DELETE FROM wp_options WHERE option_name IN ('woocommerce_prices_include_tax', 'woocommerce_tax_display_cart', 'woocommerce_currency_pos', 'recently_activated', 'update_plugins');
