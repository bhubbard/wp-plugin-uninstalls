...
DELETE FROM wp_options WHERE option_name IN ('active_sitewide_plugins', 'acf_first_activated_version', 'acf_escaped_html_notice_dismissed', 'cptui_post_types', 'cptui_taxonomies', 'acf_escaped_html_log', 'acf_will_escape_html_log', 'acf_version', 'acf_deactivated_notice_id');
