...
// Delete Options
delete_option('wpb2205_cpt_base');
delete_site_option('wpb2205_cpt_base');
delete_option('woopb_option-param');
delete_site_option('woopb_option-param');
...
delete_site_transient('wc_layered_nav_counts');
...
// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'woopb-param' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'woopb-param' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'woopb-param' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'woopb-param' ) );
