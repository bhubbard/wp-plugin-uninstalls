...
DELETE FROM wp_options WHERE option_name IN ('bstwbsftwppdtplgns_options', 'recently_activated', 'active_sitewide_plugins', 'vstrsnln_options', 'widget_vstrsnln_widget', 'update_plugins', 'bws_plugins_update');
