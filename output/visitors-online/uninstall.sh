...
wp option delete 'vstrsnln_options'
wp option delete 'widget_vstrsnln_widget'
...
# Clear Cron Jobs
wp cron event delete 'vstrsnln_check_users'
wp cron event delete 'vstrsnln_count_visits_day'
