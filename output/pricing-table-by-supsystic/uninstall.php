...
delete_option('pts_ac_subscribe');
delete_site_option('pts_ac_subscribe');
delete_option('pts_ac_remind');
delete_site_option('pts_ac_remind');
delete_option('pts_ac_disabled');
delete_site_option('pts_ac_disabled');
delete_option('pts_show_love_link');
delete_site_option('pts_show_love_link');
delete_option('pts_last_check_love_link');
delete_site_option('pts_last_check_love_link');
delete_option('supsystic_pts_love_link_title');
delete_site_option('supsystic_pts_love_link_title');
global $wpdb;
