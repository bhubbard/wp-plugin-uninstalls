...
delete_option('active-digital-barcodes-version');
delete_site_option('active-digital-barcodes-version');
...
// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_%2.0.5', '_site_transient_%2.0.5' ) );
