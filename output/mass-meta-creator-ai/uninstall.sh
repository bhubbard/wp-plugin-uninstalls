...
# Delete Options
wp option delete 'mass_meta_creator_homepage_context'
wp option delete 'mass_meta_creator_provider'
wp option delete 'mass_meta_creator_api_key'
wp option delete 'mass_meta_creator_gemini_model'

# Delete Transients
wp transient delete 'mass_meta_creator_api_check'
wp transient delete 'mass_meta_creator_model_check'
