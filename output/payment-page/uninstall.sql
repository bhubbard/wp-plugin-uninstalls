...
DELETE FROM wp_options WHERE option_name LIKE 'payment_page_area_%';
DELETE FROM wp_options WHERE option_name LIKE '%_form_templates';
DELETE FROM wp_options WHERE option_name LIKE '%_stripe_apple_pay_domain';

-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('payment_page_settings', '_elementor_data');
DELETE FROM wp_usermeta WHERE meta_key IN ('payment_page_settings', '_elementor_data');
DELETE FROM wp_termmeta WHERE meta_key IN ('payment_page_settings', '_elementor_data');
DELETE FROM wp_commentmeta WHERE meta_key IN ('payment_page_settings', '_elementor_data');
