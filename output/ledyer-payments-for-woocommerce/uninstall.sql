...
DELETE FROM wp_options WHERE option_name IN ('woocommerce_ledyer_payments_settings', 'woocommerce_smart_coupon_apply_before_tax', 'ledyer_payments_access_token');
