...
# Delete Options
wp option delete 'BeRocket_splash_popup_page_types'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br-splash_popup-options'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br-splash_popup-options'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br-splash_popup-options'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br-splash_popup-options'"
