...
# Delete Options
wp option delete 'freshdesk_options'
wp option delete 'freshdesk_feedback_options'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'fd_ticket_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'fd_ticket_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'fd_ticket_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'fd_ticket_id'"
