...
delete_option('wpinv_wallet_default_topup_form');
delete_site_option('wpinv_wallet_default_topup_form');
delete_option('wpinv_wallet_db_version');
delete_site_option('wpinv_wallet_db_version');
delete_option('wpinv_wallet_encryption_vector');
delete_site_option('wpinv_wallet_encryption_vector');
