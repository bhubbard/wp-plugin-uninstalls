...
wp option delete 'media_library_organizer_pro_license_data'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_install'"
wp option delete 'wpuxss_eml_version'
wp option delete 'wpuxss_eml_taxonomies'
...
# Delete Transients
wp transient delete 'mlo_optimole_data'
...
# Clear Cron Jobs
wp cron event delete 'media_library_organizer_remove_exported_zip'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = '_modified_at'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = '_modified_at'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = '_modified_at'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = '_modified_at'"
