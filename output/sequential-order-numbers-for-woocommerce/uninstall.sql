...
-- Delete Metadata
DELETE FROM wp_postmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_order_number_id', 'berocket_priority', 'br_order_numbers');
DELETE FROM wp_usermeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_order_number_id', 'berocket_priority', 'br_order_numbers');
DELETE FROM wp_termmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_order_number_id', 'berocket_priority', 'br_order_numbers');
DELETE FROM wp_commentmeta WHERE meta_key IN ('total_sales', 'berocket_post_order', 'br_order_number_id', 'berocket_priority', 'br_order_numbers');
