...
wp option delete 'br_order_number_id'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_order_number_id'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_order_number_id'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_order_number_id'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_order_number_id'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'berocket_priority'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'berocket_priority'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'berocket_priority'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'berocket_priority'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'br_order_numbers'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'br_order_numbers'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'br_order_numbers'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'br_order_numbers'"
