...
// Delete Options
delete_option('gutenakit_onboarding');
delete_site_option('gutenakit_onboarding');
delete_option('active_sitewide_plugins');
delete_site_option('active_sitewide_plugins');
delete_option('gutena_kit_global_typography');
delete_site_option('gutena_kit_global_typography');
global $wpdb;
...
delete_option('gutena_inactive_blocks');
delete_site_option('gutena_inactive_blocks');

// Delete Transients
delete_transient('gutenakit_demo_required_plugins');
delete_site_transient('gutenakit_demo_required_plugins');
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_%_merlin_redirect', '_site_transient_%_merlin_redirect' ) );
foreach ( $transients as $transient ) {
	delete_option( $transient );
}
delete_transient('merlin_import_file_base_name');
delete_site_transient('merlin_import_file_base_name');
...
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'gutenakit_post_config' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'gutenakit_post_config' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'gutenakit_post_config' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'gutenakit_post_config' ) );
