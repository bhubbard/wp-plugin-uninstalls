...
# Delete Options
wp option delete 'gutenakit_onboarding'
wp option delete 'active_sitewide_plugins'
wp option delete 'gutena_kit_global_typography'
...
wp option delete 'gutena_inactive_blocks'

# Delete Transients
wp transient delete 'gutenakit_demo_required_plugins'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_%_merlin_redirect' OR option_name LIKE '_site_transient_%_merlin_redirect'"
wp transient delete 'merlin_import_file_base_name'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'gutenakit_post_config'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'gutenakit_post_config'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'gutenakit_post_config'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'gutenakit_post_config'"
