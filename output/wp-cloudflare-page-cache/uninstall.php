...
delete_site_option('swcfpc_version');
delete_option('swcfpc_config');
delete_site_option('swcfpc_config');
delete_option('swcfpc_fc_ttl_registry');
delete_site_option('swcfpc_fc_ttl_registry');
delete_option('cf_will_run_free_to_pro_migrations');
delete_site_option('cf_will_run_free_to_pro_migrations');
delete_option('swcfpc_preloader_lock');
delete_site_option('swcfpc_preloader_lock');
delete_option('swcfpc_purge_cache_lock');
delete_site_option('swcfpc_purge_cache_lock');
...
// Delete Transients
delete_transient('swpcf_optimole_data');
delete_site_transient('swpcf_optimole_data');
global $wpdb;
...
wp_clear_scheduled_hook('swcfpc_purge_cache_cron');
wp_clear_scheduled_hook('delete_fonts_folder');

// Clear Metadata
global $wpdb;
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->postmeta} WHERE meta_key = %s", 'swcfpc_bypass_cache' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->usermeta} WHERE meta_key = %s", 'swcfpc_bypass_cache' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->termmeta} WHERE meta_key = %s", 'swcfpc_bypass_cache' ) );
$wpdb->query( $wpdb->prepare( "DELETE FROM {$wpdb->commentmeta} WHERE meta_key = %s", 'swcfpc_bypass_cache' ) );
