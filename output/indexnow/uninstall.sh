...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%admin_bwt_site_auth_key'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%admin_bwt_site_auth_timestamp'"
