...
DELETE FROM wp_postmeta WHERE meta_key LIKE 'facebook_cpt_settings%';
DELETE FROM wp_usermeta WHERE meta_key LIKE 'facebook_cpt_settings%';
DELETE FROM wp_termmeta WHERE meta_key LIKE 'facebook_cpt_settings%';
DELETE FROM wp_commentmeta WHERE meta_key LIKE 'facebook_cpt_settings%';
