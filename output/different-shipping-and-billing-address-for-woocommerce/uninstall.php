...
// Delete Options
delete_option('different_roles_select');
delete_site_option('different_roles_select');

// Delete Transients
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_%dsabafwerror', '_site_transient_%dsabafwerror' ) );
