...
DELETE FROM wp_options WHERE option_name IN ('active_sitewide_plugins', 'telegram_channel_names_temp', 'site_variables_my_secret', 'randoms_for_main_site', 'my_optioned_arrayyy', 'termids_for_js');
