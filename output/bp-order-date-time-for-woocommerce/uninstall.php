...
delete_option('bp_order_delivery_date_installed');
delete_site_option('bp_order_delivery_date_installed');
delete_option('wc-wdda-delivery-timeslots');
delete_site_option('wc-wdda-delivery-timeslots');
