...
// Delete Transients
delete_transient('uelm_changelog_import_success');
delete_site_transient('uelm_changelog_import_success');
...
delete_transient('uelm_changelog_import_error');
delete_site_transient('uelm_changelog_import_error');
