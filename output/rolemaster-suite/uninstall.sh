...
# Delete Options
wp option delete 'rolemaster_suite_sheet_promo_data'
wp option delete 'rolemaster_suite_sheet_promo_data_hash'
wp option delete '_rolemaster_suite_all_cpts'
wp option delete 'rolemaster_suite_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_rolemaster_suite-plugin-info-%' OR option_name LIKE '_site_transient_rolemaster_suite-plugin-info-%'"

# Clear Cron Jobs
wp cron event delete 'rolemaster_suite_sheet_promo_data_remote_sync'
