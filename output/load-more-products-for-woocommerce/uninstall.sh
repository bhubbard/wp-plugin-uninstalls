...
wp option delete 'br_lmp_general_settings'
wp option delete 'br_lmp_button_settings'
wp option delete 'br_lmp_selectors_settings'
wp option delete 'br_lmp_lazy_load_settings'
wp option delete 'br_lmp_messages_settings'
wp option delete 'br_lmp_javascript_settings'
wp option delete 'br_lmp_license_settings'
