...
delete_site_option('br_lmp_general_settings');
delete_option('br_lmp_button_settings');
delete_site_option('br_lmp_button_settings');
delete_option('br_lmp_selectors_settings');
delete_site_option('br_lmp_selectors_settings');
delete_option('br_lmp_lazy_load_settings');
delete_site_option('br_lmp_lazy_load_settings');
delete_option('br_lmp_messages_settings');
delete_site_option('br_lmp_messages_settings');
delete_option('br_lmp_javascript_settings');
delete_site_option('br_lmp_javascript_settings');
delete_option('br_lmp_license_settings');
delete_site_option('br_lmp_license_settings');
