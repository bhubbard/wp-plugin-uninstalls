...
wp option delete 'qcld_openrouter_enabled'
...
wp option delete 'skip_wp_greetings_donot_show_menu'
...
wp option delete 'open_links_new_window'
...
wp option delete 'wp_chatbot_language_center_language'
...
wp option delete 'skip_chat_reactions_menu'
wp option delete 'qlcd_wp_chatbot_like_text'
wp option delete 'qlcd_wp_chatbot_dislike_text'
wp option delete 'enable_chat_report_menu'
wp option delete 'qlcd_wp_chatbot_report_text'
wp option delete 'enable_chat_share_menu'
wp option delete 'qlcd_wp_chatbot_share_text'
...
wp option delete 'qc_wpbotpro_disable_floating_icon'
wp option delete 'qcld_ai_settings_open_ai'
wp option delete 'qcld_gemini_enabled'
wp option delete 'wpchatbot_license_valid'
wp option delete 'rag_embed_pages'
wp option delete 'rag_embed_posts'
wp option delete 'rag_embed_str'
wp option delete 'rag_embed_cpts'
wp option delete 'rag_auto_sync_enabled'
wp option delete 'qlcd_wp_chatbot_stop_words'
wp option delete 'qcld_openai_relevant_post'
wp option delete 'is_page_rag_enabled'
wp option delete 'qcld_gemini_rag_enabled'
wp option delete 'qcld_gemini_api_key'
wp option delete 'qcld_openrouter_rag_enabled'
wp option delete 'aws_reindex_version'
wp option delete 'wp_chatbot_index_meta'
wp option delete 'wp_chatbot_index_count'
wp option delete 'gemeni_context_awareness_enabled'
wp option delete 'qcld_gemini_page_suggestion_enabled'
wp option delete 'qcld_gemini_prepend_content'
wp option delete 'qcld_gemini_append_content'
...
wp option delete 'context_awareness_enabled'
wp option delete 'qcld_openai_system_content'
wp option delete 'qcld_openai_append_content'
...
wp option delete 'opnrouter_context_awareness_enabled'
wp option delete 'qcld_openrouter_page_suggestion_enabled'
wp option delete 'qcld_openrouter_api_key'
wp option delete 'qcld_openrouter_model'
wp option delete 'qcld_openrouter_prepend_content'
wp option delete 'qcld_openrouter_append_content'
...
wp option delete 'qlcd_wp_chatbot_default_language'
...
wp option delete 'active_advance_query'
wp option delete 'wpbotml_url_urls'
wp option delete 'qlcd_wp_chatbot_no_result'
wp option delete 'qc_bot_str_remove_stopwords'
wp option delete 'qcld_chatbot_existing_plugin_activate_check'
...
# Delete Transients
wp transient delete 'qcld_bot_clear_cache'
wp transient delete 'qcld_update_openaiaddon_'
wp transient delete 'qcld_renew_openaiaddon__subscription'
wp transient delete 'qcld_get_openaiaddon_enter_license_notice_dismiss_transient'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_meta_key'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_meta_key'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_meta_key'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_meta_key'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_language'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_language'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_language'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_language'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_preview_title'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_preview_title'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_preview_title'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_preview_title'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_number_of_heading'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_number_of_heading'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_number_of_heading'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_number_of_heading'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_heading_tag'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_heading_tag'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_heading_tag'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_heading_tag'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_style'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_writing_style'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_style'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_style'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_tone'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_writing_tone'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_tone'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_writing_tone'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_modify_headings'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_modify_headings'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_modify_headings'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_modify_headings'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_add_img'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_add_img'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_add_img'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_add_img'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_add_tagline'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_add_tagline'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_add_tagline'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_add_tagline'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_add_intro'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_add_intro'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_add_intro'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_add_intro'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_add_conclusion'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_add_conclusion'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_add_conclusion'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_add_conclusion'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_anchor_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_anchor_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_anchor_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_anchor_text'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_target_url'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_generated_text'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_generated_text'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_generated_text'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_generated_text'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_cta_pos'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_cta_pos'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_cta_pos'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_cta_pos'"
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url_cta'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'qc_wpbotpro_floating_target_url_cta'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url_cta'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'qc_wpbotpro_floating_target_url_cta'"
