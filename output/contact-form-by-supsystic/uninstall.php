...
delete_option('cfs_ac_subscribe');
delete_site_option('cfs_ac_subscribe');
delete_option('cfs_ac_remind');
delete_site_option('cfs_ac_remind');
delete_option('cfs_ac_disabled');
delete_site_option('cfs_ac_disabled');
global $wpdb;
...
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%cleared_trash_stat_data' ) );
foreach ( $options as $opt ) {
	delete_option( $opt );
	delete_site_option( $opt );
}
delete_option('cfs_show_love_link');
delete_site_option('cfs_show_love_link');
delete_option('cfs_last_check_love_link');
delete_site_option('cfs_last_check_love_link');
global $wpdb;
