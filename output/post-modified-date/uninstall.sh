...
# Delete Options
wp option delete 'jwt_pmd_text'
wp option delete 'jltpmd_sheet_promo_data'
wp option delete 'jltpmd_sheet_promo_data_hash'
wp option delete 'jltpmd_activation_time'
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%_allow_tracking'"

# Delete Transients
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_jltpmd-plugin-info-%' OR option_name LIKE '_site_transient_jltpmd-plugin-info-%'"

# Clear Cron Jobs
wp cron event delete 'jltpmd_sheet_promo_data_remote_sync'
