...
# Delete Transients
wp transient delete 'aigpl_install_notice'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key LIKE '%gallery_imgs'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key LIKE '%gallery_imgs'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key LIKE '%gallery_imgs'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key LIKE '%gallery_imgs'"
