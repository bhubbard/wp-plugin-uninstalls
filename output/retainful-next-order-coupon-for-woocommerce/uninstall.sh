...
wp option delete 'retainful_is_new_installation'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'coupon_expired_on'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'coupon_expired_on'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'coupon_expired_on'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'coupon_expired_on'"
