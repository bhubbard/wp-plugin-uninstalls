...
delete_option('en_freightview_carriers');
delete_site_option('en_freightview_carriers');
delete_option('en_quote_settings_shipping_logs_freightview');
delete_site_option('en_quote_settings_shipping_logs_freightview');
...
delete_option('en_connection_settings_license_key_freightview');
delete_site_option('en_connection_settings_license_key_freightview');
delete_option('en_quote_settings_show_delivery_estimate_freightview');
delete_site_option('en_quote_settings_show_delivery_estimate_freightview');
delete_option('en_quote_settings_delivery_estimate_options_freightview');
delete_site_option('en_quote_settings_delivery_estimate_options_freightview');
...
delete_option('freightview_backup_rates_category');
delete_site_option('freightview_backup_rates_category');
delete_option('freightview_backup_rates_display');
delete_site_option('freightview_backup_rates_display');
delete_option('en_freightview_plan_number');
delete_site_option('en_freightview_plan_number');
delete_option('en_freightview_plan_message');
delete_site_option('en_freightview_plan_message');
delete_option('active_sitewide_plugins');
delete_site_option('active_sitewide_plugins');
delete_option('en_freightview_plan_expire_days');
delete_site_option('en_freightview_plan_expire_days');
delete_option('en_freightview_plan_expire_date');
delete_site_option('en_freightview_plan_expire_date');
delete_option('en_freightview_store_type');
delete_site_option('en_freightview_store_type');
...
delete_option('freightview_backup_rates_fixed_rate');
delete_site_option('freightview_backup_rates_fixed_rate');
delete_option('freightview_backup_rates_cart_price_percentage');
delete_site_option('freightview_backup_rates_cart_price_percentage');
delete_option('freightview_backup_rates_weight_function');
delete_site_option('freightview_backup_rates_weight_function');
delete_option('en_quote_settings_order_cut_off_time_freightview');
delete_site_option('en_quote_settings_order_cut_off_time_freightview');
delete_option('enable_backup_rates_freightview');
delete_site_option('enable_backup_rates_freightview');
delete_option('EN_Plugins');
delete_site_option('EN_Plugins');
delete_option('en_quote_settings_allow_other_plugins_freightview');
delete_site_option('en_quote_settings_allow_other_plugins_freightview');
delete_option('en_freightview_ltl_update_now');
delete_site_option('en_freightview_ltl_update_now');
delete_option('eniture_show_rate_limit_notice_without_time');
delete_site_option('eniture_show_rate_limit_notice_without_time');
delete_option('en_quote_settings_residential_delivery_freightview');
delete_site_option('en_quote_settings_residential_delivery_freightview');
delete_option('en_quote_settings_liftgate_delivery_freightview');
delete_site_option('en_quote_settings_liftgate_delivery_freightview');
delete_option('en_quote_settings_limited_access_delivery_freightview');
delete_site_option('en_quote_settings_limited_access_delivery_freightview');
...
delete_option('en_quote_settings_limited_access_delivery_fee_freightview');
delete_site_option('en_quote_settings_limited_access_delivery_fee_freightview');
...
delete_option('en_quote_settings_rating_method_freightview');
delete_site_option('en_quote_settings_rating_method_freightview');
delete_option('en_quote_settings_custom_label_freightview');
delete_site_option('en_quote_settings_custom_label_freightview');
delete_option('en_quote_settings_own_arrangment_freightview');
delete_site_option('en_quote_settings_own_arrangment_freightview');
delete_option('en_quote_settings_text_for_own_arrangment_freightview');
delete_site_option('en_quote_settings_text_for_own_arrangment_freightview');
delete_option('en_quote_settings_number_of_options_freightview');
delete_site_option('en_quote_settings_number_of_options_freightview');
delete_option('en_quote_settings_handling_unit_weight_freightview');
delete_site_option('en_quote_settings_handling_unit_weight_freightview');
delete_option('maximum_handling_weight_freightview');
delete_site_option('maximum_handling_weight_freightview');
delete_option('en_quote_settings_handling_fee_freightview');
delete_site_option('en_quote_settings_handling_fee_freightview');
delete_option('freightview_liftgate_delivery_as_option');
delete_site_option('freightview_liftgate_delivery_as_option');
delete_option('en_quote_settings_limited_access_delivery_as_option_freightview');
delete_site_option('en_quote_settings_limited_access_delivery_as_option_freightview');
...
delete_option('freightview_backup_rates_carrier_returns_error');
delete_site_option('freightview_backup_rates_carrier_returns_error');
delete_option('freightview_backup_rates_carrier_fails_to_return_response');
delete_site_option('freightview_backup_rates_carrier_fails_to_return_response');
...
delete_option('freightview_backup_rates_label');
delete_site_option('freightview_backup_rates_label');
delete_option('en_quote_settings_shipment_offset_days_freightview');
delete_site_option('en_quote_settings_shipment_offset_days_freightview');
delete_option('en_quote_settings_all_shipment_days_freightview');
delete_site_option('en_quote_settings_all_shipment_days_freightview');
delete_option('en_quote_settings_monday_shipment_day_freightview');
delete_site_option('en_quote_settings_monday_shipment_day_freightview');
delete_option('en_quote_settings_tuesday_shipment_day_freightview');
delete_site_option('en_quote_settings_tuesday_shipment_day_freightview');
delete_option('en_quote_settings_wednesday_shipment_day_freightview');
delete_site_option('en_quote_settings_wednesday_shipment_day_freightview');
delete_option('en_quote_settings_thursday_shipment_day_freightview');
delete_site_option('en_quote_settings_thursday_shipment_day_freightview');
delete_option('en_quote_settings_friday_shipment_day_freightview');
delete_site_option('en_quote_settings_friday_shipment_day_freightview');
