...
# Delete Options
wp option delete 'pimi_encryption_key'
wp option delete 'pimi_site_salt'
wp option delete 'pimi_blocked_ips'
wp option delete 'pimi_approval_enabled'
wp option delete 'pimi_approval_threshold'
wp option delete 'pimi_uninstall_delete_data'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'pimi_csv_file_%'"
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'pimi_csv_import_%'"
wp option delete 'sidebars_widgets'
wp db query "DELETE FROM wp_options WHERE option_name LIKE 'widget_%'"

# Delete Transients
wp transient delete 'wp_plugins'
