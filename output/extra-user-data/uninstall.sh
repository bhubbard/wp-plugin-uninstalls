...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'login_count'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'login_count'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'login_count'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'login_count'"
