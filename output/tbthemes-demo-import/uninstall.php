...
// Delete Options
global $wpdb;
$options = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s", '%-demo_content_imported' ) );
...
global $wpdb;
$transients = $wpdb->get_col( $wpdb->prepare( "SELECT option_name FROM {$wpdb->options} WHERE option_name LIKE %s OR option_name LIKE %s", '_transient_tbthemes_demo_content_file_%', '_site_transient_tbthemes_demo_content_file_%' ) );
foreach ( $transients as $transient ) {
	delete_option( $transient );
}
