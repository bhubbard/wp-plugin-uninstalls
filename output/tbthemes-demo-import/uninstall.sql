...
DELETE FROM wp_options WHERE option_name IN ('primary_pricing_category', 'woocommerce_shop_page_id', 'woocommerce_cart_page_id', 'woocommerce_checkout_page_id', 'woocommerce_myaccount_page_id', 'sidebars_widgets', '_wxr_imported_posts', '_wxr_imported_users', '_wxr_imported_terms', '_wxr_orphaned_terms', 'wc_attribute_taxonomies', '_wxr_orphaned_posts', '_wxr_orphaned_comments', '_wxr_imported_comments');
DELETE FROM wp_options WHERE option_name LIKE '%-demo_content_imported';
DELETE FROM wp_options WHERE option_name LIKE 'widget_%';
DELETE FROM wp_options WHERE option_name LIKE '%-json';
DELETE FROM wp_options WHERE option_name LIKE 'tbthemes_demo_content_file_%';
