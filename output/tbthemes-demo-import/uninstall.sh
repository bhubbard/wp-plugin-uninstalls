...
# Delete Options
wp db query "DELETE FROM wp_options WHERE option_name LIKE '%-demo_content_imported'"
...
wp db query "DELETE FROM wp_options WHERE option_name LIKE '_transient_tbthemes_demo_content_file_%' OR option_name LIKE '_site_transient_tbthemes_demo_content_file_%'"
