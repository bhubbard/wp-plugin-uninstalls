...
DELETE FROM wp_options WHERE option_name IN ('sidebars_widgets', 'ctp_options', 'ctdi_importer_data', 'wc_attribute_taxonomies', 'ctdi_demo_json', 'cdti_import_dir_list');
