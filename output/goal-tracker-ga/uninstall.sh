...
# Delete Options
wp option delete 'gtga_review_notice_dismissed'
wp option delete 'gtga_activation_timestamp'
...
wp option delete 'wp_goal_tracker_ga_options'
...
wp db query "DELETE FROM wp_postmeta WHERE meta_key = 'isRecommended'"
wp db query "DELETE FROM wp_usermeta WHERE meta_key = 'isRecommended'"
wp db query "DELETE FROM wp_termmeta WHERE meta_key = 'isRecommended'"
wp db query "DELETE FROM wp_commentmeta WHERE meta_key = 'isRecommended'"
